package es.trafico.www.servicios.vehiculos.comunicaciones.webservices.informeReducido.ws;
...
public class SoapInteveWSReducidoWSHandler extends GenericWSHandler{

	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapInteveWSReducidoWSHandler.class);

	public static final String PROPERTY_KEY_ID = "llamadaWSInteveCompleto";

	private final String PREF_NOMBRE_FICHERO = "INTEVE_WS_REDUCIDO_";
	private final String SUF_NOMBRE_FICHERO_REQ = "_REQ";
	private final String SUF_NOMBRE_FICHERO_RESP = "_RESP";

	private final String TIPO_DOCUMENTO = ConstantesGestorFicheros.INTEVE_WS_REDUCIDO;
	...
	private String llamadaWSInteveCompleto;
	private Date fecha;

	public SoapInteveWSReducidoWSHandler() {
		fecha = new Date();
	}
	...
	public void init(HandlerInfo arg0) {
		...
		if(arg0.getHandlerConfig() != null){
			if(arg0.getHandlerConfig().get(PROPERTY_KEY_ID) != null){
				llamadaWSInteveCompleto = (String) arg0.getHandlerConfig().get(PROPERTY_KEY_ID).toString();
			}
		}
	}
	...
	public String getNombreFicheroRequest() {
		...
		sb.append(llamadaWSInteveCompleto).append("_");
