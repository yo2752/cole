package org.gestoresmadrid.oegamBajas.utiles;
...
public class XmlConsultaBTVFactory implements Serializable {
	
	private static final long serialVersionUID = -2006083082225860482L;

	private static final String UTF_8 = "UTF-8";
	private static final String XML_ENCODING = UTF_8;
	public static final String NAME_CONTEXT = "org.gestoresmadrid.oegamBajas.checkBtv.view.xml";
	private final static String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String TRAFICO_SCHEMAS_INTERFAZ_CONSULTABTV_XSD = "/org/gestoresmadrid/oegam2/consultaBTV/schemas/Interfaz_CONSULTABTV.xsd";
	...
	private ILoggerOegam log = LoggerOegam.getLogger(XmlConsultaBTVFactory.class);
	...
	private URL getEsquemaURL() {
		if (esquemaURL == null){
			esquemaURL = XmlConsultaBTVFactory.class.getResource(TRAFICO_SCHEMAS_INTERFAZ_CONSULTABTV_XSD);
		}
		return esquemaURL; 
	}
