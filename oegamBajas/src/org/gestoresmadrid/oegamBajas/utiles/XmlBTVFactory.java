...
public class XmlBTVFactory implements Serializable{

	private static final long serialVersionUID = -7223380309857102727L;
	
	private static final String XML_ENCODING = "UTF-8";
	public static final String NAME_CONTEXT = "org.gestoresmadrid.oegamBajas.btv.view.xml";
	private final static String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String TRAFICO_SCHEMAS_INTERFAZ_BTV_XSD = "/org/gestoresmadrid/oegam2/btv/schemas/TramitaBTV.xsd";
	...
	private URL getEsquemaURL() {
		if (esquemaURL == null){
			esquemaURL = XmlConsultaBTVFactory.class.getResource(TRAFICO_SCHEMAS_INTERFAZ_BTV_XSD);
		}
		return esquemaURL; 
	}
