...
import javax.xml.bind.annotation.XmlType;
	...
	@XmlType(name="Titular_Adquirente",propOrder = {
	    "datosAdquiriente",
	    "autonomoTransmitente"
	})
	public class TitularAdquiriente {
		@XmlElement(name = "Datos_Transmitente", required = true)
		protected TitularAdquiriente.DatosAdquiriente datosAdquiriente;
		
		@XmlElement(name = "Datos_Representante", required = false)
		protected TitularAdquiriente.DatosRepresentante datosRepresentante;
		...
		protected TitularAdquiriente.Domicilio domicilio;
		...
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = {
				"datosFiliacion","sexo","doi","datosRepresentante"
		})
		public static class DatosAdquiriente {
			@XmlElement(name = "Datos_Filiacion", required = true)
			protected TitularAdquiriente.DatosAdquiriente.DatosFiliacion datosFiliacion;
			...
			public TitularAdquiriente.DatosAdquiriente.DatosFiliacion getDatosFiliacion() {
				return datosFiliacion;
			}

			public void setDatosFiliacion(
					TitularAdquiriente.DatosAdquiriente.DatosFiliacion datosFiliacion) {
			...
			public static class DatosFiliacion {
				...
				protected TitularAdquiriente.DatosAdquiriente.DatosFiliacion.PersonaFisica personaFisica;
				
				@XmlElement(name = "Persona_Juridica", required = false)
				protected TitularAdquiriente.DatosAdquiriente.DatosFiliacion.PersonaJuridica personaJuridica;
				
				public TitularAdquiriente.DatosAdquiriente.DatosFiliacion.PersonaFisica getPersonaFisica() {
					return personaFisica;
				}

				public void setPersonaFisica(
						TitularAdquiriente.DatosAdquiriente.DatosFiliacion.PersonaFisica personaFisica) {
					this.personaFisica = personaFisica;
				}

				public TitularAdquiriente.DatosAdquiriente.DatosFiliacion.PersonaJuridica getPersonaJuridica() {
					return personaJuridica;
				}

				public void setPersonaJuridica(
						TitularAdquiriente.DatosAdquiriente.DatosFiliacion.PersonaJuridica personaJuridica) {
