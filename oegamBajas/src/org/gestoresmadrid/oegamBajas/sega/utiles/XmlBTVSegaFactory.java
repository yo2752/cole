package org.gestoresmadrid.oegamBajas.sega.utiles;
...
public class XmlBTVSegaFactory implements Serializable{

	private static final long serialVersionUID = 90591500814788835L;
	
	private static final String XML_ENCODING = "UTF-8";
	public static final String NAME_CONTEXT = "org.gestoresmadrid.oegamBajas.sega.btv.view.xml";
	private final static String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String TRAFICO_SCHEMAS_INTERFAZ_BTV_XSD = "/org/gestoresmadrid/oegamBajas/sega/btv/schemas/Interfaz_Btv_Sega.xsd";
	...
	private ILoggerOegam log = LoggerOegam.getLogger(XmlBTVSegaFactory.class);
	...
	private URL getEsquemaURL() {
		if (esquemaURL == null){
			esquemaURL = XmlBTVSegaFactory.class.getResource(TRAFICO_SCHEMAS_INTERFAZ_BTV_XSD);
		}
		return esquemaURL; 
	}
	 ...
	 */
	public String toXML(SolicitudRegistroEntrada solicitudRegistroEntradaSega) {
		String xmlString = null;
		try {
			xmlString = toXML((Object)solicitudRegistroEntradaSega);
		} catch(Exception e) {
	...
	/**
	 * M�todo que valida un XML contra el xsd del BTV (Interfaz_BTV.xsd)
	 ...
	 */
	public void validarXMLBTV(File fichero) throws OegamExcepcion {
		Validator validator;
		String mensaje, snif;
		int pos;
		try {
