...
public class XmlConsultaBTVSegaFactory {
	private static final String UTF_8 = "UTF-8";
	private static final String XML_ENCODING = UTF_8;
	public static final String NAME_CONTEXT = "org.gestoresmadrid.oegamBajas.sega.checkBtv.view.xml";
	private final static String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String TRAFICO_SCHEMAS_INTERFAZ_CONSULTABTV_XSD = "/org/gestoresmadrid/oegamBajas/sega/checkBtv/schemas/Interfaz_Check_Btv_Sega.xsd";
	...
	private ILoggerOegam log = LoggerOegam.getLogger(XmlConsultaBTVSegaFactory.class);
	...
	private URL getEsquemaURL() {
		if (esquemaURL == null){
			esquemaURL = XmlConsultaBTVSegaFactory.class.getResource(TRAFICO_SCHEMAS_INTERFAZ_CONSULTABTV_XSD);
		}
		return esquemaURL; 
	}
	 ...
	 */
	public String toXML(SolicitudTramite solicitudTramiteSega) {
		String xmlString = null;
		try {
			xmlString = toXML((Object)solicitudTramiteSega);
		} catch(Exception e) {
	...
	/**
	 * M�todo que valida un XML contra el xsd del CheckBTV (checkBtv.xsd)
	 ...
	 */
	public void validarXMLCheckBTV(File fichero) throws OegamExcepcion {
		Validator validator;
		String mensaje, snif;
		int pos;
		try {
