...
import org.gestoresmadrid.oegamBajas.sega.checkBtv.view.xml.DatosFirmados.ListaTransmitentes;
import org.gestoresmadrid.oegamBajas.sega.checkBtv.view.xml.ObjectFactory;
import org.gestoresmadrid.oegamBajas.sega.checkBtv.view.xml.SolicitudTramite;
import org.gestoresmadrid.oegamBajas.sega.utiles.XmlConsultaBTVSegaFactory;
...
@Component
public class BuildCheckBtvSega implements Serializable{

	private static final long serialVersionUID = -8714710377297857535L;

	private static final ILoggerOegam log = LoggerOegam.getLogger(BuildCheckBtvSega.class);
	...
	public ResultBean realizarFirmaColegiadoSega(SolicitudTramite solicitudTramiteSega,	String alias) {
	...
	private byte[] firmarXml(SolicitudTramite solicitudTramiteSega, String alias) throws UnsupportedEncodingException {
	...
	private String getXmlAfirmarPorTag(SolicitudTramite solicitudTramiteSega)  {
