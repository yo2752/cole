package org.gestoresmadrid.oegamBajas.sega.service.build;
...
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.Asunto;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosEspecificos;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosEspecificos.DatosExpediente;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosEspecificos.DatosGestor;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosEspecificos.DatosGestoria;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosEspecificos.DatosVehiculo;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosEspecificos.Indicadores;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosEspecificos.Solicitante;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosEspecificos.Tasas;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosEspecificos.Titular;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosGenericos.Interesados;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosInteresado;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.DatosRemitente;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.Destino;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.ObjectFactory;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.SolicitudRegistroEntrada;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.TipoOrganismo;
import org.gestoresmadrid.oegamBajas.sega.btv.view.xml.TipoTextoLegal;
import org.gestoresmadrid.oegamBajas.sega.utiles.XmlBTVSegaFactory;
...
@Component
public class BuildBtvSega implements Serializable{

	private static final long serialVersionUID = 2332997838838235868L;

	private static final ILoggerOegam log = LoggerOegam.getLogger(BuildBtvSega.class);
	...
	public SolicitudRegistroEntrada rellenarXmlTramitacionBtvSega(TramiteTrafBajaDto tramiteTraficoBajaDto) {
		...
		Asunto asunto = new Asunto();
			...
			asunto.setDescripcion("Solicitud de Baja Telem�tica por Exportaci�n o Tr�nsito Comunitario");	
		solicitudRegistroEntradaSega.getDatosFirmados().getDatosGenericos().setAsunto(asunto);
		
		Destino destino = new Destino();
    	destino.setCodigo("101001");
    	destino.setDescripcion("DGT - Veh�culos");
	...
	public ResultBean firmaColegiadoSega(SolicitudRegistroEntrada solicitudRegistroEntradaSega, ColegiadoDto colegiadoDto) {
	...
	private byte[] firmarXml(SolicitudRegistroEntrada solicitudRegistroEntradaSega, String alias) throws UnsupportedEncodingException {
	...
	private String getXmlAfirmarPorTag(SolicitudRegistroEntrada solicitudRegistroEntradaSega) {
	...
	public ResultBean firmaColegioSega(SolicitudRegistroEntrada solicitudRegistroEntradaSega, String alias) {
		ResultBean resultado = new ResultBean(false);
		try {
			...
			log.error("Ha sucedido un error a la hora de firmar el colegio la petici�n de baja telematica, error: ", e);
			resultado.setError(true);
			resultado.setMensaje("Ha sucedido un error a la hora de firmar el colegio la petici�n de baja telematica.");
		}
		return resultado;
	}

	public ResultBean validarXmlSega(SolicitudRegistroEntrada solicitudRegistroEntradaSega, String nombreXml) {
		ResultBean resultado = new ResultBean(false);
