package org.gestoresmadrid.oegam2.colas.view.decorator;
...
public class GestorColaDecorator extends TableDecorator {
	...
	public String getEstado() {
		...
		if (solicitudesColaBean != null && solicitudesColaBean.getEstado() != null && !solicitudesColaBean.getEstado().isEmpty()) {
