...
public class ModificarArrendatariosAction extends ActionBase {
	private static final long serialVersionUID = 1L;
	private static final String MODIFICAR_ARRENDATARIO = "altaArrendatario";
	...
	private void cargarValoresIniciales() {
		...
		arrendatarioDto.setOperacion(TipoOperacionCaycEnum.Modif_Arrendatario.toString());
	}
