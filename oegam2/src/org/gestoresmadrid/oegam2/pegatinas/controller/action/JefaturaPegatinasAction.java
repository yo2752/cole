...
public class JefaturaPegatinasAction extends ActionBase {
	...
	public String cambiar() {
		...
		if (jefaturaValida()) {
			ResultBean resultado = servicioUsuario.actualizarJefaturaJPTUsuario(
					utilesColegiado.getIdUsuarioSessionBigDecimal(), jefaturaSeleccionada);
