package org.gestoresmadrid.oegam2.remesa.tags;
 ...
 * getBotones()...
 */
public class BotonesPaginaConsultaRemesaTag extends TagSupport {
	...
	private final String CLASE_CSS_TABLE = "acciones";
	...
	public BotonesPaginaConsultaRemesaTag() {
		super();
	...
	public int doStartTag() throws JspException {
		try {
			...
			ArrayList<String> listaTds = new ArrayList<String>();
	...
	private ArrayList<BotonPaginaConsultaBean> getBotones() {
		...
		ArrayList<BotonPaginaConsultaBean> listaBotones = new ArrayList<BotonPaginaConsultaBean>();

		// BOTÓN 'Validar'
		BotonPaginaConsultaBean botonValidar = new BotonPaginaConsultaBean("bValidar", "bValidar", "Validar",
				"return validarBloque();");
		listaBotones.add(botonValidar);

		// BOTÓN 'Generar'
		BotonPaginaConsultaBean botonGenerar = new BotonPaginaConsultaBean("bGenerar", "bGenerar", "Generar",
				"return generarBloque();");
		listaBotones.add(botonGenerar);
