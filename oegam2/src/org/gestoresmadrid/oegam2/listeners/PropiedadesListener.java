package org.gestoresmadrid.oegam2.listeners;
...
public class PropiedadesListener implements ServletContextListener {

	private static final ILoggerOegam log = LoggerOegam.getLogger(PropiedadesListener.class);
