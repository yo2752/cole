...
<div class="popup formularios" style="width:95%;">
		...
		<table width="100%" >
			<tr>
				<td class="tabular" align="left">
					<span class="titulo">Evolucion Consulta Atex5</span>
				</td>
			</tr>
		</table>
	</div>
						...
						<tr>
							...
							<td width="10%" align="right">
								<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboResultadosPorPagina()" 
											...
											id="idResultadosPorPaginaEvolAtex5"
											name= "resultadosPorPagina"
											value="resultadosPorPagina"
											title="Resultados por página"
											onchange="cambiarElementosPorPaginaConsulta('navegarEvolucionAtex5.action', 'displayTagEvolucionAtex5Div', this.value);" > 
								</s:select>
							</td>
						</tr>
					</table>
	...
	<div id="displayTagEvolucionAtex5Div" class="divScroll">
		<div
			style="display: none; margin-top: auto; margin-left: auto; margin-right: auto;">
			<%@include file="../../../../includes/bloqueLoading.jspf"%>
		</div>
		<display:table name="lista" class="tablacoin"
				uid="tablaEvolucionAtex5" requestURI= "navegarEvolucionAtex5.action"
				id="tablaEvolucionAtex5" summary="Listado Evolucion Consulta Atex5"
			...
			<display:column property="numExpediente" title="Num.Expediente" sortable="true" headerClass="sortable"
				sortProperty="id.numExpediente" defaultorder="descending" style="width:2%"/>
			...
			<display:column title="Tipo Actuacion" sortProperty="tipoActuacion" sortable="true" headerClass="sortable" defaultorder="descending" style="width:2%">
				<s:property value="%{@org.gestoresmadrid.core.model.enumerados.TipoActualizacion@getNombrePorValor(#attr.tablaEvolucionAtex5.tipoActuacion)}" />
			</display:column>
			...
			<display:column title="Estado anterior" sortProperty="estadoAnt" sortable="true" headerClass="sortable" defaultorder="descending" style="width:2%">
				<s:property value="%{@org.gestoresmadrid.core.atex5.model.enumerados.EstadoAtex5@convertirEstadoBigDecimal(#attr.tablaEvolucionAtex5.estadoAnt)}" />
			</display:column>
			...
			<display:column title="Estado nuevo" sortProperty="estadoNuevo" sortable="true" headerClass="sortable" defaultorder="descending" style="width:2%">
				<s:property value="%{@org.gestoresmadrid.core.atex5.model.enumerados.EstadoAtex5@convertirEstadoBigDecimal(#attr.tablaEvolucionAtex5.estadoNuevo)}" />
			</display:column>
	...
	<script type="text/javascript">
		$(function() {
			$("#displayTagEvolucionAtex5Div").displayTagAjax();
		});
	</script>	