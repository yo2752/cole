...
<div class="popup formularios" style="width:95%;">
		...
		<table width="100%" >
			<tr>
				<td class="tabular" align="left">
					<span class="titulo">Evolucion Contrato</span>
				</td>
			</tr>
		</table>
	</div>
						...
						<tr>
							...
							<td width="10%" align="right">
								<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboResultadosPorPagina()" 
											...
											id="idResultadosPorPaginaEvolContrato"
											name= "resultadosPorPagina"
											value="resultadosPorPagina"
											title="Resultados por página"
											onchange="cambiarElementosPorPaginaEvolucionContratos();">
								</s:select>
							</td>
						</tr>
					</table>
	...
	<script type="text/javascript">
		$(function() {
			$("#displayTagEvolucionContratoDiv").displayTagAjax();
		});
	</script>	
	<div id="displayTagEvolucionContratoDiv" class="divScroll">
		<div
			style="display: none; margin-top: auto; margin-left: auto; margin-right: auto;">
			<%@include file="../../../../includes/bloqueLoading.jspf"%>
		</div>
		<display:table name="lista" class="tablacoin"
				uid="tablaEvolucionContrato" requestURI= "navegarEvolucionContrato.action"
				id="tablaEvolucionContrato" summary="Listado Evolucion Contrato"
				excludedParams="*" sort="list"				
				cellspacing="0" cellpadding="0"
				decorator="${decorator}">	
				
			<display:column property="razonSocial" title="Razon Social" sortable="true" headerClass="sortable"  sortProperty="contrato.razonSocial"
				defaultorder="descending" style="width:2%"/>
				
			<display:column property="tipoAct" title="Tipo Actualizacion" sortable="true" headerClass="sortable"  sortProperty="tipoActualizacion"
				defaultorder="descending" style="width:2%"/>		
			...
			<display:column property="motivo" title="Motivo" sortable="true"  headerClass="sortable" 
				defaultorder="descending" style="width:4%" sortProperty="motivo"/>
				
			<display:column property="solicitante" title="Solicitante" sortable="true"  headerClass="sortable" 
				defaultorder="descending" style="width:4%" sortProperty="solicitante"/>
