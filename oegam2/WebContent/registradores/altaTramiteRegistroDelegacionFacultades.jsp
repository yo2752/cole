...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Cese, Nombramiento y Delegaci&oacute;n de Facultades</span>
			</td>
		</tr>
	</table>
</div>
...
<ol id="toc">
	...
	<li id="Asistentes"><a style="display:none;" id="pesJunta" href="#Asistentes">Consejo Administraci&oacute;n</a></li>	
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegistro.estado,tramiteRegistro.numReg)">
		...
		<div id="botonBusqueda">
			<table width="100%">
				<tr>
					<td>
						<input type="button" value="Guardar" class="boton"  id="botonSeleccionarSociedad" onclick="return (validacionCamposSociedadGuardar('TramiteRegistroMd5'));" onKeyPress="this.onClick"/>
					</td>
					<td>
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegistro.estado,tramiteRegistro.numReg)">
		...
		<div id="botonBusqueda">
			<table width="100%">
				<tr>
					<td> 
						<input type="button" class="boton" value="Guardar" id="botonGuardarDelegacionFacultades" onclick="guardarTramiteRegistro();"/>
						&nbsp;
						<img id="loadingImage" style="display:none;margin-left:auto;margin-right:auto;" src="img/loading.gif">  
					</td>
				</tr>
...
<div class="contentTabs" id="Asistentes">
	<%@include file="asistentesLista.jsp" %>
	&nbsp;
	<%@include file="lugarFechaAsistencia.jsp" %>
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegistro.estado,tramiteRegistro.numReg)">
		<div id="botonBusqueda">
			<table width="100%">
				<tr>
					<td> 
						<input type="button" class="boton" value="Guardar" id="botonActualizarAsistente" onclick="guardarAsistente();"/>
						&nbsp;
						<img id="loadingImage" style="display:none;margin-left:auto;margin-right:auto;" src="img/loading.gif">  
					</td>
				</tr>
...
<div  id="formaPago" class="contentTabs">  
	<%@include file="pestaniaFormaPagoDelegacionFacultades.jsp" %>
</div>

<!-- Contenido de la pestaña del formulario que contiene el resumen del estado del trámite -->
<%@include file="resumenTramiteDelegacionFacultades.jsp" %>
