...
<div class="contentTabs" id="Resumen">
	...
	<s:if test="tramiteRegistro.estado == 3 || tramiteRegistro.estado == 9 || tramiteRegistro.estado == 15 || tramiteRegistro.estado == 13"> 
		...
		<div id="busqueda" class="busqueda">
			<%@include file="/registradores/resumen/resumenAceptacionNombramiento.jsp" %>
		</div>
		<div>&nbsp;</div>
		<div id="busqueda" class="busqueda">
					...
					<tr>
						<td>
							<s:if test="tramiteRegistro.estado == 1">
								<input type="button" value="Validar" class="boton" id="btnValidar" onclick="javascript:doPost('formData', 'validarTramiteTramiteRegistroMd2.action#Resumen', null);"/>
							</s:if>
							<s:if test="tramiteRegistro.estado == 28">
								<input type="button" id="btnFirmar" value="Firmar" class="boton" onclick="construirRm(true, 2);" />
							</s:if>
							&nbsp;
							...
							<input type="button" value="Ver documento" class="boton" id="btnVerDocumento" onclick="construirRm(false, 2);" />
							&nbsp;
