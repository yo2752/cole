		  ...
		  <td>
				<table style="width:20%">
					<tr>
						...
						<td align="left">
							<s:textfield name="tramiteRegRbmDto.datoFirmaDto.fecFirmaDatFirma.mes" id="mesFecFirma"								onfocus="this.className='inputfocus';" size="2" maxlength="2" onblur = "validaInputFecha(document.getElementById('diaFecFirma'), document.getElementById('mesFecFirma'), document.getElementById('anioFecFirma'));"/>
						</td>
						<td align="left">
							<label class="labelFecha">/</label>
						</td>
