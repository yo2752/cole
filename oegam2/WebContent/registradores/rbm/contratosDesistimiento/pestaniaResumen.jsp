...
<div class="contenido">
	...
	<table border="0" class="tablaformbasicaTC">
		...
		<tr>
			<td align="right" nowrap="nowrap" style="vertical-align: middle;">
				<label for="cif">N&uacute;mero de entrada:</label>
			</td>
			<td align="left" nowrap="nowrap" colspan="5">
				<s:textfield name="tramiteRegRbmDto.numEntradaOrigen" id="numEntradaOrigen" 
		...
		<tr>
			<td align="right" nowrap="nowrap" style="vertical-align: middle;">
				<label for="cif">N&uacute;mero presentaci&oacute;n:</label>
			</td>
			<td align="left" nowrap="nowrap" colspan="5">
				<s:textfield name="tramiteRegRbmDto.numPresentacionOrigen" id="tipoOperacion" 
					onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="60" maxlength="60"
					disabled="true"  />
			</td>
		</tr>
