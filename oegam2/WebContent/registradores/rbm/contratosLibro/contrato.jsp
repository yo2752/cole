...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Presentación de libros</span>
			</td>
		</tr>
	</table>
</div>
...
<ol id="toc">
	<li id="documentacion"><a id="pesDocumentacion" href="#documentacion">Documentación aportada/recibida</a></li>
	<li ><a style="display:none;" id="presentador" href="#presentador">Presentador</a></li>
	<li><a style="display:none;" id="Libro" href="#Libro">Libros</a></li>
...
<s:if test="%{tramiteRegistro.sociedadEstablecida==true}">
	<script type="text/javascript">habilitarPestaniasLibro();</script>
</s:if>
...
<div id="documentacion" class="contentTabs">
	<%@include file="../../resumen/listaFicheros.jsp" %>
</div>
...
<div id="Libro"><jsp:include page="libros.jsp" flush="true" /></div>
