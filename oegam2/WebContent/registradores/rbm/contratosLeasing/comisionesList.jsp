...
<display:table name="tramiteRegRbmDto.datosFinanciero.comisiones" uid="tablaComisiones" class="tablacoin" id="tablaComisiones"
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
		<display:column title="Eliminar" style="width:10%">						
			 <a href="javascript:doConfirmPost('¿Está seguro de que desea borrar esta comisión?', 'formData', 'borrarComisionLeasing.action?identificador=<s:property value="#attr.tablaComisiones.idComision"/>', null);">
				Eliminar
			</a>
		</display:column>					
		<display:column style="width:3%">
			<a href="javascript:aniadirComision('Leasing', 'formData','cargarPopUpComisionRegistroLeasing.action?identificador=${tablaComisiones.idComision}')" >
