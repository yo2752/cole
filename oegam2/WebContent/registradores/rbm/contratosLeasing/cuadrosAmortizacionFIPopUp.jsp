...
<s:hidden name="tramiteRegRbmDto.cuadroAmortizacionDto.tipoPlazo" id="tipoPlazoCuadro" value="ANTICIPATED_FINANCING"/>

<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
	<tr>
		<td class="tabular">
			<span class="titulo">Cuadros de amortizaci&oacute;n F.I.:</span>
		</td>
	</tr>
</table>
