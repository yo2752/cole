...
<display:table name="tramiteRegRbmDto.pactos" uid="tablaPactos" class="tablacoin" id="tablaPactos"
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
		<display:column title="Eliminar" style="width:10%">						
			 <a href="javascript:doConfirmPost('¿Está seguro de que desea borrar este acuerdo?', 'formData', 'borrarAcuerdoLeasing.action?identificador=<s:property value="#attr.tablaPactos.idPacto"/>\u0023tab7', null);">
				Eliminar
			</a>
		</display:column>					
		<display:column style="width:3%">
				<a href="javascript:doPost('formData','modificarAcuerdoLeasing.action?identificador=${tablaPactos.idPacto}\u0023tab7')" >
