...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Importaci&oacute;n de Contratos de Leasing/Renting</span>
			</td>
		</tr>
	</table>
</div>
...
<div class="contenido">	
	...
	<s:form action="importar_ImportarLeasingRentingDossier.action" id="formData" cssClass="transformable" enctype="multipart/form-data">
	...
	<s:hidden name="idSession" />
		...
		<table class="insertDatosTb" id="datosTB">
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td><label for="fichero" class="small">Fichero:</label></td>
				<td>
		    	<s:file id="fichero" size="50" name="fichero" value="fichero" />
				</td>
			</tr>
		</table>&nbsp;
		<a href="javascript:importarFicheroLeasingRenting()"
