...
<div class="contentTabs" id="Resumen">
	...
	<div id="busqueda" class="busqueda">
		<%@include file="resumenCuenta.jsp" %>
	</div>
				...
				<tr>
					<td>
						<s:if test="tramiteRegistro.estado == 1">
							<input type="button" value="Validar" class="boton" id="btnValidar"  onclick="javascript:validarTramiteRegistradores('btnValidar','formData', 'validarTramiteCuenta.action#Resumen');"/>
						</s:if>
						&nbsp;
