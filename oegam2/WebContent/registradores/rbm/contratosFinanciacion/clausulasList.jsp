...
<display:table name="tramiteRegRbmDto.clausulas" uid="tablaClausulas" class="tablacoin" id="tablaClausulas"
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
		<display:column title="Eliminar" style="width:10%">						
			 <a href="javascript:doConfirmPost('¿Está seguro de que desea borrar esta cláusula?', 'formData', 'borrarClausulaFinanciacion.action?identificador=<s:property value="#attr.tablaClausulas.idClausula"/>\u0023tab5', null);">
				Eliminar
			</a>
		</display:column>					
		<display:column style="width:3%">
			<a href="javascript:aniadirClausula('Financiacion', 'formData','cargarPopUpClausulaRegistroFinanciacion.action?identificador=${tablaClausulas.idClausula}')" >
