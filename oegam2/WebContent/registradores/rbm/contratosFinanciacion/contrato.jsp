...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Contrato de Financiaci&oacute;n</span>
			</td>
		</tr>
	</table>
</div>
<div>
	...
	<ol id="toc">
		...
		<li id="tab3" ><a href="#tab3">Compradores</a></li>
	    <li id="tab4" ><a href="#tab4">Vendedores</a></li>
	   	<li id="tab9" ><a href="#tab9">Financiadores</a></li>
	...
	<table class="subtitulo" align="left" cellspacing="0">
		<tr>
			...
			<td>Datos contrato Financiaci&oacute;n</td>
	...
	<s:form action="guardarFinanciacion.action" id="formData" name="formData" enctype="multipart/form-data">
		...
		<div class="contentTabs" id="tab3">  
        	<jsp:include page="pestaniaCompradores.jsp" flush="true" />
        </div> <!-- fin tab3 -->
        
		<div class="contentTabs" id="tab4">  
        	<jsp:include page="pestaniaVendedores.jsp" flush="true" />
        </div> <!-- fin tab4 -->
      
		<div class="contentTabs" id="tab9">  
        	<jsp:include page="pestaniaFinanciadores.jsp" flush="true" />
        </div> <!-- fin tab9 -->
		...
		<div class="acciones center">
			<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
				<input type="button" value="Guardar" class="boton" id="botonGuardar" onclick="javascript:guardarTramiteRegRbm();"/>
			</s:if>
			<s:if test="tramiteRegRbmDto.estado==@org.gestoresmadrid.core.registradores.model.enumerados.EstadoTramiteRegistro@Iniciado">
				<input type="button" value="Validar" class="boton" id="botonValidar" onclick="javascript:validarTramiteRegRbm();"/>
			</s:if>
...
<div id="divEmergentePopUpFinanciacion" style="display: none; background: #f4f4f4;"></div>
