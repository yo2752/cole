...
<div class="contenido">	
		...
		<tr>
			...
			<td>
				<s:select name="tramiteRegRbmDto.tipoContrato" 
					list="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().getListFinancialContractType()" 
					listKey="key"
					headerKey="" 
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		<tr>			
			<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoImpPrecioCompraventa" >Precio compraventa<span class="naranja">*</span></label>
				<img src="img/botonDameInfo.gif" alt="Info" title="Importe del precio de compraventa o valor al contado"/>
			</td>
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impPrecioCompraventa" id="datosFinancierosDtoImpPrecioCompraventa" size="14" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')"></s:textfield></td>
		 
       		<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoImpDesembolsoIni" >Pvp inicial<span class="naranja">*</span></label>
       			<img src="img/botonDameInfo.gif" alt="Info" title="Importe desembolso inicial"/>
       		</td>
            <td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impDesembolsoIni" id="datosFinancierosDtoImpDesembolsoIni" size="14" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')" ></s:textfield></td>
           	
           	<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoImpCapitalPrestamo" >Capital pr&eacute;stamo<span class="naranja">*</span></label>
           		<img src="img/botonDameInfo.gif" alt="Info" title="Importe del capital del pr&eacute;stamo"/>
           	</td>
            <td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impCapitalPrestamo" id="datosFinancierosDtoImpCapitalPrestamo" size="14" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')"></s:textfield></td>
			
		</tr>
		<tr> 
			<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoImpTotalPrestamo" >Total cr&eacute;dito<span class="naranja">*</span></label>
				<img src="img/botonDameInfo.gif" alt="Info" title="Importe total pr&eacute;stamo. Capital + Otros conceptos financiados"/>
			</td>
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impTotalPrestamo" id="datosFinancierosDtoImpTotalPrestamo" size="14" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')"></s:textfield></td>              
			<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoImtIntereses" class="small">Inter&eacute;s pr&eacute;stamo<span class="naranja">*</span></label></td>
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.imtIntereses" id="datosFinancierosDtoImtIntereses" size="14" maxlength="14" onkeypress="return soloNumeroDecimal(event, this, '3', '10')"></s:textfield></td>
			
			<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoTipoDeudor" class="small">Tipo deudor<span class="naranja">*</span></label></td>
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.tipoDeudor" id="datosFinancierosDtoTipoDeudor" size="14" maxlength="14" onkeypress="return soloNumeroDecimal(event, this, '3', '10')" ></s:textfield></td>
		...
		<tr> 
			...
			<td align="left" nowrap="nowrap"> <label for="datosFinancierosDtoInteresesDemora" class="small">Inter&eacute;s demora<span class="naranja">*</span></label></td>
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.interesesDemora" id="datosFinancierosDtoInteresesDemora" size="14" maxlength="14" onkeypress="return soloNumeroDecimal(event, this, '3', '10')"></s:textfield></td>
		...
		<tr>
			...
			<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoImpImpuestoMatriculacion" class="small">Impuesto matriculaci&oacute;n</label></td>
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impImpuestoMatriculacion" id="datosFinancierosDtoImpImpuestoMatriculacion" size="14" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')" ></s:textfield></td>
			
			<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoImpCancelacionRdLd" >Importe cancelaci&oacute;n</label>
				<img src="img/botonDameInfo.gif" alt="Info" title="Importe cancelaci&oacute;n de la reserva de dominio y/o limitaci&oacute;n de disposici&oacute;n"/>
			</td>
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impCancelacionRdLd" id="datosFinancierosDtoImpCancelacionRdLd" size="14" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')" ></s:textfield></td>
		</tr>
		<tr> 
			<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoImpTotalAdeudado" >Imp. total + coste total<span class="naranja">*</span></label>
				<img src="img/botonDameInfo.gif" alt="Info" title="La suma del importe total del cr&eacute;dito m&aacute;s el coste total del cr&eacute;dito para el consumidor"/>
			</td>
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impTotalAdeudado" id="datosFinancierosDtoImpTotalAdeudado" size="14" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')"></s:textfield></td>
			<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoImpDerechoDes" >Importe derecho desist.<span class="naranja">*</span></label>
				<img src="img/botonDameInfo.gif" alt="Info" title="Importe del inter&eacute;s diario a efectos del derecho de desistimiento"/>
			</td>
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impDerechoDes" id="datosFinancierosDtoImpDerechoDes" size="14" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')"></s:textfield></td>
						...
						<tr>
							...
							<td align="left">
								<s:textfield name="tramiteRegRbmDto.datosFinanciero.fecRevisionDatFinancieros.anio" id="anioFecRevision"
									onfocus="this.className='inputfocus';" size="4" maxlength="4" onblur = "validaInputFecha(document.getElementById('diaFecRevision'), document.getElementById('mesFecRevision'), document.getElementById('anioFecRevision'));this.className='input2';"/>
							</td>
							<td align="left">
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
         <tr>
               <td align="left" nowrap="nowrap"> <label for="datosFinancierosDtoDomicilioEntidadPago" class="small">Domicilio entidad<span class="naranja">*</span></label></td>
         ...
         <tr>     
                <td align="left" nowrap="nowrap"><label for="datosFinancierosDtoCodProvinciaPago" >C&oacute;digo INE provincia<span class="naranja">*</span></label>
               ...
               <td align="left" nowrap="nowrap"><label for="datosFinancierosDtoCodMunicipioPago" >C&oacute;digo INE municipio<span class="naranja">*</span></label>
          ...
          <tr>
          	<td align="left" nowrap="nowrap"> <label for="datosFinancierosDtoEntidadPago" class="small">Entidad de pago<span class="naranja">*</span></label></td>
               <td><s:textfield name="tramiteRegRbmDto.datosFinanciero.entidadPago" id="datosFinancierosDtoEntidadPago" size="4" maxlength="4" onkeypress="return soloNumeroDecimal(event, this, '4', '0')" ></s:textfield></td>
               <td align="left" nowrap="nowrap"><label for="datosFinancierosDtoCccPago" class="small">N&uacute;mero cuenta corriente<span class="naranja">*</span></label></td>
          ...
          <tr>
         	<td align="left" nowrap="nowrap"><label for="datosFinancierosDtoPorcentajeTaePago" class="small">Porcentaje TAE<span class="naranja">*</span></label></td>
               <td><s:textfield name="tramiteRegRbmDto.datosFinanciero.porcentajeTaePago" id="datosFinancierosDtoPorcentajeTaePago" size="14" maxlength="14" onkeypress="return soloNumeroDecimal(event, this, '3', '10')" ></s:textfield></td>
          </tr>
     </table>
		    ...
		    <tr>
				<td align="center" nowrap="nowrap">
					<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
						<input type="button" onclick="javascript:aniadirFirma('Financiacion','formData','cargarPopUpDatosFirmaRegistroFinanciacion.action');" id="btnAniadirFirmaFinanciacion" class="button corporeo" value="Añadir"/>
					</s:if>
				</td>
			</tr>
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				<td>
					<jsp:include page="firmasList.jsp" flush="true" />
				</td>
			</tr>
		</table>
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">	
		  	 <tr>
				<td align="center" nowrap="nowrap" colspan="6">
					<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
						<input type="button" onclick="javascript:aniadirComision('Financiacion','formData', 'cargarPopUpComisionRegistroFinanciacion.action');" id="btnAniadirComisionFinanciacion" class="button corporeo" value="Añadir" />
					</s:if>
				</td>
			</tr>
		</table> 
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		    <tr>
				<td align="center" nowrap="nowrap" colspan="6">
					<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
						<input type="button" onclick="javascript:aniadirImporte('Financiacion','formData', 'cargarPopUpOtrosImportesRegistroFinanciacion.action');" id="btnAniadirImporteFinanciacion" class="button corporeo" value="Añadir" />
					</s:if>
				</td>
			</tr>
		</table>
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				<td>
	        		<jsp:include page="importesList.jsp" flush="true" />
	        	</td>
	        </tr>
		</table>
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		    <tr>
				<td align="center" nowrap="nowrap" colspan="6">
					<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
						<input type="button" onclick="javascript:aniadirDeuda('Financiacion','formData', 'cargarPopUpReconocimientoDeudaRegistroFinanciacion.action');" id="btnAniadirDeudaFinanciacion" class="button corporeo" value="Añadir" />
					</s:if>
				</td>
			</tr>
		</table>
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				<td>
	        		<jsp:include page="deudasList.jsp" flush="true" />
	        	</td>
	        </tr>
		</table>
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left"> 
		    <tr>
				<td align="center" nowrap="nowrap" colspan="6">
					<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
						<input type="button" onclick="javascript:aniadirCuadro('Financiacion','formData', 'cargarPopUpCuadroAmortizacionRegistroFinanciacion.action', 'btnAniadirCuadroFinanciacion');" id="btnAniadirCuadroFinanciacion" class="button corporeo" value="Añadir" />
					</s:if>
				</td>
			</tr>
		</table>
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				<td>
	        		<jsp:include page="cuadrosList.jsp" flush="true" />
	        	</td>
	        </tr>
		</table>
