...
<div class="contenido">
	...
	<!-- Lista de bienes financiados -->
	<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
		<tr>
			<td class="tabular" style="">
				<span class="titulo">Bienes financiados:</span>
			</td>
		</tr>
	</table>
	 <table border="0" class="tablaformbasicaTC">
		<tr>
			<s:if test="tramiteRegRbmDto.propiedades != null && tramiteRegRbmDto.propiedades.size() > 0">
				<td align="right">
					<display:table name="tramiteRegRbmDto.propiedades" uid="tablaBienes" class="tablacoin" id="tablaBienes"
						summary="Listado de bienes" cellspacing="0" cellpadding="0" style="width:95%">
						<display:column title="Categoría" >
							<s:property value="%{@org.gestoresmadrid.oegam2comun.registradores.enums.TipoCategoria@convertirTexto(#attr.tablaBienes.categoria)}" />
						</display:column>
						<display:column title="Número Inscripción Registral" property="numeroRegistral" />
						<display:column title="Valor contado" property="valor" />
						<display:column title="Uni. cuenta" property="unidadCuenta" />
					</display:table>
				</td>
			</s:if>
			...
			<s:else>
				<td align="left" nowrap="nowrap" >
					<label for="arrendadores" style="color:red;font-size:12px">
						FALTAN LOS DATOS DE LOS BIENES FINANCIADOS
					</label>
				</td>
			</s:else> 
		</tr>		
	...
	<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
		<tr>
			<td class="tabular" style="">
				<span class="titulo">Compradores:</span>
			</td>
		</tr>
	</table>
	 <table border="0" class="tablaformbasicaTC">
		<tr>
			<s:if test="tramiteRegRbmDto.compradores != null && tramiteRegRbmDto.compradores.size() > 0">
				<td align="right">
					<display:table name="tramiteRegRbmDto.compradores" uid="tablaCompradores" class="tablacoin" id="tablaCompradores"
						summary="Listado de compradores" cellspacing="0" cellpadding="0"  style="width:95%">
						<display:column title="Tipo" style="width:23%">
							<s:property value="%{@org.gestoresmadrid.core.registradores.model.enumerados.TipoPersonaRegistro@convertirTextoDesdeXML(#attr.tablaCompradores.tipoPersona)}" />
						</display:column>
			...
			<s:else>
				<td align="left" nowrap="nowrap" >
					<label for="compradores" style="color:red;font-size:12px">
						FALTAN LOS DATOS DE LOS COMPRADORES
					</label>
				</td>
			</s:else> 
		</tr>		
	...
	<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
		<tr>
			<td class="tabular" style="">
				<span class="titulo">Financiadores:</span>
			</td>
		</tr>
	</table>
	 <table border="0" class="tablaformbasicaTC">
		<tr>
			<s:if test="tramiteRegRbmDto.financiadores != null && tramiteRegRbmDto.financiadores.size() > 0">
				<td align="right">
					<display:table name="tramiteRegRbmDto.financiadores" uid="tablaFinanciadores" class="tablacoin" id="tablaFinanciadores"
						summary="Listado de financiadores" cellspacing="0" cellpadding="0"  style="width:95%">
						<display:column title="Tipo" style="width:23%">
							<s:property value="%{@org.gestoresmadrid.core.registradores.model.enumerados.TipoPersonaRegistro@convertirTextoDesdeXML(#attr.tablaFinanciadores.tipoPersona)}" />
						</display:column>
						<display:column title="Nif/Cif" property="persona.nif" style="width:23%"/>
						<display:column title="Nombre" property="persona.nombre" style="width:23%"/>
						<display:column title="Apellido" property="persona.apellido1RazonSocial" style="width:23%" />
			...
			<s:else>
				<td align="left" nowrap="nowrap" >
					<label for="arrendadores" style="color:red;font-size:12px">
						FALTAN LOS DATOS DE LOS FINANCIADORES
					</label>
				</td>
			</s:else> 
		</tr>		
