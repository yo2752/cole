		...
		<tr>
					...
					<tr>
						...
						<td align="left">
							<s:textfield name="tramiteRegRbmDto.fechaDocumento.anio" id="aniofechaDocumento"
								onfocus="this.className='inputfocus';" size="5" maxlength="4" onblur = "this.className='input2';validaInputFecha(document.getElementById('diafechaDocumento'), document.getElementById('mesfechaDocumento'), document.getElementById('aniofechaDocumento'));"/>
						</td>
						<td align="left">
			...
			<td>
				<s:select name="tramiteRegRbmDto.tipoContrato" 
					list="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().getListRentingContractType()" 
					listKey="key"
					headerKey="" 
	...
	<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
  	...
  	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		<tr>			
			...
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impTotalArrend" id="datosFinancierosDtoImpTotalArrend" size="13" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')"></s:textfield></td>
			...
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impOpcionCompra" id="datosFinancierosDtoPurchaseImpOpcionCompra" size="13" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')"></s:textfield></td>
		</tr>
		<tr> 
			...
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impEntregaCuenta" id="datosFinancierosDtoImpEntregaCuenta" size="13" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')"></s:textfield></td> 
			...
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.impFianza" id="datosFinancierosDtoImpFianza" size="13" maxlength="13" onkeypress="return soloNumeroDecimal(event, this, '10', '2')"></s:textfield></td>  
		...
		<tr>
			...
			<td><s:textfield name="tramiteRegRbmDto.datosFinanciero.numeroMeses" id="datosFinancierosDtoNumeroMeses" size="13" maxlength="10" onkeypress="return soloNumeroDecimal(event, this, '10', '0')"></s:textfield></td>
					...
					<tr>
						...
						<td align="left">
							<s:textfield name="tramiteRegRbmDto.datosFinanciero.fecUltVencimientoDatFinancieros.anio" id="anioFecUltVencimiento"
								onfocus="this.className='inputfocus';" size="5" maxlength="4" onblur = "this.className='input2';validaInputFecha(document.getElementById('diaFecUltVencimiento'), document.getElementById('mesFecUltVencimiento'), document.getElementById('anioFecUltVencimiento'));"/>
						</td>
						<td align="left">
   ...
   <table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
						...
						<tr>
							...
							<td align="left">
								<s:textfield name="tramiteRegRbmDto.datosFinanciero.fecRevisionDatFinancieros.anio" id="anioFecRevision"
									onfocus="this.className='inputfocus';" size="5" maxlength="4" onblur = "this.className='input2';validaInputFecha(document.getElementById('diaFecRevision'), document.getElementById('mesFecRevision'), document.getElementById('anioFecRevision'));"/>
							</td>
							<td align="left">
	    ...
	    <tr>
			<td align="center" nowrap="nowrap">
				<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
					<input type="button" onclick="javascript:aniadirFirma('Renting','formData', 'cargarPopUpDatosFirmaRegistroRenting.action');" id="btnAniadirFirmaRenting" class="button corporeo" value="Añadir"/>
				</s:if>
			</td>
		</tr>
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">	
	  	 <tr>
			<td align="center" nowrap="nowrap" colspan="6">
				<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
					<input type="button" onclick="javascript:aniadirComision('Renting','formData', 'cargarPopUpComisionRegistroRenting.action');" id="btnAniadirComisionRenting" class="button corporeo" value="Añadir" />
				</s:if>
			</td>
		</tr>
	</table> 
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
	    <tr>
			<td align="center" nowrap="nowrap" colspan="6">
				<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
					<input type="button" onclick="javascript:aniadirImporte('Renting','formData', 'cargarPopUpOtrosImportesRegistroRenting.action');" id="btnAniadirImporteRenting" class="button corporeo" value="Añadir" />
				</s:if>
			</td>
		</tr>
	</table>
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
	    <tr>
			<td align="center" nowrap="nowrap" colspan="6">
				<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
					<input type="button" onclick="javascript:aniadirDeuda('Renting', 'formData', 'cargarPopUpReconocimientoDeudaRegistroRenting.action');" id="btnAniadirDeudaRenting" class="button corporeo" value="Añadir" />
				</s:if>
			</td>
		</tr>
	</table>
