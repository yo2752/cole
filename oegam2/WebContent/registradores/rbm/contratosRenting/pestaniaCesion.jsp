		...
		<tr>
			<td align="center" nowrap="nowrap" colspan="6">
				<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
					<input type="button" onclick="javascript:aniadirRepresentanteRBM('cargarPopUpRepresentanteCesionarioRegistroRenting.action','Cesionario');" id="btnAniadirRepresentanteCesionarioRenting" class="button corporeo"value="Añadir representante" />
				</s:if>
			</td>
		</tr>
	</table>
