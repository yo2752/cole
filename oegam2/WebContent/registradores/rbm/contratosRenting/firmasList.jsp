...
<display:table name="tramiteRegRbmDto.datoFirmas" uid="tablaDatosFirma" class="tablacoin" id="tablaDatosFirma"
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
		<display:column title="Eliminar" style="width:10%">						
			 <a href="javascript:doConfirmPost('¿Está seguro de que desea borrar estos datos de firma?', 'formData', 'borrarDatosFirmaRenting.action?identificador=<s:property value="#attr.tablaDatosFirma.idDatoFirma"/>', null);">
				Eliminar
			</a>
		</display:column>					
		<display:column style="width:3%">
			<a href="javascript:aniadirFirma('Renting', 'formData','cargarPopUpDatosFirmaRegistroRenting.action?identificador=${tablaDatosFirma.idDatoFirma}')" >
