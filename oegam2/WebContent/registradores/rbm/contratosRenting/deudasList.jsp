...
<display:table name="tramiteRegRbmDto.datosFinanciero.reconocimientoDeudas" uid="tablaReconocimientoDeuda" class="tablacoin" id="tablaReconocimientoDeuda"
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegRbmDto.estado,tramiteRegRbmDto.numReg)">
		<display:column title="Eliminar" style="width:10%">						
			 <a href="javascript:doConfirmPost('¿Está seguro de que desea borrar este Reconocimiento de Deuda?', 'formData', 'borrarReconocimientoDeudaRenting.action?identificador=<s:property value="#attr.tablaReconocimientoDeuda.idReconocimientoDeuda"/>', null);">
				Eliminar
			</a>
		</display:column>					
		<display:column style="width:3%">
			<a href="javascript:aniadirDeuda('Renting', 'formData','cargarPopUpReconocimientoDeudaRegistroRenting.action?identificador=${tablaReconocimientoDeuda.idReconocimientoDeuda}')" >
