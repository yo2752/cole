...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Contrato de Renting</span>
			</td>
		</tr>
	</table>
</div>
<div class="contenido">
	...
	<s:form action="guardarRenting.action"  id="formData" name="formData" cssClass="transformable" enctype="multipart/form-data">
	...
	<div id="divEmergentePopUpRenting" style="display: none; background: #f4f4f4;"></div>
