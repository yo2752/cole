...
<div class="contenido">
	...
	<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
	 ...
	 <table border="0" class="tablaformbasicaTC">
		<tr>
			<s:if test="tramiteRegRbmDto.arrendatarios != null && tramiteRegRbmDto.arrendatarios.size() > 0">
				<td align="right">
					<display:table name="tramiteRegRbmDto.arrendatarios" uid="tablaArrendatarios" class="tablacoin" id="tablaArrendatarios"
						summary="Listado de arrendatarios" cellspacing="0" cellpadding="0"  style="width:95%">
						<display:column title="Tipo" style="width:23%">
							<s:property value="%{@org.gestoresmadrid.core.registradores.model.enumerados.TipoPersonaRegistro@convertirTextoDesdeXML(#attr.tablaArrendatarios.tipoPersona)}" />
						</display:column>
			...
			<s:else>
				<td align="left" nowrap="nowrap" >
					<label for="arrendadores" style="color:red;font-size:12px">
						FALTAN LOS DATOS DE LOS ARRENDATARIOS
					</label>
				</td>
			</s:else> 
		</tr>		
	...
	<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
		<tr>
			<td class="tabular" style="">
				<span class="titulo">Arrendadores:</span>
			</td>
		</tr>
	</table>
	 <table border="0" class="tablaformbasicaTC">
		<tr>
			<s:if test="tramiteRegRbmDto.arrendadores != null && tramiteRegRbmDto.arrendadores.size() > 0">
				<td align="right">
					<display:table name="tramiteRegRbmDto.arrendadores" uid="tablaArrendadores" class="tablacoin" id="tablaArrendadores"
						summary="Listado de arrendadores" cellspacing="0" cellpadding="0"  style="width:95%">
						<display:column title="Tipo" style="width:23%">
							<s:property value="%{@org.gestoresmadrid.core.registradores.model.enumerados.TipoPersonaRegistro@convertirTextoDesdeXML(#attr.tablaArrendadores.tipoPersona)}" />
						</display:column>
						<display:column title="Nif/Cif" property="persona.nif" style="width:23%"/>
						<display:column title="Nombre" property="persona.nombre" style="width:23%"/>
						<display:column title="Apellido" property="persona.apellido1RazonSocial" style="width:23%" />
			...
			<s:else>
				<td align="left" nowrap="nowrap" >
					<label for="arrendadores" style="color:red;font-size:12px">
						FALTAN LOS DATOS DE LOS ARRENDADORES
					</label>
				</td>
			</s:else> 
		</tr>		
