...
<div class="contenido">
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		...
		<tr>
		  <td  colspan="2" align="left" nowrap="nowrap" width="18%"><label for="fechaFirma">Fecha &uacute;ltima firma<span class="naranja">*</span></label></td>
		  <td>
				<table style="width:20%">
					<tr>
						<td align="left">
							<s:textfield name="tramiteRegRbmDto.datoFirmaDto.fecFirmaDatFirma.dia" id="diaFecFirma"
								onfocus="this.className='inputfocus';" size="2" maxlength="2" onblur = "this.className='input2';validaInputFecha(document.getElementById('diaFecFirma'), document.getElementById('mesFecFirma'), document.getElementById('anioFecFirma'));"/>
						</td>
						<td align="left">
						...
						<td align="left">
							<s:textfield name="tramiteRegRbmDto.datoFirmaDto.fecFirmaDatFirma.anio" id="anioFecFirma"
								onfocus="this.className='inputfocus';" size="5" maxlength="4" onblur = "this.className='input2';validaInputFecha(document.getElementById('diaFecFirma'), document.getElementById('mesFecFirma'), document.getElementById('anioFecFirma'));"/>
						</td>
						
						<td align="left">
							<a href="javascript:;" onClick="if(self.gfPop)gfPop.fPopCalendarSplit(document.getElementById('anioFecFirma'), document.getElementById('mesFecFirma'), document.getElementById('diaFecFirma'));return false;" 
