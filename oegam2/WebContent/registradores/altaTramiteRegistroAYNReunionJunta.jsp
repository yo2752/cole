...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Aceptaci&oacute;n de Nombramiento</span>
			</td>
		</tr>
	</table>
</div>
...
<ol id="toc">
	...
	<li id="Certificantes"><a style="display:none;" id="pesCertif" href="#Certificantes">Certificaci&oacute;n</a></li>
	<li id="Junta"><a style="display:none;" id="pesJunta" href="#Junta">Reuni&oacute;n de la junta</a></li>
	<li id="Acuerdos"><a style="display:none;" id="pesAcuerdos" href="#Acuerdos">Nombramiento</a></li>
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegistro.estado,tramiteRegistro.numReg)">
		...
		<div id="botonBusqueda">
			<table width="100%">
				<tr>
					<td>
						<input type="button" value="Guardar" class="boton"  id="botonSeleccionarSociedad" onclick="return (validacionCamposSociedadGuardar('TramiteRegistroMd2'));" onKeyPress="this.onClick"/>
					</td>
					<td>
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegistro.estado,tramiteRegistro.numReg)">
		...
		<div id="botonBusqueda">
			<table width="100%">
				<tr>
					<td> 
						<input type="button" class="boton" value="Guardar" id="botonGuardarAYNReunionJunta" onclick="guardarTramiteRegistro();"/>
						&nbsp;
						<img id="loadingImage" style="display:none;margin-left:auto;margin-right:auto;" src="img/loading.gif">  
					</td>
				</tr>
...
<div  id="formaPago" class="contentTabs">  
	<%@include file="pestaniaFormaPagoAYNReunionJunta.jsp" %>
</div>

<%@include file="resumenTramiteAYNReunionJunta.jsp" %>
