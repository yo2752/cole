...
<div class="contenido">
		...
		<tr>
			...
			<td align="left"  nowrap="nowrap" >
				<s:radio id="idFormaPago" cssStyle="display:inline; width: 25px;" labelposition="left"
					...
					listKey="valorEnum" listValue="nombreEnum" name="tramiteRegRbmDto.formaPago"
			...
			<tr>
				...
				<td align="left"  nowrap="nowrap">
					<s:radio id="idTipoDatoBancario" cssStyle="display: inline;" labelposition="left"
						...
						listKey="valorEnum" listValue="nombreEnum" name="tramiteRegRbmDto.datosBancarios.tipoDatoBancario"
			...
			<tr id="idSeleccionDatosBancFavoritos">
				...
				<td align="left" nowrap="nowrap">
					<s:select id="idComboExistente"
						list="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().getListaDatosBancariosFavoritos(tramiteRegRbmDto)" 
					...
					<s:hidden id="idDatosBancarios" name="tramiteRegRbmDto.datosBancarios.idDatosBancarios"/>
				</td>
			</tr>
		</table>
			...
			<table  class="tablaformbasica">
				<tr>
					...
					<td align="left" nowrap="nowrap" colspan = "2">
						<s:textfield name="tramiteRegRbmDto.datosBancarios.nombreTitular" id="idNombreTitularDatBancarios" size="31" maxlength="100" 
				...
				<tr>
					<td align="left" nowrap="nowrap"><label for="cuentaProvinciaId" class="small">Provincia:<span class="naranja">*</span></label></td>
	               	<td>
	                	<s:select name="tramiteRegRbmDto.datosBancarios.idProvincia" 
	               ...
	               <td>       
						<s:select id="cuentaSelectMunicipioId"
								list="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().getMunicipiosPorProvincia(tramiteRegRbmDto.datosBancarios.idProvincia)"
								onchange="javascript:seleccionMunicipio(this, 'cuenta');"
								name="tramiteRegRbmDto.datosBancarios.idMunicipio"
				...
				<tr>
							...
							<tr>
								<td>
									...
									<s:textfield autocomplete="off" size="4" maxlength="4"
										id="idIban" name="tramiteRegRbmDto.datosBancarios.iban"
										onblur="this.className='input2';"
								...
								<td>
									...
									<s:textfield autocomplete="off" size="4" maxlength="4"
										id="idEntidad" name="tramiteRegRbmDto.datosBancarios.entidad"
								...
								<td>
									...
									<s:textfield autocomplete="off" size="4" maxlength="4"
										id="idOficina" name="tramiteRegRbmDto.datosBancarios.oficina"
										onkeypress="return validarNumerosEnteros(event)" onblur="this.className='input2';"
										onfocus="this.className='inputfocus';"></s:textfield>
								</td>
								<td>
									...
									<s:textfield autocomplete="off" size="2" maxlength="2"
										id="idDC" name="tramiteRegRbmDto.datosBancarios.dc"
										onkeypress="return validarNumerosEnteros(event)" onblur="this.className='input2';"
										onfocus="this.className='inputfocus';"></s:textfield>
								</td>
								<td>
									...
									<s:textfield autocomplete="off" size="10"
										...
										name="tramiteRegRbmDto.datosBancarios.numeroCuentaPago"
										onkeypress="return validarNumerosEnteros(event)" onblur="this.className='input2';"
										onfocus="this.className='inputfocus';"></s:textfield>
								</td>
							</tr>
					...
					<td align="left" nowrap="nowrap">
						<s:checkbox name="tramiteRegRbmDto.datosBancarios.esFavorita" id="idFavoritoDatBancario"
				...
				<tr>
					...
					<td align="left" nowrap="nowrap">
						<s:textfield name="tramiteRegRbmDto.datosBancarios.descripcion" id="idDescripcionDatBancarios" size="25" maxlength="25" 
							onblur="this.className='input';" onfocus="this.className='inputfocus';"/>
					</td>
				</tr>
			</table>
	...
	<div id = "divIdentificacionCorpme" >
		...
		<table border="0" class="tablaformbasicaTC" style="width: 100%;" >
			<tr>
				<td colspan = "6">
					<s:if test="tramiteRegRbmDto.presentador.passwordCorpme == null || tramiteRegRbmDto.presentador.usuarioCorpme == null">
