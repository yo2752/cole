...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Cese y Nombramiento en Reuni&oacute;n Junta</span>
			</td>
		</tr>
	</table>
</div>
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegistro.estado,tramiteRegistro.numReg)">
		...
		<div id="botonBusqueda">
			<table width="100%">
				<tr>
					<td>
						<input type="button" value="Guardar" class="boton"  id="botonSeleccionarSociedad" onclick="return (validacionCamposSociedadGuardar('TramiteRegistroMd1'));" onKeyPress="this.onClick"/>
					</td>
					<td>
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegistro.estado,tramiteRegistro.numReg)">
		...
		<div id="botonBusqueda">
			<table width="100%">
				<tr>
					<td> 
						<input type="button" class="boton" value="Guardar" id="botonGuardarCYNReunionJunta" onclick="guardarTramiteRegistro();"/>
						&nbsp;
						<img id="loadingImage" style="display:none;margin-left:auto;margin-right:auto;" src="img/loading.gif">  
					</td>
				</tr>
...
<div  id="formaPago" class="contentTabs">  
	<%@include file="pestaniaFormaPagoCYNReunionJunta.jsp" %>
</div>

<!-- Contenido de la pestaña del formulario que contiene el resumen del estado del trámite -->
<%@include file="resumenTramiteCYNReunionJunta.jsp" %>
