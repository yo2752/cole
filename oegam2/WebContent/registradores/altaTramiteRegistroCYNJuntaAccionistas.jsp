...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">S.A Cese y Nombramiento</span>
			</td>
		</tr>
	</table>
</div>
...
<ol id="toc">
	...
	<li id="Junta"><a style="display:none;" id="pesJunta" href="#Junta">Junta Accionistas</a></li>
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegistro.estado,tramiteRegistro.numReg)">
		...
		<div id="botonBusqueda">
			<table width="100%">
				<tr>
					<td>
						<input type="button" value="Guardar" class="boton"  id="botonSeleccionarSociedad" onclick="return (validacionCamposSociedadGuardar('TramiteRegistroMd3'));" onKeyPress="this.onClick"/>
					</td>
					<td>
	...
	<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esEditable(tramiteRegistro.estado,tramiteRegistro.numReg)">
		...
		<div id="botonBusqueda">
			<table width="100%">
				<tr>
					<td> 
						<input type="button" class="boton" value="Guardar" id="botonGuardarCYNJuntaAccionistas" onclick="guardarTramiteRegistro();"/>
						&nbsp;
						<img id="loadingImage" style="display:none;margin-left:auto;margin-right:auto;" src="img/loading.gif">  
					</td>
				</tr>
...
<%@include file="juntaAccionistas.jsp" %>
...
<div  id="formaPago" class="contentTabs">  
	<%@include file="pestaniaFormaPagoCYNJuntaAccionistas.jsp" %>
</div>

<!-- Contenido de la pestaña del formulario que contiene el resumen del estado del trámite -->
<%@include file="resumenTramiteCYNJuntaAccionistas.jsp" %>
