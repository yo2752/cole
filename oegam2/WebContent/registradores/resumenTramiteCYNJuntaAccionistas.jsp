...
<div class="contentTabs" id="Resumen">
	...
	<div class="nav">
		<table border="0" cellSpacing="0" cellPadding="0" style="background-color: transparent; width: 100%">
			<tr>
				<td class="tabular" style="">
					<span class="titulo">Informaci&oacute;n de la Junta de accionistas</span>
				</td>
			</tr>
		</table>
	</div>
	...
	<div id="busqueda" class="busqueda">
		<%@include file="/registradores/resumen/resumenJuntaAccionistas.jsp" %>
	</div>
	
	<div>&nbsp;</div>
	
	<div id="busqueda" class="busqueda">
		<%@include file="/registradores/resumen/resumenMedios.jsp" %>
	</div>
	...
	<div id="busqueda" class="busqueda">
		<%@include file="/registradores/resumen/resumenCesesModelos3y4.jsp" %>
	</div>
	...
	<div id="busqueda" class="busqueda">
		<%@include file="/registradores/resumen/resumenNombramientosModelos3y4.jsp" %>
	</div>
				...
				<tr>
					<td>
						<s:if test="tramiteRegistro.estado == 1">
							<input type="button" value="Validar" class="boton" id="btnValidar" onclick="javascript:doPost('formData', 'validarTramiteTramiteRegistroMd3.action#Resumen', null);"/>
						</s:if>
						<s:if test="tramiteRegistro.estado == 28">
							<input type="button" id="btnFirmar" value="Firmar" class="boton" onclick="construirRm(true, 3);" />
						</s:if>
						&nbsp;
						...
						<input type="button" value="Ver documento" class="boton" id="btnVerDocumento" onclick="construirRm(false, 3);" />
						&nbsp;
