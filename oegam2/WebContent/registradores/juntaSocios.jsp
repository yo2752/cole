...
<div class="contentTabs" id="Junta">
	...
	<div id="busqueda" class="busqueda">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap" width="10%">
					<s:select list="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().getTipoReunionJunta()"
						...
						listValue="nombreEnum" listKey="valorEnum" title="Tipo de reunión" headerKey="" headerValue="-"/>
				</td>
				<td align="right" nowrap="nowrap" width="10%">
		...
		<tr>
			...
			<tr>
				<td align="right" nowrap="nowrap" width="2%">
					<label for="transcripcionContenidoIntegro">Contenido Integro de la Convocatoria<span class="naranja">*</span>:</label>
				</td>
				<td align="left" nowrap="nowrap" colspan="6">
					<s:textarea name="tramiteRegistro.reunion.contenidoConvo" id="transcripcionContenidoIntegro"
		...
		<s:if test="tramiteRegistro == null || tramiteRegistro.estado == null || tramiteRegistro.estado.getNombreEnum()=='Iniciado'">
			<div id="botonBusqueda">
				<table width="100%">
					<tr>
						<td width="50%" align="right">
							<input type="button" value="Guardar" class="boton" onclick="guardarReunionSocios();" id="botonSeleccionarJuntaSocios"/>
						</td>
						<td>
							<img id="loading4.4Image" style="display:none;margin-left:auto;margin-right:auto;" src="img/loading.gif">
						</td>
						<td>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</td>
						<td width="50%" align="left">
							<input type="button" class="boton" value="Limpiar campos" onclick="limpiarCamposJuntaSocios();" />
						</td>
					</tr>	
				</table>	
			</div>
