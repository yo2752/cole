...
<div class="contenido">	
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		<tr>
			...
			<td align="left" nowrap="nowrap" width="24%">
				<s:textfield id="idNifPresentador" name="tramiteRegistro.presentador.nif"  onblur="this.className='input2';calculaLetraNIF(this)" 
       				readonly="true" onfocus="this.className='inputfocus';" style="text-transform : uppercase"
       				size="9" maxlength="9"/>
       			<s:hidden name="tramiteRegistro.presentador.numColegiado"/>
       			<s:hidden name="tramiteRegistro.presentador.direccionDto.idDireccion"/>
       			
	    	</td>
	    	 <td align="left" nowrap="nowrap">
       			<label for="labelTipoPersona">Tipo de persona:</label>
       		</td>
       		<td><s:textfield value="%{@org.gestoresmadrid.core.registradores.model.enumerados.TipoPersonaRegistro@convertirTexto(#attr.tramiteRegistro.presentador.tipoPersona)}" readonly="true"/></td>
		</tr>
		<tr>       
       		<td align="left" nowrap="nowrap">
       		...
       		<td align="left" nowrap="nowrap">
	         	<s:textfield id="idSexoPresentador" name="tramiteRegistro.presentador.sexo"
       		...
       		<td align="left" nowrap="nowrap">
       			<s:textfield id="idPrimerApeRazonSocialPresentador"  name="tramiteRegistro.presentador.apellido1RazonSocial"  
      	...
      	<tr>        	       			
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idSegundoApePresentador" name="tramiteRegistro.presentador.apellido2" onblur="this.className='input2';" 
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idNombrePresentador" name="tramiteRegistro.presentador.nombre" onblur="this.className='input2';" 
      	...
      	<tr>
   				...
   				<table width="20%">
					<tr>
						<td align="left" nowrap="nowrap" width="5%">
							<s:textfield name="tramiteRegistro.presentador.fechaNacimiento.dia" id="idDiaNacPresentador" onblur="this.className='input2';" 
								onkeypress="return validarDia(this, event)" onfocus="this.className='inputfocus';" size="2" maxlength="2" readonly="true"/>
						</td>
						<td width="1%">/</td>
						<td align="left" nowrap="nowrap" width="5%">
							<s:textfield name="tramiteRegistro.presentador.fechaNacimiento.mes" id="idMesNacPresentador" onblur="this.className='input2';" 
								onkeypress="return validarMes(this, event)" onfocus="this.className='inputfocus';"  size="2" maxlength="2" readonly="true"/>
						</td>
						<td width="1%">/</td>
						<td align="left" nowrap="nowrap" width="5%">
							<s:textfield name="tramiteRegistro.presentador.fechaNacimiento.anio" id="idAnioNacPresentador" onblur="this.className='input2';" onkeypress="return validarAnio(this, event)"
			...
			<td align="left" nowrap="nowrap">
				<s:textfield name="tramiteRegistro.presentador.telefonos" id="idTelefonoPresentador" size="10" maxlength="9" onblur="this.className='input2';" 
      	...
      	<tr>        	       			
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idCorreoPresentador" name="tramiteRegistro.presentador.correoElectronico" onblur="this.className='input2';" 
	   				onfocus="this.className='inputfocus';" size="30" maxlength="100" readonly="true"/>
   			</td>
      	</tr>
	</table>
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		<tr>
			...
			<td><s:textfield value="%{@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesModelos@getInstance().getProvinciaNombre(tramiteRegistro.presentador.direccionDto.idProvincia)}" readonly="true"/></td>
			
			<td align="left" nowrap="nowrap">
				<label for="labelMunicipioPresentador">Municipio:</label>
			</td>
			<td><s:textfield value="%{@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().getMunicipioNombre(tramiteRegistro.presentador.direccionDto.idMunicipio, tramiteRegistro.presentador.direccionDto.idProvincia)}" readonly="true"/></td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap"><label for="labelPuebloPresentador">Pueblo: </label></td>
   			 <td><s:textfield name="tramiteRegistro.presentador.direccionDto.pueblo" id="cesionNumLocal" size="18" maxlength="70" readonly="true"></s:textfield></td>
			...
			<td>
				<s:textfield  onblur="this.className='input2';" onfocus="this.className='inputfocus';" 
					...
					name="tramiteRegistro.presentador.direccionDto.idTipoVia"
		...
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<s:textfield name="tramiteRegistro.presentador.direccionDto.nombreVia" id="idNombreViaPresentador" size="25" onblur="this.className='input2';" 
	       			onfocus="this.className='inputfocus';" readonly="true"/>
			</td>
			<td align="left" nowrap="nowrap">
			...
			<td align="left" nowrap="nowrap">
				<s:textfield name="tramiteRegistro.presentador.direccionDto.codPostal" id="idCodPostalPresentador" size="5" maxlength="5" onblur="this.className='input2';" 
	       			onfocus="this.className='inputfocus';" readonly="true"/>
			</td>
		</tr>
	</table>
	<table  cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left" style="100%">
      	<tr>    			
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idNumeroDireccionPresentador" name="tramiteRegistro.presentador.direccionDto.numero" 
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idLetraDireccionPresentador" name="tramiteRegistro.presentador.direccionDto.letra" 
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idEscaleraDireccionPresentador" name="tramiteRegistro.presentador.direccionDto.escalera"
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idPisoDireccionPresentador" name="tramiteRegistro.presentador.direccionDto.planta"
      	...
      	<tr>    			
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idPuertaDireccionPresentador" name="tramiteRegistro.presentador.direccionDto.puerta"
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idBloqueDireccionPresentador" name="tramiteRegistro.presentador.direccionDto.bloque"
	   				onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="4" maxlength="10" readonly="true"/>
   			</td>
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idKmDireccionPresentador" name="tramiteRegistro.presentador.direccionDto.km"
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="hmDireccionPresentador" name="tramiteRegistro.presentador.direccionDto.hm" 
	   				onblur="this.className='input2';" onfocus="this.className='inputfocus';" 
