...
<div id="buscarCertificante">
	<%@include file="../../includes/erroresMasMensajes.jspf"%>

	<div class="nav">
		<table cellSpacing="0" cellPadding="0" style="background-color: transparent; width: 100%">
			<tr>
				<td class="tabular" style=""><span class="titulo">B&uacute;squeda de certificantes</span></td>
			</tr>
		</table>
	</div>
		...
		<tr>
			...
			<td align="left" nowrap="nowrap" colspan="3">
				<s:select list="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().getTipoCargos()" 
					...
					name="consultaSociedadCargoBean.codigoCargo" listValue="descCargo" listKey="codigoCargo" title="Cargo del certificante" headerKey="" headerValue="Seleccionar" />
			</td>
		</tr>
		<tr>
			<td colspan="6">&nbsp;</td>
	...
	<div id="botonBusqueda">
		<table width="100%">
			<tr>
				<td>
					<input type="button" class="boton" name="bBuscar" id="bBuscar" value="Buscar" onkeypress="this.onClick" onclick="javascript:buscarCertificante();"/>			
				</td>
				<td>
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td> 
					<input type="button" class="boton" value="Limpiar campos" onclick="limpiarFormulario('buscarCertificante');"/>
				</td>
			</tr>
			<tr>
				<td colspan="4">&nbsp;</td>
	...
	<div class="nav">
		<table cellSpacing="0" cellPadding="0" style="background-color: transparent; width: 100%">
			<tr>
				<td class="tabular" style=""><span class="titulo">Lista de certificantes</span></td>
			</tr>
		</table>
	</div>
						...
						<tr>
							...
							<td width="10%" align="right">
								<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboResultadosPorPagina()"
									...
									title="Resultados por página" onchange="cambiarElementosPorPaginaConsulta('navegarCertificante.action','displayTagDiv', this.value);" />
							</td>
						</tr>
					</table>
				</td>
	...
	<div id="displayTagDiv" class="divScroll">
		...
		<display:table name="lista" requestURI="navegarCertificante.action" class="tablacoin" uid="row" summary="Listado de Cargos" cellspacing="0" cellpadding="0">
			...
			<display:column title="<input type='checkbox' name='checkAll' onClick='marcarTodos(this, document.formData.certificantesMarcados);' 
					onKeyPress='this.onClick'/>" style="width:1%;text-align:center;">
		    	<input type="checkbox" name="certificantesMarcados" value="${row.id.nifCargo}-${row.id.codigoCargo}" class="checkbox" 
		    		<s:if test="%{#attr.row.certif==1}">
		      			checked=checked
		      		</s:if>
		      	/>
			</display:column>
	...
	<div id="botonBusqueda">
		<table width="100%">
			<tr>
				<td> 
					<input type="button" class="boton" value="Seleccionar" id="botonActualizarCertificante" onclick="seleccionarCertificante();"/>
					&nbsp;
