				...
				<div class="divScroll">
					<display:table name="tramiteRegistro.nombramientos" excludedParams="*" class="tablacoin" uid="row" summary="Certificantes" style="width:98%"
						cellspacing="0" cellpadding="0">
							...
							<display:column property="sociedadCargo.personaCargo.apellido1RazonSocial" title="Apellido 1" sortable="false" 
								style="width:20%;text-align:left;"/>
								<display:column property="sociedadCargo.personaCargo.apellido2" title="Apellido 2" sortable="false" 
								style="width:20%;text-align:left;"/>
		...
		<s:elseif test="tramiteRegistro.nombramientos == null || tramiteRegistro.nombramientos.size() == 0">
			<td align="center" nowrap="nowrap" >
				<label for="sinCertificantes" style="color:red;font-size:12px">
					REQUERIDO (Deben constar los datos del nombramiento aceptado)
				</label>
			</td>
		</s:elseif>
	</tr>		
