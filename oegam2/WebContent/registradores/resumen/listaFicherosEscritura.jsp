		...
		<table cellPadding="1" cellSpacing="3"  cellpadding="1"  class="tablaformbasica" width="100%" border="0">
			<tr>
				...
				<td align="right" nowrap="nowrap" width="30%">
					<input type="button" class="boton" id="botonSubirFichero" value="Subir fichero" onclick="javascript:doPost('formData', 'incluirFicheroTramiteRegistroMd6.action\u0023documentacion', '', '');" />
				</td>
