...
<table border="0" class="tablaformbasicaTC">
	...
	<tr>
		<td align="right" nowrap="nowrap">
			<label for="codigoRegistro">C&oacute;digo registro destino:</label>
		</td>
		<td align="left" nowrap="nowrap" width="40px">
			<s:textfield name="tramiteRegistro.registro.idRegistro" id="codigoRegistro" 
				onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="10" maxlength="10" disabled="true"  />
		</td>
	</tr>
	<tr>
		<td align="right" nowrap="nowrap">
