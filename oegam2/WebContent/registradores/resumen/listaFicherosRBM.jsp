...
<%@ taglib uri="http://displaytag.sf.net" prefix="display"%>
	...
	<table cellPadding="1" cellSpacing="3" cellpadding="1" class="tablaformbasica" width="100%" >
		<tr>
			<td align="center">
				<display:table name="tramiteRegRbmDto.ficherosSubidos" excludedParams="*" style="width:95%"
	...
	<s:if test="tramiteRegRbmDto.estado && tramiteRegRbmDto.estado != 1 && tramiteRegRbmDto.estado != 4
			&& tramiteRegRbmDto.estado != 28 && tramiteRegRbmDto.estado != 29" >		
		...
		<table cellPadding="1" cellSpacing="3" cellpadding="1" class="tablaformbasica" width="100%" >
			<tr>
				<td align="center">
					<display:table name="tramiteRegRbmDto.listaDocuRecibida" excludedParams="*" style="width:95%"
						class="tablacoin" id="Bien" summary="Listado de Ficheros Subidos" cellspacing="0" cellpadding="0" uid="row">	
