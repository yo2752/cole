...
<table border="0" class="tablaformbasicaTC">
	<tr>
		<s:if test="tramiteRegistro.ceses != null && tramiteRegistro.ceses.size() > 0">
			<td align="right" width="100%">
				<div class="divScroll">
					<display:table name="tramiteRegistro.ceses" excludedParams="*" class="tablacoin" uid="row" summary="Certificantes" cellspacing="0" cellpadding="0" style="width:98%">
							<display:column property="sociedadCargo.personaCargo.nif" title="Nif" sortable="false" style="width:10%;text-align:left;"/>
							<display:column property="sociedadCargo.personaCargo.nombre" title="Nombre" sortable="false" style="width:15%;text-align:left;" />
		...
		<s:elseif test="tramiteRegistro.ceses == null || tramiteRegistro.ceses.size() == 0">
			<s:if test="tramiteRegistro.nombramientos == null || tramiteRegistro.nombramientos.size() == 0">
				<td align="center" nowrap="nowrap" >
					<label for="sinCertificantes" style="color:red;font-size:12px">
						REQUERIDO (Al menos debe constar un acuerdo (cese o nombramiento)
					</label>
				</td>
			</s:if>
			<s:elseif test="tramiteRegistro.nombramientos != null && tramiteRegistro.nombramientos.size() > 0">
				<td align="center" nowrap="nowrap" >
					<label for="sinCertificantes" style="color:red;font-size:12px">
						No requerido
					</label>
		...
		<s:elseif test="tramiteRegistro.ceses != null && tramiteRegistro.nombramientos != null">
			<s:if test="tramiteRegistro.ceses.size() == 0 && tramiteRegistro.nombramientos.size() == 0">
				<td align="center" nowrap="nowrap" >
					<label for="sinCertificantes" style="color:red;font-size:12px">
						REQUERIDO (Al menos debe constar un acuerdo (cese o nombramiento)
					</label>
