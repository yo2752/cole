...
<table border="0" class="tablaformbasicaTC">
	...
	<tr>
		<tr>
			...
			<s:if test="tramiteRegistro.reunion != null && tramiteRegistro.reunion.convocatoria != null && tramiteRegistro.reunion.convocatoria.numeroConvo != null && tramiteRegistro.reunion.convocatoria.numeroConvo != ''">
				<td align="left" nowrap="nowrap" width="100px">
					<s:textfield name="tramiteRegistro.reunion.numeroConvo" id="ordenConvocatoria" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="12" maxlength="12" disabled="true"/>
				</td>
			</s:if>
			<s:else>
	...
	<tr>
		<td align="right" nowrap="nowrap">
			<label for="contenidoConvo">Contenido &iacute;ntegro de la convocatoria:</label>
		</td>
		<td align="left" nowrap="nowrap">
			<s:if test="tramiteRegistro.reunion != null && tramiteRegistro.reunion.contenidoConvo != null && tramiteRegistro.reunion.contenidoConvo != ''">
				<s:textfield name="tramiteRegistro.reunion.contenidoConvo" id="contenidoConvo" onblur="this.className='input2';"
					onfocus="this.className='inputfocus';" size="10" maxlength="10" disabled="true" value="Establecido" />
			</s:if>
			<s:else>
				<s:textfield name="contenidoConvo" id="contenidoConvo" onblur="this.className='input2';"
					onfocus="this.className='inputfocus';" size="10" maxlength="10"
					disabled="true" cssStyle="color:red" value="REQUERIDO"/>
			</s:else>
		</td>
