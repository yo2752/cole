...
<%@ taglib uri="etiquetasOegam" prefix="oegam"%>
	...
	<div id="contenido" class="contentTabs" style="display: block; text-align: center;">
		<div class="nav">
			<table width="100%">
				<tr>
					<td class="tabular">
						<span class="titulo">Evolución del trámite de registro <s:property value="consultaEvolucionTramiteRegistroBean.idTramiteRegistro" /></span>
					</td>
				</tr>
			</table>
		</div>
	...
	<div class="busqueda">
							...
							<tr>
								...
								<td width="10%" align="right">
									<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboResultadosPorPagina()" 
											...
											onchange="cambiarElementosPorPaginaConsulta('navegarConsultaEvTramiteRg.action', 'displayTagDiv', this.value);" />
								</td>
							</tr>
						</table>
					</td>
		...
		<div id="displayTagDiv">
			...
			<display:table name="lista" excludedParams="*" sort="external" class="tablacoin" uid="tablaEvolucionTramiteRegistro"
				summary="Listado de Estados de Trámites Registro" cellspacing="0" cellpadding="0" requestURI="navegarConsultaEvTramiteRg.action"
				decorator="org.gestoresmadrid.oegam2.view.decorator.DecoratorEvolucionTramiteRegistro">
				
				<display:column property="id.idTramiteRegistro" title="Nº expediente" style="width:4%" />
