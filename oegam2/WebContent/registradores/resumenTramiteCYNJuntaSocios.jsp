...
<div class="contentTabs" id="Resumen">
	...
	<div class="nav">
		<table border="0" cellSpacing="0" cellPadding="0" style="background-color: transparent; width: 100%">
			<tr>
				<td class="tabular" style="">
					<span class="titulo">Informaci&oacute;n de la Junta de socios</span>
				</td>
			</tr>
		</table>
	</div>
	...
	<div id="busqueda" class="busqueda">
		<%@include file="/registradores/resumen/resumenJuntaSocios.jsp" %>
	</div>
				...
				<tr>
					<td>
						<s:if test="tramiteRegistro.estado == 1">
							<input type="button" value="Validar" class="boton" id="btnValidar" onclick="javascript:doPost('formData', 'validarTramiteTramiteRegistroMd4.action#Resumen', null);"/>
						</s:if>
						<s:if test="tramiteRegistro.estado == 28">
							<input type="button" id="btnFirmar" value="Firmar" class="boton" onclick="construirRm(true, 4);" />
						</s:if>
						&nbsp;
						...
						<input type="button" value="Ver documento" class="boton" id="btnVerDocumento" onclick="construirRm(false, 4);" />
						&nbsp;
