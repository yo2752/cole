...
<div class="contentTabs" id="pesPendientes">
	...
	<s:if test="%{tramiteRegistro.acusesPendientes.size>0}">
		
		<table class="subtitulo" align="left" cellspacing="0">
			<tr>
				<td class="espacio"><img src="img/activo.gif" alt=" - "></td>
				<td>Acuses pendientes</td>
				<td align="right">
		...
		<div id="busqueda" class="busqueda">
			<table border="0" class="tablaformbasicaTC">
				...
				<tr>
					<td>
						<div class="divScroll">
							<display:table name="tramiteRegistro.acusesPendientes" excludedParams="*" class="tablacoin" uid="row" summary="Listado de notificaciones" cellspacing="0" cellpadding="0"
							decorator="org.gestoresmadrid.oegam2.view.decorator.DecoratorRegistroFueraSecuencia">
								...
								<s:if test="@org.gestoresmadrid.oegam2comun.registradores.utiles.UtilesVistaRegistradores@getInstance().esPermitidoFirmarAcuseFueraSecuencia(tramiteRegistro.estado,#attr.row.tipoMensaje)">
								...
								<s:else>
									<display:column title="Enviar acuse" style="width:40%;color:red;text-align:left;">                                        
										...
										<s:label style="color:red;text-align:left;" value="Para poder firmar este acuse debe ir antes a la pestaña resumen y firmar el acuse, ya que el trámite se encuentra en estado %{@org.gestoresmadrid.core.registradores.model.enumerados.EstadoTramiteRegistro@convertirTexto(tramiteRegistro.estado)}."/>
									</display:column>
								</s:else>
