	...
	<div class="contenido">
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				...
				<td align="left" nowrap="nowrap">
					...
					<s:else>
						<s:textfield id="idBastidor" name="vehiculoDto.bastidor" onblur="this.className='input2';"
								onfocus="this.className='inputfocus';" size="22" maxlength="21" readonly="true" style="background:#EEEEEE"/>
					</s:else>
				</td>
			...
			<tr>
				...
				<td>
					<s:if test="%{@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoAdmin() || @org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoColegio()}">
						<s:textfield name="vehiculoDto.matricula" id="idMatricula" onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="13" maxlength="9"  onkeypress="return validarMatricula(event)"
								onChange="return validarMatricula_alPegar(event)" onmousemove="return validarMatricula_alPegar(event)" />
					</s:if>
					<s:else>
						<s:textfield value="%{vehiculoDto.matricula}" id="idMatricula" onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="13" maxlength="9" cssClass="campo_disabled" name="idDireccion_admin"  onkeypress="return validarMatricula(event)"
								onChange="return validarMatricula_alPegar(event)" onmousemove="return validarMatricula_alPegar(event)" />
					</s:else>
				</td>
			</tr>
						...
						<tr>
							...
							<td align="left" nowrap="nowrap">
								<s:textfield name="vehiculoDto.fechaMatriculacion.anio" id="anioMatriculacion" onblur="this.className='input2';"
									onkeypress="return validarNumerosEnteros(event)" onfocus="this.className='inputfocus';" size="4" maxlength="4" />
							</td>
							<td align="left" nowrap="nowrap">
								<a href="javascript:;" onClick="if(self.gfPop)gfPop.fPopCalendarSplit(document.formData.anioMatriculacion, document.formData.mesMatriculacion, document.formData.diaMatriculacion);return false;" title="Seleccionar fecha">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:checkbox disabled="%{flagDisabledFichaTecnica}" id="idFichaTecnicaRD750" name="vehiculoDto.fichaTecnicaRD750"/>
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="codigoMarca" name="codigoMarca" onblur="this.className='input2'; validarMarca(this, document.getElementById('idMarca'), marcaVehiculoMatriculacion, document.getElementById('checkCodigoMarca'), 'MATW');" 
						onfocus="this.className='inputfocus';" size="23" maxlength="22" autocomplete="off" cssStyle="position:relative; float:left;" />
					&nbsp;
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:select id="idServicioTrafico" onblur="this.className='input2';"
						...
						headerValue="Servicio" onchange="habilitarCEMA();"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td align="left" nowrap="nowrap">
					<s:select id="idCarburanteVehiculo" onblur="this.className='input2';"
						...
						listKey="valorEnum" listValue="nombreEnum" headerKey="-1" headerValue="Carburante"
						onchange="habilitarCamposElectrico(this.value, 'false');"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:select id="idComboFabricacion" onblur="this.className='input2';"
						...
						listKey="valorEnum" listValue="nombreEnum" headerKey="" headerValue="Fabricación"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<label for="idClasificacionCriteriosConstruccionVehiculo">Criterios de construccion: </label>
				</td>
			...
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<label for="idClasificacionCriteriosUtilizacionVehiculo">Criterios de Utilizacion: </label>
				</td>
				<td align="left" nowrap="nowrap" colspan="3">
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:checkbox id="idDiplomatico" name="vehiculoDto.diplomatico"/>
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<label for="idExcesoPeso">Exceso de Peso:<span></span></label>
				</td>
				<td align="left" nowrap="nowrap">
					<s:checkbox id="idExcesoPeso" name="vehiculoDto.excesoPeso"/>
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idNcilindros" name="vehiculoDto.cilindrada" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="9" maxlength="8" onkeypress="return validarDecimal(event, 2)" />
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idCo2" name="vehiculoDto.co2" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="8" maxlength="7" onkeypress="return validarDecimal(event, 3)"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idtara" name="vehiculoDto.tara" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="8" maxlength="7" onkeypress="return validarNumerosEnteros(event)" />
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idMma" name="vehiculoDto.pesoMma" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="7" maxlength="6" onkeypress="return validarNumerosEnteros(event)" />
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<label> Evoluci&oacute;n Kilometraje: </label>
				</td>
				<td style="border: 0px;">
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:select id="idTipoTarjetaITV" onblur="this.className='input2';"
						...
						onchange=" editarFechaCaducidad(this.value); habilitarCamposBase(this.value, 'false');"/>
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idVariante" name="vehiculoDto.variante" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="26" maxlength="25"/>
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idVersion" name="vehiculoDto.version" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="36" maxlength="35"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idPotenciaPeso" name="vehiculoDto.potenciaPeso"
						...
						onkeypress="return validarDecimal(event, 2)"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idPlazasPie" name="vehiculoDto.numPlazasPie" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="4" maxlength="3" onkeypress="return validarNumerosEnteros(event)"/>
				</td>
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idNumRuedas" name="vehiculoDto.numRuedas" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="3" maxlength="2" onkeypress="return validarNumerosEnteros(event)"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idConsumo" name="vehiculoDto.consumo" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="5" maxlength="4" onkeypress="return validarNumerosEnteros(event)"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:checkbox id="idSubasta" name="vehiculoDto.subastado"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idFabricante" name="vehiculoDto.fabricante" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="35" maxlength="70" autocomplete="off" cssStyle="position:relative;"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:textfield id="idCodigoEco" name="vehiculoDto.codigoEco" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" size="11" maxlength="10"/></td>
			</tr>
		</table>
		...
		<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">
			<tr>
				...
				<td class="tabular">
					<s:checkbox id="idUsado" name="vehiculoDto.vehiUsado" onchange="habilitarUsado(this.checked, false);"/>
				</td>
			</tr>
		</table>
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left" >
				...
				<td align="left" nowrap="nowrap" width="1%">
					<table>
						<tr>
							...
							<td align="left" nowrap="nowrap">
								<a href="javascript:;" onClick="if(self.gfPop)gfPop.fPopCalendarSplit(document.formData.aniolimiteMatrTuris, document.formData.meslimiteMatrTuris, document.formData.dialimiteMatrTuris);return false;" title="Seleccionar fecha"> 
									<img class="PopcalTrigger" align="middle" src="img/ico_calendario.gif" width="15" height="16" border="0" alt="Calendario" id="imgCalendarLimiteMatrTuris" />
								</a>
							</td>
						</tr>
					</table>
						...
						<tr>
							...
							<td align="left" nowrap="nowrap">
								<a href="javascript:;" onClick="if(self.gfPop)gfPop.fPopCalendarSplit(document.formData.anioPrimMatri, document.formData.mesPrimMatri, document.formData.diaPrimMatri);return false;" title="Seleccionar fecha"> 
									<img class="PopcalTrigger" align="middle" src="img/ico_calendario.gif" width="15" height="16" border="0" alt="Calendario" id="imgCalendarFechaPrimMatri" />
								</a>
							</td>
						</tr>
					</table>
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:textfield disabled="%{flagDisabled}" id="idMatriculaOrigen"
						name="vehiculoDto.matriculaOrigen" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" onkeypress="return validarMatricula(event)" onChange="return validarMatricula_alPegar(event)" onmousemove="return validarMatricula_alPegar(event)"  size="10" maxlength="9"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap" width="10%">
					<s:checkbox id="idImportado" onchange="habilitarImportado(this.checked)" name="vehiculoDto.importado" disabled="true"/>
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;" width="10%">
					<label for="idComboProcedencia">Procedencia: </label>
				</td>
				<td align="left" nowrap="nowrap" colspan="2">
					<s:select id="idComboProcedencia" onblur="this.className='input2';"
						...
						listKey="valorEnum" listValue="nombreEnum" headerKey="" headerValue="Procedencia" disabled="true"/>
				</td>

			<td align="left" nowrap="nowrap" width="20%" style="vertical-align:middle;">
				<label for="idMatriculaOrigenExtranjero">Matr&iacute;cula Origen Extranjera: </label>
			</td>
			<td align="left" nowrap="nowrap">
					<s:textfield disabled="%{flagDisabled}" id="idMatriculaOrigenExtranjero"
						name="vehiculoDto.matriculaOrigExtr" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" onkeypress="return validarMatricula(event)" onChange="return validarMatricula_alPegar(event)" onmousemove="return validarMatricula_alPegar(event)"   size="10" maxlength="9"/>
				</td>
			</tr>
		</table>
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
				...
				<td align="left" nowrap="nowrap">
					<s:select cssStyle="width:150px;" list="@trafico.utiles.UtilesVistaTrafico@getInstance().getProvincias()"
						...
						onchange="cargarListaMunicipios(this,'idMunicipioVehiculo','municipioSeleccionadoVehiculo');
								  ...
								  borrarComboPueblo('idPuebloVehiculo');borrarComboPuebloCorreos('idPuebloVehiculoCorreos');"/>
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<label for="idMunicipioVehiculo">Municipio:</label>
				</td>
				<td align="left" nowrap="nowrap">
					<select id="idMunicipioVehiculo" onblur="this.className='input2';" onfocus="this.className='inputfocus';"
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<select id="tipoViaVehiculo" onblur="this.className='input2';" onfocus="this.className='inputfocus';"
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				<td align="left" nowrap="nowrap" width="10%" style="vertical-align: middle;">
					<label for="bastidorPrever">Número de Bastidor:</label>
				</td>
				<td align="left" nowrap="nowrap">
					<s:textfield id="bastidorPrever" name="vehiculoPreverDto.bastidor" onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="19" maxlength="17"/>
				</td>
				<td align="left" nowrap="nowrap" width="10%"
					style="vertical-align: middle;"><label for="matriculaPrever">Matrícula:
				</label></td>
				<td align="left" nowrap="nowrap">
					<s:textfield id="matriculaPrever" name="vehiculoPreverDto.matricula"
						onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="9" maxlength="9" onkeypress="return validarMatricula(event)" onChange="return validarMatricula_alPegar(event)" onmousemove="return validarMatricula_alPegar(event)"  />
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align:middle;">
			...
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<label for="idClasificacionCriteriosConstruccionVehiculoPrever">Criterios de construcción Prever:</label>
				</td>
				<td align="left" nowrap="nowrap" colspan="3">
			...
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<label for="idClasificacionCriteriosUtilizacionVehiculoPrever">Criterios de Utilización Prever:</label>
				</td>
				<td align="left" nowrap="nowrap" colspan="3">
			...
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<label for="clasificacionITVPrever">Clasificación ITV:</label>
				</td>
				<td align="left" nowrap="nowrap">
					<s:textfield id="clasificacionITVPrever" name="vehiculoPreverDto.clasificacionItv"
						onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="9" maxlength="9" readonly="true" />
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap" colspan="2">
					<s:checkbox id="vehiculoAgricola" name="vehiculoDto.vehiculoAgricola"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td colspan="2">
					<table>
						<tr>
							...
							<td align="left" nowrap="nowrap">
								<a href="javascript:;" onClick="if(self.gfPop)gfPop.fPopCalendarSplit(document.formData.anioInspeccion, document.formData.mesInspeccion, document.formData.diaInspeccion);return false;" title="Seleccionar fecha"> 
									<img class="PopcalTrigger" align="middle" src="img/ico_calendario.gif" width="15" height="16" border="0" alt="Calendario" />
								</a>
							</td>
						</tr>
		...
		<table class="acciones" width="95%" align="left">
			<tr>
				<td align="center" style="size: 100%; TEXT-ALIGN: center; list-style: none;">
					<s:if test="@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoAdmin()">
					<input type="button" class="boton" name="bGuardar" id="idBotonGuardar" value="Actualizar Vehículo" onClick="return comprobacionEstadoTramite(idEstado);"
						onKeyPress="this.onClick" />
					</s:if>
					<s:else>
					<input type="button" class="boton" name="bGuardar" id="idBotonGuardar" value="Actualizar Vehículo" onClick="return guardarVehiculo();"
						onKeyPress="this.onClick" />
					</s:else>
					&nbsp;&nbsp;&nbsp;
		...
		<script>
			...
			habilitarUsado(document.getElementById("idUsado").checked, true);
			...
			habilitarCamposBase(idTipoTarjetaITV, 'false');
			habilitarCamposElectrico(carburante, 'false');

			$( document ).ready(function() {
				habilitaCheckFichaTecnica(document.getElementById('idTipoVehiculo').value);
				// Si es mozilla le damos al combo de carrocerias toda la funcionalidad de despliegue de opciones
				if(navigator.userAgent.toLowerCase().indexOf('firefox/') != -1){
					deshabilitaCarroceriaOptions();
				// Si no, sólo le desactivamos los nodos padre, para que no puedan ser seleccionados
				} else {
