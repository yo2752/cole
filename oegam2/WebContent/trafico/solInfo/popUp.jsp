		...
		<table class="tablaformbasica" cellspacing="3" cellpadding="0">
			...
			<tr>
				<td nowrap="nowrap" align="left" width="30%" style="vertical-align:middle">
					...
					<s:select label="Estado trámite:" name="estadoTramite" id="estadoTramite"
						list="@org.gestoresmadrid.oegam2.trafico.solInfo.utiles.UtilesVistaSolInfo@getInstance().getEstadoSolInfoVehiculo()"
...
function estadoSeleccionado(){
	...
	window.opener.invokeCambiarEstadoInteve(estado);
}</script>
</body>
</html>	