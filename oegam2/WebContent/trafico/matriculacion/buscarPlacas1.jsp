...
<s:form method="post" id="formData" name="formData">
	...
	<div id="displayTagDiv" class="divScroll" style="overflow:hidden;">
		...
		<display:table name="listaSolicitudes" excludedParams="*"
			requestURI="navegarConsultaSolicitudesPlacas.action" sort="list" class="tablacoin"
...
<script type="text/javascript">
	...
	function buscarSolicitudPlacas() {
		$('#formData').attr("action", "boton_busquedaConsultaSolicitudesPlacas.action").trigger("submit");
	}
