...
<div id="contenido" class="contentTabs" style="display: block;">
	...
	<s:form method="post" id="formData" name="formData">
		<input type="hidden" id="botonVolver" name="botonVolver" value="<s:property value='botonVolver'/>" />
		<div class="divScroll">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<s:iterator value="listaSolicitudes" var="tablaSeleccionados"
					...
					<tr>
						...
						<td><s:property value="nifTitular" /></td>
						<td><s:property value="fechaSolicitud" /></td>
						<td><s:property value="descEstado" /></td>
					</tr>
				</s:iterator>
			</table>
	...
	<s:form method="post" id="formDataMatriculas" name="formDataMatriculas"
		...
		<div class="contenido fondoFormularios">
			...
			<div id="contenedorGeneralSolicitudes">
				...
				<%@include file="solicitudContent.jsp"%>
			...
			<table class="acciones">
				<tr>
					<td>
						...
						<!-- Se comenta botones ya que no se usan. Borrar código para el siguiente pase -->
						<%-- <s:if test="%{@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoAdmin()}">
							...
							<input class="boton" type="button" id="bVolver"
								name="bVolver" value="Volver"
								onClick="return volverConsOAlta();" onKeyPress="this.onClick" />
							&nbsp;
						</div>
		...
		<input type="hidden" id="listaSolic" name="listaSolic"
			value="<s:property value='listaSolicitudes.size()' />" />
