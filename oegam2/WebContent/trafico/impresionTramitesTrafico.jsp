...
<s:hidden id="numExpedientes" name="numsExpediente"/>
...
<s:form method="post" cssClass="fileDownloadForm" id="formData" name="formData" action="imprimirImpresionAction" 
...
<s:if test="fileName!=null">
	<s:form id="recuperarFichero" method="post" action="descargarFicheroImpresionAction">
