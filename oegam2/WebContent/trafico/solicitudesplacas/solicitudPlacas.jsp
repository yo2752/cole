							...
							<s:if
								...
								<s:if test="tramitables">
									<input class="boton" type="button" id="bTramitar"
										...
										onClick="return cambiarEstadoSolicitudPlacasaTramitado(this.form, '<s:property value="@org.gestoresmadrid.placas.utilities.enumerados.EstadoSolicitudPlacasEnum@convertir('3')" />');"
										onKeyPress="this.onClick" />
								&nbsp;
							</s:if>
