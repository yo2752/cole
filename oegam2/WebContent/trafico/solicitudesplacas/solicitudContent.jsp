			...
			<div class="<s:property value='clase' />">
				<table>
					<tr>
						...
						<td>
						<s:select
								list="@trafico.utiles.UtilesVistaTrafico@getInstance().getTiposPlacasMatriculacion('delantera',tipoVehiculo)"
				...
				<div class="contenedorSolicitudDerecha">
					<table>
						<tr>
							...
							<td>
								<s:select
									list="@trafico.utiles.UtilesVistaTrafico@getInstance().getTiposPlacasMatriculacion('trasera',tipoVehiculo)"
