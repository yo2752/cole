...
<script src="js/excelLiquidacion620.js" type="text/javascript"></script>
...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Excel liquidación 620</span>
			</td>
		</tr>
	</table>
</div>
					...
					<tr>
						...
						<td  align="left">
							<s:select id="idContrato" list="@org.gestoresmadrid.oegam2.utiles.UtilesVistaContrato@getInstance().getComboContratosHabilitados()"
								...
								listValue="descripcion" cssStyle="width:220px" name="generarExcelLiquidacionDto.contrato.idContrato"
								/>
						</td>
					</tr>
				</s:if>
					...
					<td align="left">
						<table style="width:20%">
							<tr>
								...
								<td align="left">
									<s:textfield name="generarExcelLiquidacionDto.fechaLiquidacion.diaInicio" id="diaFechaAltaIni"
								...
								<td align="left">
									<s:textfield name="generarExcelLiquidacionDto.fechaLiquidacion.mesInicio" id="mesFechaAltaIni" onblur="this.className='input2';"
								...
								<td align="left">
									<s:textfield name="generarExcelLiquidacionDto.fechaLiquidacion.anioInicio" id="anioFechaAltaIni"
					...
					<td align="left">
						<table style="width:20%">
							<tr>
								...
								<td align="left">
									<s:textfield name="generarExcelLiquidacionDto.fechaLiquidacion.diaFin" id="diaFechaAltaFin" onblur="this.className='input2';"
										onfocus="this.className='inputfocus';" size="2" maxlength="2" />
								</td>
								<td align="left">
									<label class="labelFecha">/</label>
								...
								<td align="left">
									<s:textfield name="generarExcelLiquidacionDto.fechaLiquidacion.mesFin" id="mesFechaAltaFin" onblur="this.className='input2';"
										onfocus="this.className='inputfocus';" size="2" maxlength="2" />
								</td>
								<td align="left">
									<label class="labelFecha">/</label>
								...
								<td align="left">
									<s:textfield name="generarExcelLiquidacionDto.fechaLiquidacion.anioFin" id="anioFechaAltaFin"
										onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="5" maxlength="4" />
								</td>
								<td align="left">
