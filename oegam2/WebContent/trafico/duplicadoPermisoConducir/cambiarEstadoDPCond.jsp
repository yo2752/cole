		...
		<table>
			<s:if test="%{@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoAdmin() || @org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoColegio()}">
				<tr>
					...
					<td align="left">
						<s:select id="idEstadoNuevoDPC" headerKey="" headerValue="Seleccione Estado"
							list="@org.gestoresmadrid.oegam2.utiles.UtilesVistaInterga@getInstance().getEstadosTramiIntergaDuplicados()"
