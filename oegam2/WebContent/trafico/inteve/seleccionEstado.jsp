	...
	<table class="tablaformbasica" cellspacing="3" cellpadding="0" style="width:100%">
		...
		<tr>
			<td nowrap="nowrap" align="left" width="30%" style="vertical-align:middle">
				...
				<s:select id="idEstadoNuevoCTRI" listKey="valorEnum" listValue="nombreEnum"
					headerKey="" headerValue=""
					list="@org.gestoresmadrid.oegam2.utiles.UtilesVistaTramiteInteve@getInstance().getEstadosTramiteInteve()"/>
			</td>
		</tr>
	</table>