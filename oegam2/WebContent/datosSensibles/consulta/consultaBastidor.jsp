...
<c:set var="myTipo" value="Bastidor"/>
<s:form method="post" id="formData" name="formData">
	...
	<div class="nav">
		<table width="100%">
			<tr>
				<td class="tabular">
					<span class="titulo">Consulta de Bastidor</span>
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="acciones center">
		<input type="button" class="boton" name="bConsultarDatosSensibles" id="idBotonConsultarDatosSensibles"
			value="Consultar" onClick="return consultaBastidor();"onKeyPress="this.onClick"/>
		<input type="button" class="boton" name="bLimpiar" id="idBotonLimpiarConsulta" value="Limpiar"
			onkeypress="this.onClick" onclick="return limpiarConsultaBastidor();"/>
	</div>
							...
							<tr>
								...
								<td width="10%" align="right">
									<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboResultadosPorPagina()"
										...
										onchange="return cambiarElementosPorPaginaConsultaDatosSensiblesBastidor();"
										/>
								</td>
							</tr>
						</table>
	...
	<display:table name="listaConsultaDatosSensibles" excludedParams="*"
					requestURI="navegarBastidor${action}"
					class="tablacoin"
	...
	<s:if test="%{(listaConsultaDatosSensibles.getFullListSize()>0)}">
		<div class="acciones center">
			<input type="button" class="boton" name="bEliminar"	id="idBotonEliminar"
				value="Eliminar" onkeypress="this.onClick" 	onclick="return eliminarConsultaBastidor();"/>
		</div>
