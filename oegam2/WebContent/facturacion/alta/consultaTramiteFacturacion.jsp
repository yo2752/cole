		...
		<div id="busqueda">					
			<table class="tablaformbasica">
				<tr>
					...
					<td align="left">
						<s:select list="@trafico.utiles.UtilesVistaTrafico@getInstance().getEstadosTramiteTrafico()"
							...
							headerKey="-1"
	           				headerValue="TODOS"
							name="consultaTramiteTrafico.estado" 
					...
					@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoColegio()}">
       				...
       				<s:if test="%{@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoAdmin()||
					@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoColegio()}">
       					<s:textfield name="consultaTramiteTrafico.numColegiado" 
        					id="numColegiado" 
        					onblur="this.className='input2';" 
        					onfocus="this.className='inputfocus';" 
        					size="5" maxlength="4"/>
	        	...
	        	<tr>        	       			
       				...
       				<td align="left">
       					<s:textfield name="consultaTramiteTrafico.referenciaPropia" 
	       					id="refPropia" 
	       					onblur="this.className='input2';" 
	       					onfocus="this.className='inputfocus';" 
	        		...
	        		<td align="left" nowrap="nowrap">
       				...
       				<td align="left" colspan="3">
        				<s:textfield name="consultaTramiteTrafico.numExpediente" 
	        				id="numExpediente" 
	        				onblur="this.className='input2';" 
		       				onfocus="this.className='inputfocus';" 
	        				maxlength="50"
				...
				<tr>
				    <td align="left" nowrap="nowrap">
       				...
       				<td align="left">
        				<s:textfield name="consultaTramiteTrafico.titular.nif" 
        					id="dniTitular" 
        					onblur="this.className='input2';" 
        					onfocus="this.className='inputfocus';" 
        					size="9" maxlength="9"/>
       				...
       				<td align="left">
        				<s:textfield name="consultaTramiteTrafico.nifFacturacion" 
        					id="dniFacturacion" 
        					onblur="this.className='input2';" 
        					onfocus="this.className='inputfocus';"
        					size="9" maxlength="9"/>
					...
					<td align="left" nowrap="nowrap">
       				...
       				<td align="left">
        				<s:textfield name="consultaTramiteTrafico.numBastidor" 
        					id="numBastidor" 
        					onblur="this.className='input2';" 
        					onfocus="this.className='inputfocus';" 
	        		...
	        		<td align="left" nowrap="nowrap">
       				...
       				<td align="left">
        				<s:textfield name="consultaTramiteTrafico.matricula" 
        					id="matricula" 
        					onblur="this.className='input2';" 
        					onfocus="this.className='inputfocus';" 
					...
					<td align="left">
						<TABLE WIDTH=100%>
							<tr>
								...
								<td>
									<s:textfield name="consultaTramiteTrafico.fechaPresentacion.diaInicio" 
								...
								<td>
									<s:textfield name="consultaTramiteTrafico.fechaPresentacion.mesInicio" 
								...
								<td>
									<s:textfield name="consultaTramiteTrafico.fechaPresentacion.anioInicio" 
					...
					<td align="left">
						<TABLE WIDTH=100%>
							<tr>
								...
								<td>
									<s:textfield name="consultaTramiteTrafico.fechaPresentacion.diaFin" 
								...
								<td>
									<s:textfield name="consultaTramiteTrafico.fechaPresentacion.mesFin" 
								...
								<td>
									<s:textfield name="consultaTramiteTrafico.fechaPresentacion.anioFin" id="anioPresentacionFin"
										onblur="this.className='input2';"
										onfocus="this.className='inputfocus';" 
										size="5" maxlength="4" />
								</td>
				...
				<tr>
					<td>
						<input type="button" 
							...
							onclick="return buscarTramiteTrafico();"/>			
						&nbsp;
						<input type="button" 
							class="boton" 
							name="bLimpiar" 
...
<s:if test="%{(@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoMantenimientoTrafico())&&
	...
	<table class="acciones">
    	<tr>  		
    		<td>			
    			<input class="boton" type="button" id="bNuevaFactura" name="bNuevaFactura" value="Nueva Factura v1.0" onClick="return nuevaFactura(this);" onKeyPress="this.onClick"/>
			</td>
	    </tr>
    </table>
