		...
		<table class="tablaformbasica" cellspacing="3" cellpadding="0">
			...
			<tr>
				<td nowrap="nowrap" align="left" width="30%" style="vertical-align:middle">
					...
					<s:select id="estadoLegalizacion" 
							listKey="valorEnum"
							listValue="nombreEnum"
							headerKey="-1"
			           		headerValue=""
							list="@org.gestoresmadrid.oegamLegalizaciones.view.utiles.UtilesVistaLegalizacion@getEstadoPeticion()"/>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			...
			<tr>
				<td nowrap="nowrap" width="30%" align="left" style="vertical-align:middle">
					<input type="button" value="Seleccionar" class="boton" onclick="estadoAnuntisSeleccionado()"/>
					&nbsp;
...
function estadoAnuntisSeleccionado(){
	var estado = document.getElementById("estadoLegalizacion").value;
	if(estado == "-"){
		alert("Seleccione un estado");
		return false;
	}
	window.opener.invokeCambiarEstadoLegalizacion(estado);
}</script>
