...
<div class="contenido">	
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		<tr>			
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idDoiVehiculoConductor" name="conductorDto.doiVehiculo"  onblur="this.className='input2';" 
    				onfocus="this.className='inputfocus';" size="20" maxlength="9"/>
			</td>
			<td align="left" nowrap="nowrap">
				<label for="labelMatriculaConductor"><span class="naranja">*</span>Matricula:</label>
			</td>
			<td align="left" nowrap="nowrap">
				<s:textfield id="idMatriculaConductor" name="conductorDto.matricula"  onblur="this.className='input2';" 
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idBastidorConductor" name="conductorDto.bastidor"  onblur="this.className='input2';" 
