...
<div class="nav">
	<table width="100%">
		<tr>
			<td class="tabular">
				<span class="titulo">Consulta Distintivo MedioAmbiental</span>
			</td>
		</tr>
	</table>
</div>
...
<div>
	<s:form method="post" id="formData" name="formData">
		...
		<div id="busqueda">
			<table class="tablaformbasica">
				...
				<s:if test="%{@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoAdmin()}">
					<tr>
						<td align="left" nowrap="nowrap">
							<label for="labelEstadoDstv">Estado Petición Distintivo:</label>
						</td>
						<td align="left">
		...
		<div id="displayTagDivConsultaDstv" class="divScroll">
			...
			<display:table name="lista" class="tablacoin" uid="tablaConsultaPrmDstv" requestURI= "navegarGestionDstv.action"
				...
				<s:if test="%{@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoAdmin()}">
					...
					<display:column property="estadoDstv" title="Estado Dstv" sortable="true" sortProperty="estadoDstv" headerClass="sortable"
				...
				<display:column property="estadoPetImp" title="Estado Pet.Impresion" sortable="true" headerClass="sortable" sortProperty="estadoPetImp"
						defaultorder="descending" style="width:7%" />
