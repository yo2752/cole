...
<div class="contenido">	
		...
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<table>
					<tr>
						<td>
							<s:select list="remesa.modelo.bonificaciones" id="idBonificaciones" onblur="this.className='input2';"
								onfocus="this.className='inputfocus';" name="remesa.bonificacion.bonificacion"
								listValue="descripcion" listKey="bonificacion" title="Bonificación" headerKey="" 
								headerValue="Seleccione Bonificación" onchange="javascript:cargarMonto(this,'idBonificacionMonto');"/>
						</td>
						<td>
	...
	<div id="divRenta">
		...
		<table class="tablaformbasica">
			<tr>
				<td align="left" nowrap="nowrap">
					<label for="labelTipoRenta">Tipo de Renta:</label>
				</td>
				<td align="left" nowrap="nowrap">
					<table>
						<tr>
							<td align="left" nowrap="nowrap">
								<s:radio id="duracionRenta" cssStyle="display:inline;" labelposition="left"
									name="remesa.duracionRenta" 
									list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getDuracionRenta()"
						...
						<tr>
							<td align="left" nowrap="nowrap">
								<s:radio id="periodoRenta" cssStyle="display:inline;" labelposition="left"
									name="remesa.tipoPeriodoRenta" 
									list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getPeriodosRenta()"
									listKey="valorEnum" listValue="nombreEnum" disabled="true">
								</s:radio>
							</td>
							<td>
								<label for="labelNperiodos">Nº de periodos (años o meses):</label>
							</td>
							<td align="left" nowrap="nowrap">
								<s:textfield id="idNumPeriodo"  name="remesa.numPeriodoRenta"  
									onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="10" disabled="true" />
							<td>
						<tr>
					</table>
	       		</td>
	       	...
	       	<tr>
	       		<td align="left" nowrap="nowrap">
					<label for="labelTipoRenta">Importe Renta:</label>
				</td>
				<td align="left" nowrap="nowrap">
					<s:textfield id="idImporteRenta"  name="remesa.importeRenta"  
									onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="10" />
				</td>
	       	</tr>
		</table>
	...
	<div id="divDerechosReales">
		<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
			<tr>
				<td class="tabular">
					<span class="titulo">Derechos Reales</span>
				</td>
			</tr>
		</table>
		<table class="tablaformbasica">
			<tr>
				<td align="left" nowrap="nowrap">
					<label for="labelDerReal">Derecho Real:</label>
				</td>
				<td align="left" nowrap="nowrap">
					<s:select list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getListaDerechosReales()"
						id="idDerechoReal" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" name="remesa.descDerechoReal"
						listValue="nombreEnum" listKey="valorEnum" headerKey="-1" headerValue="Seleccione Derecho Real"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap">
					<s:radio id="duracion" cssStyle="display:inline;" labelposition="left"
						name="remesa.duracionDerechoReal" 
						list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getDuracionDerechoReal()"
						listKey="valorEnum" listValue="nombreEnum"
						onchange="javascript:habilitarCamposDerReal();">
					</s:radio>
				</td>
				<td align="left" nowrap="nowrap">
					<table>
						<tr>
							<td align="left" nowrap="nowrap">
								<label for="labelNumAnios">Número de años:</label>
							</td>
							<td align="left" nowrap="nowrap">
								<s:textfield id="idNumAnio"  name="remesa.numAnio"  
									onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="10" disabled="true" />
							</td>
							<td align="left" nowrap="nowrap">
							...
							<td align="left" nowrap="nowrap">
								<table>
									<tr>
										<td align="left" nowrap="nowrap" width="5%">
											<s:textfield name="remesa.nacimientoUsufructuario.dia" id="idDiaNacUsufructurario" onblur="this.className='input2';" 
												onkeypress="return validarDia(this, event)" onfocus="this.className='inputfocus';" size="2" maxlength="2" disabled="true"/>
										</td>
										<td width="1%">/</td>
										<td align="left" nowrap="nowrap" width="5%">
											<s:textfield name="remesa.nacimientoUsufructuario.mes" id="idMesNacUsufructurario" onblur="this.className='input2';" 
												onkeypress="return validarMes(this, event)" onfocus="this.className='inputfocus';"  size="2" maxlength="2" disabled="true"/>
										</td>
										<td width="1%">/</td>
										<td align="left" nowrap="nowrap" width="5%">
											<s:textfield name="remesa.nacimientoUsufructuario.anio" id="idAnioNacUsufructurario" onblur="this.className='input2';" onkeypress="return validarAnio(this, event)"
												onfocus="this.className='inputfocus';" size="4" maxlength="4" disabled="true"/>
										</td>
										
										<td align="left" nowrap="nowrap">
								    		<a id="idCalendarNacUsufructurario" href="javascript:;" onClick="if(self.gfPop)gfPop.fPopCalendarSplit(document.formData.idAnioNacUsufructurario, document.formData.idMesNacUsufructurario, document.formData.idDiaNacUsufructurario);return false;" 
								    			title="Seleccionar fecha">
								    			<img class="PopcalTrigger" align="middle" src="img/ico_calendario.gif" width="15" height="16" border="0" alt="Calendario"/>
								    		</a>
										</td>
