...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Impresión de Remesas</span>
			</td>
		</tr>
	</table>
</div>
...
<div>
	<s:form method="post" id="formData" name="formData">
		<table class="subtitulo" cellSpacing="0"  style="width:100%;" >
			<tr>
				<td  style="width:100%;text-align:center;">Listado Remesas 600/601</td>
			</tr>
		</table>
							...
							<tr>
								...
								<td width="10%" align="right">
									<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboResultadosPorPagina()" 
												...
												onchange="cambiarElementosPorPaginaImprimirRemesas();">
									</s:select>
								</td>
							</tr>
						</table>
		...
		<div id="displayTagDiv" class="divScroll">
			...
			<display:table name="lista" class="tablacoin"
					uid="tablaImprimirRemesas" requestURI= "navegarImpRmS.action"
					id="tablaImprimirRemesas" summary="Listado de Remesas 600/601"
				...
				<display:column title="Estado" sortable="true" headerClass="sortable"
						defaultorder="descending" style="width:4%" >
					<s:property value="%{@org.gestoresmadrid.core.modelos.model.enumerados.EstadoRemesas@convertirTexto(#attr.tablaImprimirRemesas.estado)}" />
				</display:column>
				...
				<display:column title="<input type='checkbox' name='checkAll' onClick='marcarTodosRemesa(this)' 
						...
						<input type="checkbox" name="listaChecks" id="check<s:property value="#attr.tablaImprimirRemesas.numExpediente"/>" 
							value='<s:property value="#attr.tablaImprimirRemesas.numExpediente"/>' />
					</display:column>
			</display:table>
		</div>
		<table class="subtitulo" cellSpacing="0" cellspacing="0">
			<tr>
				<td>Impresos de Remesas 600/601</td>
			</tr>
		</table>
		...
		<div class="acciones center">
			<input type="button" class="boton" name="bImprimir" id="bImprimir" value="Imprimir"  onkeypress="this.onClick" onclick="return imprimirRemesas();"/>
			<input type="button" class="boton" name="bVolver" id="bVolver" value="Volver"  onkeypress="this.onClick" onclick="return volverRemesas();"/>			
		</div>
	</s:form>
</div>
