...
<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
	<tr>
		<td>
			<display:table name="remesa.listaOtrosBienes" class="tablacoin"
...
<%-- 				@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesModelos@getInstance().esGuardable(modeloDto)}"> --%>
	<div class="acciones center">
		...
		<input type="button" class="boton" name="bModificarOtrosBienes" id="idModificarOtrosBienes" value="Modificar" onClick="javascript:modificarBienes('OtrosBienes','OTRO');"onKeyPress="this.onClick"/>	
	</div>
<%-- </s:if> --%>
<br/>
