...
<div class="contenido">	
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		<tr>
			...
			<td align="left" nowrap="nowrap" width="24%">
	     		<table style="align:left;" >
					<tr>
						<td align="left" nowrap="nowrap">
							<s:textfield id="idNifSujPasivo" name="remesa.sujetoPasivo.persona.nif"  onblur="this.className='input2';calculaLetraNIF(this)" 
			       				onfocus="this.className='inputfocus';" style="text-transform : uppercase"
			       				size="9" maxlength="9"/>
			       			<s:hidden name="remesa.sujetoPasivo.persona.numColegiado"/>
			       			<s:hidden name="remesa.sujetoPasivo.idInterviniente"/>
			       			<s:hidden name="remesa.sujetoPasivo.tipoInterviniente"/>
						</td>
						<td align="left" nowrap="nowrap">
         	...
         	<td align="left" nowrap="nowrap">
	         	<s:select list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getComboTipoPersonas()"
					...
					onfocus="this.className='inputfocus';" name="remesa.sujetoPasivo.persona.tipoPersona"
		...
		<tr>       
       		...
       		<td align="left" nowrap="nowrap" >
	         	<s:select id="idSexoSujPasivo" name="remesa.sujetoPasivo.persona.sexo"
       		...
       		<td align="left" nowrap="nowrap">
       			<s:textfield id="idPrimerApeRazonSocialSujPasivo"  name="remesa.sujetoPasivo.persona.apellido1RazonSocial"  
      	...
      	<tr>        	       			
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idSegundoApeSujPasivo" name="remesa.sujetoPasivo.persona.apellido2" onblur="this.className='input2';" 
       		...
       		<td align="left" nowrap="nowrap" colspan="2">
   				<s:textfield id="idNombreSujPasivo" name="remesa.sujetoPasivo.persona.nombre" onblur="this.className='input2';" 
      	...
      	<tr>
      		<td align="left" nowrap="nowrap">
   				...
   				<table>
					<tr>
						<td align="left" nowrap="nowrap" width="5%">
							<s:textfield name="remesa.sujetoPasivo.persona.fechaNacimiento.dia" id="idDiaNacSujPasivo" onblur="this.className='input2';" 
								onkeypress="return validarNumerosEnteros(event)" onfocus="this.className='inputfocus';" size="2" maxlength="2"/>
						</td>
						<td width="1%">/</td>
						<td align="left" nowrap="nowrap" width="5%">
							<s:textfield name="remesa.sujetoPasivo.persona.fechaNacimiento.mes" id="idMesNacSujPasivo" onblur="this.className='input2';" 
								onkeypress="return validarNumerosEnteros(event)" onfocus="this.className='inputfocus';"  size="2" maxlength="2"/>
						</td>
						<td width="1%">/</td>
						<td align="left" nowrap="nowrap" width="5%">
							<s:textfield name="remesa.sujetoPasivo.persona.fechaNacimiento.anio" id="idAnioNacSujPasivo" onblur="this.className='input2';" onkeypress="return validarNumerosEnteros(event)"
   			...
   			<s:if test="%{!@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().esConceptoBienes(remesa)}">
	   			<td align="left" nowrap="nowrap">
	   				<label for="labelPorctjSujPasivo" id="idLabelPorctjSujPasivo">Porcentaje: </label>
	   			</td>
	   			<td align="left" nowrap="nowrap" colspan="2">
	   				<s:textfield name="remesa.sujetoPasivo.porcentaje" id="idPorcentajeSujPasivo" onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="4" maxlength="3"/>
	   			</td>
	   		</s:if>
      	</tr>
	</table>
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		<s:if test="%{@org.gestoresmadrid.oegam2.utiles.UtilesVistaAcceso@getInstance().tienePermisoAdmin() && remesa.sujetoPasivo.direccion.idDireccion != null}">
			<tr id="trDireccionSujPasivo">
				<td align="left" nowrap="nowrap">
					<label for="labelIdDir">Id direccion:</label>
				</td>
				<td>
					<s:textfield name="remesa.sujetoPasivo.direccion.idDireccion" id="idDireccionSujPasivo" size="25" onblur="this.className='input2';" 
	       			onfocus="this.className='inputfocus';" disabled="true"/>
				</td>
			</tr>
		</s:if>
		<s:else>
			<s:hidden id="idDireccionSujPasivoHidden" name="remesa.sujetoPasivo.direccion.idDireccion"/>
		</s:else>
		<tr>
			<td align="left" nowrap="nowrap">
			...
			<td>
				<s:select list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getListaProvincias()" 
						onblur="this.className='input2';" 
			    		onfocus="this.className='inputfocus';"  headerKey="-1"	headerValue="Seleccione Provincia" 
			    		name="remesa.sujetoPasivo.direccion.idProvincia" listKey="idProvincia" listValue="nombre" id="idProvinciaSujPasivo" 
			...
			<td align="left" nowrap="nowrap">
			    <s:select onblur="this.className='input2';" onfocus="this.className='inputfocus';" id="idMunicipioSujPasivo"
					...
					name="remesa.sujetoPasivo.direccion.idMunicipio"
					list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getListaMunicipiosPorProvincia(remesa,'001')"
		...
		<tr>
			<td align="left" nowrap="nowrap">
       		...
       		<td align="left" nowrap="nowrap">   				
		    	<s:select id="idPuebloSujPasivo" onblur="this.className='input2';"
   					list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getListaPueblosPorMunicipioYProvincia(remesa,'001')"
   					headerKey="-1" headerValue="Seleccione Pueblo" listKey="pueblo" listValue="pueblo"
					name="remesa.sujetoPasivo.direccion.pueblo"
			...
			<td>
			    <s:select  onblur="this.className='input2';" onfocus="this.className='inputfocus';" 
					list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getListaTiposVias(remesa,'001')"
					headerKey="-1" headerValue="Seleccione Tipo Via" listKey="idTipoViaCam" listValue="nombre" 
					name="remesa.sujetoPasivo.direccion.idTipoVia"
		...
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<s:textfield name="remesa.sujetoPasivo.direccion.nombreVia" id="idNombreViaSujPasivo" size="25" onblur="this.className='input2';" 
	       			onfocus="this.className='inputfocus';"/>
			</td>
			<td align="left" nowrap="nowrap">
			...
			<td>
				<table>
					<tr>
						<td align="left" nowrap="nowrap">
							<s:textfield name="remesa.sujetoPasivo.direccion.codPostal" id="idCodPostalSujPasivo" size="5" maxlength="5" onblur="this.className='input2';" 
				       			onfocus="this.className='inputfocus';"/>
						</td>
						<td align="left" nowrap="nowrap">
	...
	<table  cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left" style="100%">
      	<tr>    			
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idNumeroDireccionSujPasivo" name="remesa.sujetoPasivo.direccion.numero" 
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idLetraDireccionSujPasivo" name="remesa.sujetoPasivo.direccion.letra" 
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idEscaleraDireccionSujPasivo" name="remesa.sujetoPasivo.direccion.escalera"
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idPisoDireccionSujPasivo" name="remesa.sujetoPasivo.direccion.planta"
      	...
      	<tr>    			
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idPuertaDireccionSujPasivo" name="remesa.sujetoPasivo.direccion.puerta"
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idBloqueDireccionSujPasivo" name="remesa.sujetoPasivo.direccion.bloque"
	   				onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="4" maxlength="10"/>
   			</td>
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="idKmDireccionSujPasivo" name="remesa.sujetoPasivo.direccion.km"
       		...
       		<td align="left" nowrap="nowrap">
   				<s:textfield id="hmDireccionSujPasivo" name="remesa.sujetoPasivo.direccion.hm" 
	   				onblur="this.className='input2';" onfocus="this.className='inputfocus';" 
