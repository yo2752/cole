...
<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">	
	<tr>
		<td class="tabular">
			<span class="titulo">Listado Transmitentes</span>
		</td>
	</tr>
</table>
<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
	<tr>
		<td>
			<display:table name="remesa.listaTransmitentes" class="tablacoin"
						uid="tablaTransmitentes" 
						id="tablaTransmitentes" summary=""
				...
				<display:column title="<input type='checkbox' name='checkAll' onClick='marcarTodosTransmitente(this)' 
					onKeyPress='this.onClick'/>" style="width:4%" >
					<input type="checkbox" name="listaChecksTransmitente" id="check<s:property value="#attr.tablaTransmitentes.idInterviniente"/>" 
						value='<s:property value="#attr.tablaTransmitentes.idInterviniente"/>' />
				</display:column>
			</display:table>
		</td>
	</tr>
