...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Alta Remesa Modelo 601</span>
			</td>
		</tr>
	</table>
</div>
...
<div>
	...
	<ol id="toc">
		<li id="Remesa601"><a href="#Remesa601">Remesa 601</a></li>
	...
	<s:form method="post" id="formData" name="formData">
		...
		<div class="contentTabs" id="Remesa601" style="width: 760px; border: none; background-color: rgb(235, 237, 235);">  
			<%@include file="pestaniaRemesa601.jsp" %>
		</div>
