...
<body class="popup">	
<s:form method="post" name="formData" id="formData" enctype="multipart/form-data" action="importarDGTImportar.action" cssStyle="overflow:hidden;">
		...
		<table class="tablaformbasica" cellspacing="3" cellpadding="0">
			...
			<tr>
				<td nowrap="nowrap" align="left" width="30%" style="vertical-align:middle">
					...
					<s:select label="Estado del reconocimiento:" name="estado" id="estado"
						list="comboEstados"
			...
			<tr>
				<td nowrap="nowrap" width="30%" align="left" style="vertical-align:middle">
					<input type="button" value="Seleccionar" class="boton" onclick="estadoReconocimientoSeleccionado()"/>
					&nbsp;
...
function estadoReconocimientoSeleccionado(){
	var estado = document.getElementById("estado").value;
	if(estado == "-"){
		alert("Seleccione un estado");
		return false;
	}
	window.opener.invokeCambiarEstadoReconocimiento(estado);
}</script>
</body>
</html>	