	...
	<body class="popup">
		<div class="nav">
			<table width="100%">
				<tr>
					<td class="tabular">
						<span class="titulo">EVOLUCIÓN DE PETICIONES</span>
					</td>
				</tr>
			</table>
		</div>
		...
		<div id="tablaformbasica" class="tablaformbasica">
			<display:table name="listaRespuestas" excludedParams="*" class="tablanotifi"
				uid="tablaEvoPeticiones" summary="Evolucion Peticiones" cellspacing="0" cellpadding="0" sort="external">

				<display:column property="idStockPeti" title="Peticion" sortable="true" headerClass="sortable" defaultorder="descending" style="width:2%" />
				...
				<display:column property="observaciones" title="Observaciones" sortable="true" headerClass="sortable" sortProperty="observaciones" style="width:4%"/>
			</display:table>
