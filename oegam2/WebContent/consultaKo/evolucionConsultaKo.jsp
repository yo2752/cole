...
<div class="popup formularios" style="width:95%;">
						...
						<tr>
							...
							<td width="10%" align="right">
								<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboResultadosPorPagina()" 
											...
											id="idResultadosPorPaginaEvolConsultaKo"
											name= "resultadosPorPagina"
											value="resultadosPorPagina"
											title="Resultados por página"
											onchange="cambiarElementosPorPaginaEvolucionConsultaKo();">
								</s:select>
							</td>
						</tr>
					</table>
	...
	<div id="displayTagEvolucionConsultaKoDiv" class="divScroll">
		<div
			style="display: none; margin-top: auto; margin-left: auto; margin-right: auto;">
			<%@include file="../../../../includes/bloqueLoading.jspf"%>
		</div>
		<display:table name="lista" class="tablacoin"
				uid="tablaEvolucionConsultaKo" requestURI= "navegarEvMatrKo.action"
				id="tablaEvolucionConsultaKo" summary="Listado Evolucion"
	...
	<script type="text/javascript">
		$(function() {
			$("#displayTagEvolucionConsultaKoDiv").displayTagAjax();
		});
	</script>	