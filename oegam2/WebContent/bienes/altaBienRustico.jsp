...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Alta Bien Rústico</span>
			</td>
		</tr>
	</table>
</div>
<div>
	...
	<ol id="toc">
		<li id="BienRustico"><a href="#BienRustico">Bien Rústico</a></li>
	...
	<s:form method="post" id="formData" name="formData">
		...
		<s:hidden id="tipoUsoRustico" name="bien.usoRustico.tipoUso"/>
		<s:hidden name="bien.fechaAlta" />
		<div class="contentTabs" id="BienRustico" style="width: 760px; border: none; background-color: rgb(235, 237, 235);">  
			<%@include file="pestaniaBienRustico.jsp" %>
		</div>
		
		<div class="contentTabs" id="Direccion"
			style="width: 760px; border: none; background-color: rgb(235, 237, 235);">
			<%@include file="pestaniaDireccionRustico.jsp" %>
		</div>
	...
	<script type="text/javascript">inicializarCombos();</script>
</div>
