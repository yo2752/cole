...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Alta otro bien</span>
			</td>
		</tr>
	</table>
</div>
<div>
	...
	<ol id="toc">
		<li id="OtroBien"><a href="#OtroBien">Otro bien</a></li>
	...
	<s:form method="post" id="formData" name="formData">
		...
		<s:hidden id="idTipoInmueble" name="bien.tipoInmueble.idTipoInmueble" value="OT"  />

		<div class="contentTabs" id="OtroBien" style="width: 760px; border: none; background-color: rgb(235, 237, 235);">  
			<%@include file="pestaniaOtroBien.jsp" %>
		</div>
