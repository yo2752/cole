	...
	<div class="contenido">
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				...
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<s:textfield name="personaModificar.nif" id="Nif" size="9" maxlength="9" onblur="this.className='input';" onfocus="this.className='inputfocus';" disabled="true"/>
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
						...
						<tr>
							<td align="left" nowrap="nowrap">
								<s:textfield name="personaModificar.fechaCaducidadNif.dia" id="diaCadNif" onblur="this.className='input2';" onfocus="this.className='inputfocus';"
									onkeypress="return validarNumerosEnteros(event)" size="2" maxlength="2" disabled="true"/>
							</td>
							<td>/</td>
							<td align="left" nowrap="nowrap">
							...
							<td align="left" nowrap="nowrap">
								<s:textfield name="personaModificar.fechaCaducidadNif.anio" id="anioCadNif" onblur="this.className='input2';"
									onkeypress="return validarNumerosEnteros(event)" onfocus="this.className='inputfocus';" size="5" maxlength="4" disabled="true"/>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:checkbox  id="indefinido" onclick="" onkeypress="this.onClick" name="personaModificar.indefinido" disabled="true"/>
				</td>
			</tr>
		</table>
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				...
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<s:checkbox id="otroDocumentoIdentidad" onclick="" onkeypress="this.onClick"
						name="personaModificar.otroDocumentoIdentidad" disabled="true"/>
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
					<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboTipoDocumentoAlternativo()" id="tipoDocumentoAlternativo"
						...
						listValue="nombreEnum" listKey="valorEnum" title="Tipo Documento Alternativo" headerKey="-1" headerValue="-" disabled="true"/>
				</td>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
		...
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
			<tr>
				...
				<td align="left" nowrap="nowrap"> 
					<s:textfield name="personaModificar.apellido1RazonSocial" id="apellido1RazonSoc" maxlength="100" onblur="this.className='input';" onfocus="this.className='inputfocus';" disabled="true"/>
				</td>
			</tr>
			<tr>
			...
			<s:if test="personaModificar.tipoPersona == 'JURIDICA'">
				<tr>	
					...
					<td align="left" nowrap="nowrap">
						<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboTipoSubtipoPersonas()" id="subtipo" onblur="this.className='input2';" disabled="true"
				...
				<s:else>
					...
					<td align="left" nowrap="nowrap">
						<table>
							<tr>
								<td align="left" nowrap="nowrap">
									<s:textfield name="personaModificar.fechaNacimiento.dia" id="diaFechaNacimiento" size="2" maxlength="2" disabled="true"
										onblur="this.className='input';" onfocus="this.className='inputfocus';" onkeypress="return validarNumerosEnteros(event)" />
								</td>
								<td>/</td>
								<td align="left" nowrap="nowrap">
									<s:textfield name="personaModificar.fechaNacimiento.mes" id="mesFechaNacimiento" size="2" maxlength="2" disabled="true"
										onblur="this.className='input';" onfocus="this.className='inputfocus';" onkeypress="return validarNumerosEnteros(event)" />
								</td>
								<td>/</td>
								<td align="left" nowrap="nowrap">
									<s:textfield name="personaModificar.fechaNacimiento.anio" id="anioFechaNacimiento" size="4" maxlength="4" disabled="true"
										onblur="this.className='input';" onfocus="this.className='inputfocus';" onkeypress="return validarNumerosEnteros(event)" />
								</td>
							</tr>
						</table>
					...
					<td align="left" nowrap="nowrap">
						<s:select list="@escrituras.utiles.UtilesVista@getInstance().getComboSexo()" id="sexo" onblur="this.className='input2';" disabled="true"
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<s:select list="@escrituras.utiles.UtilesVista@getInstance().getProvinciasSujetoPasivo()" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';"  headerKey="-1"	headerValue="Seleccione Provincia" disabled="true"
				...
				<td align="left" nowrap="nowrap">
					<select id="idMunicipio" disabled="disabled" onchange="cargarListaPueblos('idProvincia', this, 'idPueblo', 'puebloSeleccionado');
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<select id="idPueblo" onchange="seleccionarCampo('puebloSeleccionado','idPueblo');" style="width:200px;" onblur="this.className='input2';"
						onfocus="this.className='inputfocus';" disabled="disabled">
			...
			<tr>
				...
				<td align="left" nowrap="nowrap">
					<select id="idPuebloCorreos" onchange="seleccionarCampo('puebloCorreosSeleccionado','idPuebloCorreos');"
						style="width:200px;" onblur="this.className='input2';" onfocus="this.className='inputfocus';" disabled="disabled">
							<option value="-1">Seleccione Pueblo</option>
					</select>
				...
				<td align="left" nowrap="nowrap">
					<s:textfield name="personaModificar.direccionDto.codPostalCorreos" id="codPostalCorreos" maxlength="5" size="5" onblur="this.className='input';"
						onkeypress="return validarNumeros(event)" onfocus="this.className='inputfocus';" disabled="true"/>
				</td>
			</tr>
			<tr>
				<td align="left" nowrap="nowrap" style="vertical-align: middle;">
				...
				<td align="left" nowrap="nowrap">
					<select id="tipoVia" onblur="this.className='input2';" disabled="disabled" onfocus="this.className='inputfocus';" onchange="seleccionarCampo('tipoViaSeleccionada','tipoVia');cargarListaNombresVia('idProvincia', 'municipioSeleccionado', this, 'nombreVia',viaPersona);">
				...
				<td align="left" nowrap="nowrap"> 
					<s:textfield name="personaModificar.direccionDto.nombreVia" id="nombreVia" size="30" maxlength="50" onblur="this.className='input';"
						onfocus="this.className='inputfocus';" cssStyle="width:200px;position:relative;" autocomplete="off" disabled="true"/>
				</td>
			</tr>
		</table>
		<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
