...
function limpiarCamposBienUrbano(){
	$('#idTipoInmuebleUrbano').val("-1");
	$('#idBienUrbanoDto').val("");
	$('#idBienUrbanoHidden').val("");
	$('#idSuperfConsUrbano').val("");
	$('#diaBusquedaUrbanoIni').val("");
	$('#mesBusquedaUrbanoIni').val("");
	$('#anioBusquedaUrbanoIni').val("");
	$('#idRefCatrastalUrbano').val("");
	$('#idSituacionUrbano').val("-1");
	$('#idPorcentajeTransUrbano').val("");
	$('#idValorArrendamientoUrbano').val("");
	$('#idAnioContratacionUrbano').val("");
	$('#idVPOUrbano').val("");
	$('#idDescalificadoUrbano').val("");
	$('#idPrecioMaximoUrbano').val("");
	$('#idValorDeclaradoUrbano').val("");
	$('#idProvinciaBienUrbano').val("-1");
	$('#idDupTriUrbano').val("-1");
	$('#idMunicipioBienUrbano').find('option').remove().end().append('<option value="-1">Seleccione Municipio</option>').val('whatever');
	$('#idTipoVia').find('option').remove().end().append('<option value="-1">Seleccione Tipo de Via</option>').val('whatever');
	$('#idNombreViaUrbano').val("");
	$('#idCodPostalUrbano').val("");
	$('#idNumeroViaUrbano').val("");
	$('#idNumLocalUrbano').val("");
	$('#idPisoUrbano').val("");
	$('#idPuertaUrbano').val("");
	$('#idEscaleraUrbano').val("");
}

function limpiarCamposBienRustico(){
	var $tipoInmueble = $("#idTipoInmuebleRustico", parent.document);
	...
	var $sistemaExpl = $("#idSistemaExplotacionRustico", parent.document);
	var $porctjTrans = $("#idPorcentajeTransmisionRustico", parent.document);
	var $valorDeclar = $("#idValorDeclaradoRustico", parent.document);
	var $superficie = $("#idSuperficieRustico", parent.document);
	var $unidadMetrica = $("#idUnidadMetricaRustico", parent.document);
	var $provincia = $("#idProvinciaBienRustico", parent.document);
	var $municipio = $("#idMunicipioBienRustico", parent.document);
	var $codPostal = $("#idCodPostalRustico", parent.document);
	var $paraje = $("#idParajeRustico", parent.document);
	var $poligono = $("#idPoligonoRustico", parent.document);
	var $parcela = $("#idParcelaRustico", parent.document);
	var $subParcela = $("#idSubParcelaRustico", parent.document);
	var $refCatrastal = $("#idRefCatrastalRustico", parent.document);
	
	var $hiddenIdBien = $("#idBienRusticoHidden");
	var $idBien = $("#idBienRusticoDto");
	...
	$unidadMetrica.val("-1");
	$provincia.val("-1");
	$municipio.find('option').remove().end().append('<option value="-1">Seleccione Municipio</option>').val('whatever');
	$codPostal.val("");
	$paraje.val("");
	$poligono.val("");
	$parcela.val("");
...
function limpiarCamposOtroBien(){
	var $hiddenIdBien = $("#idOtroBienHidden");
	var $idBien = $("#idOtroBienDto");
	var $refCatrastal = $("#idRefCatrastalOtro", parent.document);
	var $valorDeclar = $("#idValorDeclaradoOtro", parent.document);
	var $porctjTrans = $("#idPorcentajeTransOtro", parent.document);
	var $valorTasacion = $("#idValorTasacion", parent.document);
	var $tipoInmueble = $("#idTipoInmuebleOtro", parent.document);
...
function marcarTodosBienesUrbanos(objCheck) {
	...
	if (document.formData.listaChecksBienUrbano) {
		if (!document.formData.listaChecksBienUrbano.length) { 
...
function marcarTodosBienesRusticos(objCheck) {
	...
	if (document.formData.listaChecksBienRustico) {
		if (!document.formData.listaChecksBienRustico.length) { 
...
function importarModelo(){
	...
	if(	$("#rbAltaArrendamiento").is(':checked')){
	
		$("#formData").attr("action", "importarAACAYCImportaciones.action").trigger("submit");
	}
	
	if(	$("#rbModificacionArrendamiento").is(':checked')){
	
		$("#formData").attr("action", "importarMACAYCImportaciones.action").trigger("submit");
	}
	if(	$("#rbAltaConductor").is(':checked')){
	
		$("#formData").attr("action", "importarACCAYCImportaciones.action").trigger("submit");
	}
	if(	$("#rbModificacionConductor").is(':checked')){
	
		$("#formData").attr("action", "importarMCCAYCImportaciones.action").trigger("submit");
	}
