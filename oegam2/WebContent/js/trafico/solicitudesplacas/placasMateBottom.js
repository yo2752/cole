...
function recargar(){
	...
	// Comienza el ajax
	var url = "refrescar_AltaSolicitudesPlacas.action?numsExpedientes=" + numsExpedientes;
...
function recargar(selSolicitud,idForm){
	...
	formulario.action = 'inicioSolicitudSolicitudPlacasAltaSolicitudesPlacas.action?selSolicitud='+selSolicitud;
	formulario.submit();
