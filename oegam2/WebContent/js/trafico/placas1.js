...
function volverConsultaSolicitudesPlaca(boton) {
	...
	document.forms[0].action = "load_buscarPlacasConsultaSolicitudesPlacas.action";
	...
	function solicitarPlacasMatricula(formId){
		...
		if(codigos!=null && codigos!='' && codigos!='undefined'){
			...
			formulario.action = 'boton_AltaDesolicitudesSolicitudPlacas1.action?numsExpedientes=' + codigos;
	...
	function realizarSolicitudPlacas(formulario){
		...
		formulario.action = 'boton_guardarSolicitudSolicitudPlacas1.action';
		formulario.submit();
	...
	function confirmarSolicitudPlacas(formulario){
		...
		formulario.action = 'boton_confirmarSolicitudSolicitudPlacas1.action';
		formulario.submit();
	...
	function finalizarSolicitudPlacas(formulario){
		...
		formulario.action = 'boton_finalizarSolicitudSolicitudPlacas1.action';
		formulario.submit();
	...
	function cambiarEstadoSolicitudPlacas(formulario, estado){
		...
		formulario.action = 'boton_cambiarEstadoSolicitudSolicitudPlacas1.action';
		formulario.submit();
	...
	function editarSolicitudesPlacas(formulario){
		...
		formulario.action = 'boton_modificarConsultaSolicitudesPlacas.action';
	...
	function borrarSolicitudesPlacas(formulario){
		...
		formulario.appendChild(campoCodigos);
		formulario.appendChild(estadosSolicitudes);
		formulario.action = 'boton_borrarConsultaSolicitudesPlacas.action';
	...
	function cambiarElementosPorPaginaConsulPlacas() {
		...
		document.location.href = 'navegarConsultaSolicitudesPlacas.action?resultadosPorPagina='
