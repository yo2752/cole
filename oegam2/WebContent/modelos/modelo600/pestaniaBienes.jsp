		...
		<div id="divAltaModiBienes">
			...
			<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
				<tr>
					...
					<td align="left">
						<s:select  name="modeloDto.tipoBien"  id="idTipoBien"
							list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesBienes@getInstance().getTipoBien600()"
