...
<div class="contenido">	
	...
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
		<tr>
			...
			<td align="left" nowrap="nowrap" width="24%">
				<s:textfield id="idNifPresentador" name="modeloDto.presentador.persona.nif"  onblur="this.className='input2';calculaLetraNIF(this)"
					disabled="true" onfocus="this.className='inputfocus';" style="text-transform : uppercase"
					size="9" maxlength="9"/>
				<s:hidden name="modeloDto.presentador.persona.numColegiado"/>
				<s:hidden name="modeloDto.presentador.direccion.idDireccion"/>
				<s:hidden name="modeloDto.presentador.idInterviniente"/>
				<s:hidden name="modeloDto.presentador.tipoInterviniente"/>
			</td>
			<td align="left" nowrap="nowrap">
			...
			<td align="left" nowrap="nowrap">
				<s:select list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesModelos@getInstance().getComboTipoPersonas()"
					...
					onfocus="this.className='inputfocus';" name="modeloDto.presentador.persona.tipoPersona" disabled="true"
		...
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<s:select id="idSexoPresentador" name="modeloDto.presentador.persona.sexo"
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idPrimerApeRazonSocialPresentador"  name="modeloDto.presentador.persona.apellido1RazonSocial"
		...
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idSegundoApePresentador" name="modeloDto.presentador.persona.apellido2" onblur="this.className='input2';"
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idNombrePresentador" name="modeloDto.presentador.persona.nombre" onblur="this.className='input2';"
		...
		<tr>
				...
				<table>
					<tr>
						<td align="left" nowrap="nowrap" width="5%">
							<s:textfield name="modeloDto.presentador.persona.fechaNacimiento.dia" id="idDiaNacPresentador" onblur="this.className='input2';" 
								onkeypress="return validarDia(this, event)" onfocus="this.className='inputfocus';" size="2" maxlength="2" disabled="true"/>
						</td>
						<td width="1%">/</td>
						<td align="left" nowrap="nowrap" width="5%">
							<s:textfield name="modeloDto.presentador.persona.fechaNacimiento.mes" id="idMesNacPresentador" onblur="this.className='input2';" 
								onkeypress="return validarMes(this, event)" onfocus="this.className='inputfocus';"  size="2" maxlength="2" disabled="true"/>
						</td>
						<td width="1%">/</td>
						<td align="left" nowrap="nowrap" width="5%">
							<s:textfield name="modeloDto.presentador.persona.fechaNacimiento.anio" id="idAnioNacPresentador" onblur="this.className='input2';" onkeypress="return validarAnio(this, event)"
			...
			<td align="left" nowrap="nowrap">
				<s:textfield name="modeloDto.presentador.persona.telefonos" id="idTelefonoPresentador" size="10" maxlength="9" onblur="this.className='input2';"
		...
		<tr>
			...
			<td>
				<s:select list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesModelos@getInstance().getListaProvincias()" onblur="this.className='input2';"
						...
						name="modeloDto.presentador.direccion.idProvincia" listKey="idProvincia" listValue="nombre" id="idProvinciaPresentador"
						disabled="true"/>
			</td>
			<td align="left" nowrap="nowrap">
			...
			<td align="left" nowrap="nowrap">
				<s:select onblur="this.className='input2';" onfocus="this.className='inputfocus';" id="idMunicipioPresentador"
					...
					name="modeloDto.presentador.direccion.idMunicipio"
					list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesModelos@getInstance().getListaMunicipiosPorProvincia(modeloDto,'002')" disabled="true"
				/>
			</td>
		</tr>
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<s:select id="idPuebloPresentador" onblur="this.className='input2';"
					list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesModelos@getInstance().getListaPueblosPorMunicipioYProvincia(modeloDto,'002')"
					headerKey="-1" headerValue="Seleccione Pueblo" listKey="pueblo" listValue="pueblo"
					name="modeloDto.presentador.direccion.pueblo"
			...
			<td>
				<s:select  onblur="this.className='input2';" onfocus="this.className='inputfocus';"
					list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesModelos@getInstance().getListaTiposVias(modeloDto,'002')"
					headerKey="-1" headerValue="Seleccione Tipo Via" listKey="idTipoViaCam" listValue="nombre"
					name="modeloDto.presentador.direccion.idTipoVia"
					id="idTipoViaPresentador" disabled="true"/>
			</td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap">
			...
			<td align="left" nowrap="nowrap">
				<s:textfield name="modeloDto.presentador.direccion.nombreVia" id="idNombreViaPresentador" size="25" onblur="this.className='input2';"
					onfocus="this.className='inputfocus';" disabled="true"/>
			</td>
			<td align="left" nowrap="nowrap">
			...
			<td align="left" nowrap="nowrap">
				<s:textfield name="modeloDto.presentador.direccion.codPostal" id="idCodPostalPresentador" size="5" maxlength="5" onblur="this.className='input2';"
					onfocus="this.className='inputfocus';" disabled="true"/>
			</td>
		</tr>
	</table>
	<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left" style="100%">
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idNumeroDireccionPresentador" name="modeloDto.presentador.direccion.numero"
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idLetraDireccionPresentador" name="modeloDto.presentador.direccion.letra" 
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idEscaleraDireccionPresentador" name="modeloDto.presentador.direccion.escalera"
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idPisoDireccionPresentador" name="modeloDto.presentador.direccion.planta"
		...
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idPuertaDireccionPresentador" name="modeloDto.presentador.direccion.puerta"
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idBloqueDireccionPresentador" name="modeloDto.presentador.direccion.bloque"
					onblur="this.className='input2';" onfocus="this.className='inputfocus';" size="4" maxlength="10" disabled="true"/>
			</td>
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idKmDireccionPresentador" name="modeloDto.presentador.direccion.km"
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="hmDireccionPresentador" name="modeloDto.presentador.direccion.hm"
					onblur="this.className='input2';" onfocus="this.className='inputfocus';"
