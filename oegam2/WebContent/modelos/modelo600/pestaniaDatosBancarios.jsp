...
<div class="contenido">	
	...
	<table class="nav" cellSpacing="1" cellPadding="5" width="100%" align="left">
		<tr>
			<td class="tabular">
				<span class="titulo">Alta Datos Bancarios Modelo 600</span>
			</td>
		</tr>
	</table>
		...
		<tr id="idSeleccionDatosBancFavoritos">
			...
			<td align="left" nowrap="nowrap">
				<s:select id="idComboExistente"
					...
					headerKey="" headerValue="Seleccione Datos Bancarios Favoritos" onchange="cargarDatosBancariosFavoritos('divDatosBancarios600');"
