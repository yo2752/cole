...
<div class="contenido">	
	...
	<table class="tablaformbasica">
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<s:textfield id="idValorDeclarado"  name="modeloDto.valorDeclarado"
		...
		<tr>
			...
			<td align="left" nowrap="nowrap">
				<table>
					<tr>
						<td>
							<s:select list="modeloDto.modelo.bonificaciones" id="idBonificaciones" onblur="this.className='input2';"
						...
						<td>
							<s:textfield name="modeloDto.bonificacion.monto" id="idBonificacionMonto" size="3" maxlength="3" onblur="this.className='input';"
			...
			<td  align="left" nowrap="nowrap">
				<table>
					<tr>
						...
						<td>
							<s:checkbox name="modeloDto.exento" id="idExento"	onblur="this.className='input';" onfocus="this.className='inputfocus';"
						...
						<td>
							<s:checkbox name="modeloDto.noSujeto" id="idNoSujeto" onblur="this.className='input';" onfocus="this.className='inputfocus';"
			...
			<td align="left" nowrap="nowrap">
				<table>
					<tr>
						...
						<td align="left" nowrap="nowrap">
							<s:textfield id="idFundamentoNoSujeto"  name="modeloDto.fundamentoNoSujeccion"
							...
							<s:select list="modeloDto.modelo.fundamentosExencion"
								id="idFundamentoExento" onblur="this.className='input2';"
								onfocus="this.className='inputfocus';" name="modeloDto.idFundamentoExencion"
			...
			<td align="left" nowrap="nowrap">
				<table>
					<tr>
						...
						<td>
							<s:checkbox name="modeloDto.liquidacionComplementaria" id="idLiquiComp" onblur="this.className='input';" 
							...
							<table>
								<tr>
									<td align="left" nowrap="nowrap" width="5%">
										<s:textfield name="modeloDto.fechaPrimLiquidacion.dia" id="idDiaFechaPrimLiq" onblur="this.className='input2';" 
											onkeypress="return validarNumerosEnteros(event)" onfocus="this.className='inputfocus';" size="2" maxlength="2" disabled="true"/>
									</td>
									<td width="1%">/</td>
									<td align="left" nowrap="nowrap" width="5%">
										<s:textfield name="modeloDto.fechaPrimLiquidacion.mes" id="idMesFechaPrimLiq" onblur="this.className='input2';" 
											onkeypress="return validarNumerosEnteros(event)" onfocus="this.className='inputfocus';"  size="2" maxlength="2" disabled="true"/>
									</td>
									<td width="1%">/</td>
									<td align="left" nowrap="nowrap" width="5%">
										<s:textfield name="modeloDto.fechaPrimLiquidacion.anio" id="idAnioFechaPrimLiq" onblur="this.className='input2';" onkeypress="return validarNumerosEnteros(event)"
		...
		<tr>
			<td align="left" nowrap="nowrap">
				<label for="labelNJustiPrimLiq">Número de primera Autoliquidación:</label>
			</td>
			<td align="left" nowrap="nowrap">
				<s:textfield name="modeloDto.numeroPrimPresentacion" id="idNumJustPrimLiq" onblur="this.className='input2';"
					onfocus="this.className='inputfocus';"  size="10" maxlength="13" disabled="true"/>
			</td>
		</tr>
		<tr>
			<td align="left" nowrap="nowrap" colspan="4">
				<table>
					<tr>
						<td align="left">
							<s:checkbox name="modeloDto.liquidacionManual" id="idLiqManual" onblur="this.className='input';"
								onfocus="this.className='inputfocus';" onchange="javascript:habilitarCamposLiquidacion();" />
						</td>
						<td colspan="3" style="vertical-align: middle;">
							El Gestor Administrativo Colegiado manifiesta bajo su responsabilidad que los datos 
								de la autoliquidación han sido introducidos manualmente.
						</td>
					</tr>
				</table>
			</td>
