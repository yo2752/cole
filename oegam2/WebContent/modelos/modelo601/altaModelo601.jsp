...
<div class="nav">
	<table width="100%" >
		<tr>
			<td class="tabular">
				<span class="titulo">Alta  Modelo 601</span>
			</td>
		</tr>
	</table>
</div>
<div>
	...
	<ol id="toc">
		<li id="Modelo601" onclick="mostrarBotonGuardar()"><a href="#Modelo601">Modelo 601</a></li>
		...
		<s:if test="%{@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().esGenerada(remesa)}">
			<li id="Liquidaciones" onclick="mostrarBotonGuardar()"><a href="#Liquidaciones">Liquidaciones</a></li>
		</s:if>
		<s:if test="%{@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesModelos@getInstance().mostrarDatosBancarios(modeloDto)}">
			<li id="DatosBancarios601" onclick="ocultarBotonGuardar()"><a href="#DatosBancarios601">Datos Presentación</a></li>
		</s:if>
	...
	<s:form method="post" id="formData" name="formData" enctype="multipart/form-data">
		...
		<div class="contentTabs" id="Modelo601" style="width: 760px; border: none; background-color: rgb(235, 237, 235);">
			<%@include file="pestaniaModelo601.jsp" %>
		</div>
		...
		<div class="contentTabs" id="DatosBancarios601" 
			style="width: 760px; border: none; background-color: rgb(235, 237, 235);">
