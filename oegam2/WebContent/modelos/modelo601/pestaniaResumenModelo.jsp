...
<div class="contenido">
	...
	<s:if test="%{@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesModelos@getInstance().esConceptoBienes(modeloDto)}">
		...
		<s:if test="%{modeloDto.listaOtrosBienes != null && modeloDto.listaOtrosBienes.size()>0}">
			<table cellSpacing="3" class="tablaformbasica" cellPadding="0" align="left">
				<s:iterator value="%{modeloDto.listaOtrosBienes}">
					<tr>
						<td align="left" nowrap="nowrap" width="8%">
							<label for="labelTipoBienOT">Tipo Bien: </label>
						</td>
						<td align="left" nowrap="nowrap" width="5%">
							<s:label for="LabelDescTipoBienOT">Otro Bien</s:label>
						</td>
						<td align="left" nowrap="nowrap" width="5%">
							<label for="labelNombreBienOT">Nombre: </label>
						</td>
						<td align="left" nowrap="nowrap" width="5%">
							<s:property value="%{bien.nombreBien}"/>
						</td>
						<td align="left" nowrap="nowrap" width="5%">
							<label for="labelValDeclaradoOT">Valor Declarado: </label>
						</td>
						<td align="left" nowrap="nowrap"width="5%">
							<s:property value="%{valorDeclarado}"/>
						</td>
						<td align="left" nowrap="nowrap" width="5%">
							<label for="labelTransmisionOT">Porctj.Transmisión: </label>
						</td>
						<td align="left" nowrap="nowrap">
							<s:property value="%{transmision}"/>
						</td>
						<td align="left" nowrap="nowrap" width="5%">
							<label for="labelValorTasacOT">Valor Tasación: </label>
						</td>
						<td align="left" nowrap="nowrap">
							<s:property value="%{valorTasacion}"/>
						</td>
					</tr>
				</s:iterator>
			</table>
