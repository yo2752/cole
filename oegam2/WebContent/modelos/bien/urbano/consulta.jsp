	...
	<body class="popup">
		<s:form method="post" id="formData" name="formData">
			...
			<div id="busqueda">
				<table class="tablaformbasica">
					...
					<tr>
						...
						<td align="left">
							<s:select list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getDecision()"
					...
					<tr>
						...
						<td align="left" nowrap="nowrap">
							<s:select list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getListaTiposInmuebles(@org.gestoresmadrid.core.modelos.model.enumerados.TipoBien@Urbano)"
								onblur="this.className='input2';" 
					...
					<tr>
						...
						<td align="left" nowrap="nowrap">
							<label for="labelValorDeclarado">Valor Declarado:</label>
						</td>
						<td align="left" nowrap="nowrap">
							<s:textfield name="bien.valorDeclarado" id="idValorDeclarado" size="25" onblur="this.className='input';"
								onfocus="this.className='inputfocus';"/>
						</td>
					</tr>
					<tr>
						...
						<td align="left" nowrap="nowrap">
							<s:select list="@org.gestoresmadrid.oegam2comun.modelos.utiles.UtilesRemesas@getInstance().getComboEstados()"
								onblur="this.className='input2';" 
								onfocus="this.className='inputfocus';" headerKey=""	headerValue="TODOS"
			...
			<div class="acciones center">
				...
				<input type="button" class="boton" name="bLimpiar" onclick="javascript:limpiarBienUrbano();" value="Limpiar"/>
			</div>
			<br/>
			...
			<div id="displayTagDiv" class="divScroll">
				...
				<display:table name="lista" class="tablacoin"
					...
					<display:column property="numero" title="Numero" sortable="true" headerClass="sortable"
						defaultorder="descending" style="width:4%" />
					...
					<display:column property="transmision" title="Transmisión" sortable="true" headerClass="sortable"
						defaultorder="descending" style="width:4%" />
