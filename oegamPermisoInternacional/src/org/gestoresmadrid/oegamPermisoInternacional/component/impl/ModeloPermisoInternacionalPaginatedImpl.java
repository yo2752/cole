...
@Service(value = "modeloPermisoInternacionalPaginated")
@Transactional(readOnly = true)
public class ModeloPermisoInternacionalPaginatedImpl extends AbstractModelPagination {
	...
	protected GenericDao<?> getDao() {
		return permisoInternacionalDao;
	}
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<ConsultaPermisoInternacionalBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaPermisoInternacional.convertirListaEnBeanPantallaConsulta((List<PermisoInternacionalVO>) list);
