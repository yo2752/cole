package org.gestoresmadrid.oegamPermisoInternacional.component.impl;
...
@Service(value = "modeloEvolucionPermInterPaginated")
@Transactional(readOnly = true)
public class ModeloEvolucionPermInterPaginatedImpl extends AbstractModelPagination {

	@Resource
	EvolucionPermisoInternacionalDao evolucionPermisoInternacionalDao;
	
	@Autowired
	ServicioEvolucionPermisoInternacional servicioEvolucionPermisoIntern;

	@Override
	protected GenericDao<?> getDao() {
		return evolucionPermisoInternacionalDao;
	}
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<EvolucionPermisoInterBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioEvolucionPermisoIntern.convertirListaEnBeanPantalla((List<EvolucionPermisoInterVO>) list);
