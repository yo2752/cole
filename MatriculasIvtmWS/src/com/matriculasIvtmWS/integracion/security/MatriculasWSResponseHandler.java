...
public class MatriculasWSResponseHandler extends BasicHandler {
   ...
   // Opciones de seguridad
	...
	private static final Logger log  = Logger.getLogger(MatriculasWSResponseHandler.class);
	
	public MatriculasWSResponseHandler() {
		super();
   ...
   public void invoke(MessageContext msgContext) throws AxisFault {
      ...
      try {
			...
			Date fecha = new Date();
			String nombreFichero  = "IVTMMATRICULASWS_REQ_" + utilesFecha.formatoFecha("ddMMyyHHmmssSSS",fecha);
			try {
				gestorDocumentos.guardarFichero(ConstantesGestorFicheros.IVTM, ConstantesGestorFicheros.IVTM_MATRICULAS_WS,
					new Fecha(fecha), nombreFichero, ".soap", msg.getSOAPPartAsBytes());
