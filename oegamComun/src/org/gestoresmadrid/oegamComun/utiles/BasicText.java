...
public abstract class BasicText {
	...
	/**
	 * Reemplaza en una cadena un texto por otro. La comparación no es sensitiva a mayúsculas y minúsculas (case insensitive).
	...
	/**
	 * Reemplaza en una cadena un texto por otro. La comparación puede ser sensitiva o no sensitiva a mayúsculas y minúsculas.
	 * @param cadena la cadena original en la que va a buscarse
	 * @param subcadena1 la subcadena que se buscará en la cadena
	 * @param subcadena2 la subcadena por la que se reemplazará la subcadena1
	 * @param ignoreCase si la búsqueda de subcadena1 en cadena debe ignorar si está en mayúsculas y minúsculas (true) o no (false).
	...
	/**
	 * Crea una copia de cadena y con el tamaño especificado; si la cadena es mayor que el tamaño especificado, devuelve los <code>size</code> primeros caracteres; en caso contrario, completa con espacios en blanco al final de la cadena hasta llegar al tamaño especificado.
	 ...
	 * @param size el tamaño en caracteres de la copia
	 * @param relleno el caracter de relleno para completar el tamaño
	 * @param detras si hay que completar con " " detrás (true) o delante (false) de la cadena original
	 * @return la copia con el nuevo tamaño
	 */
	...
	/**
	 * Reemplaza los caracteres con acento por la cadena html que representa el caracter á --> &aacute;
	 * @param cadena la cadena original en la que va a buscarse
	 * @return la cadena modificada
	 */
	...
	/**
	 * If the given parameter has a value starting and ending by '"', removes those leading and trailing characters; this method "dequotes" a string, DOESN'T remove any inner quote nor remove leading or trailing quotes if both characters doesn't match (i.e. only appears a leading quote or only a
	 * trailing quote).
	 */
