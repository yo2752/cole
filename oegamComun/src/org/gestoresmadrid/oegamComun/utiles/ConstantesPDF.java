...
public class ConstantesPDF extends ConstantesTrafico{
	...
	//Rutas de las plantillas(Esto hay que pasarlo a un properties y acceder a la ruta as�)
	...
	public static final String RUTA_MARCA_AGUA_PEQUE = "marcaAguaPeque.jpg";
	...
	public static final String DENOMINACION = "Denominaci�n:";
...
//	public static final String RUTA_PERMISO_TEMPORAL_CIRCULACION = b
	...
	public static final String ID_NOMBRE_APELLIDOS_TITULAR_MTW = "Nombre y Apellidos/Raz�n Social";
	...
	public static final String ID_TIPO_TRANSMISION_2 = "CTI - Finalizaci�n tras una notificaci�n";
	public static final String ID_TIPO_TRANSMISION_3 = "CTI - Interviene Compraventa";
	public static final String ID_TIPO_TRANSMISION_4 = "NOT - Notificaci�n de Venta";
	public static final String ID_TIPO_TRANSMISION_5 = "ENT - Entrega a Compraventa";
	public static final String ID_TRAMITABLE_TELEMATICAMENTE = "Expediente tramitable telem�ticamente";
	...
	public static final String ID_GESTORIA = "ID_GESTORIA"; //Utilizado por plantilla de matriculaci�n tambi�n.
	...
	public static final String VALOR_TITULO_BAJA_4 = 		"NOTIFICACI�N DE TRANSMISI�N";
	public static final String VALOR_TITULO_TRANSMISION = 	"TRANSMISI�N";
	public static final String VALOR_TITULO_TRANSMISION_2 = "NOTIFICACI�N DE TRANSMISI�N";
	...
	public static final String VALOR_TIT_GEST = 			"RESULTADO VALIDACI�N GEST";
	...
	//Constantes para la generaci�n de etiquetas
	...
	public static final float ALTO_BARRA = 7.3f; 				// Altura de las barras del c�digo de barras
	public static final float POSICION_X_BARCODE = 4.6f; 		// Posicion X del c�digo de barras
	public static final float POSICION_Y_BARCODE = 8.7f; 		// Posicion Y del c�digo de barras. pos_Y + altura (1.6 + 7.3)
	...
	// Tama�o de la fuente de la matricula
	...
	public static final String NO_SE_PUEDE_IMPRIMIR_LA_MANCHA_PDF_PORQUE_NO_TIENE_PERMISO_PARA_ESTA_ACCION = "No se puede imprimir la mancha Pdf  por que no tiene permiso para esta acci�n";
	
	//Nombre de la property para indicar si se completa con 0 a la izquierda los campos autonom�a el�ctrica y consumo.
	...
	public static String getSchema(){
		...
		//Si no se ha especificado el key store de las claves p�blicas se coje el de por defecto
