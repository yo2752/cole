...
public class Anagrama {
	...
	public static String obtenerAnagramaFiscal(String primerApellido, String NIF) {
		try {
			...
			while (strTokenizer.hasMoreTokens()) {
				...
				if ("DE".equalsIgnoreCase(palabra) || "DEL".equalsIgnoreCase(palabra) || "LA".equalsIgnoreCase(palabra) || "LAS".equalsIgnoreCase(palabra) || "LO".equalsIgnoreCase(palabra) || "LOS"
						.equalsIgnoreCase(palabra) || "EL".equalsIgnoreCase(palabra) || "DON".equalsIgnoreCase(palabra) || "AL".equalsIgnoreCase(palabra)) {} else {
					apellido = palabra;
					break;
				}
			}
			...
			if ("ñ".equals(primeraLetraApellido) || "#".equals(primeraLetraApellido) || "@".equals(primeraLetraApellido) || "?".equals(primeraLetraApellido) || "¿".equals(primeraLetraApellido) || "/"
					.equals(primeraLetraApellido) || "\\".equals(primeraLetraApellido) || "~".equals(primeraLetraApellido)) {
				primeraLetraApellido = "Ñ";
			}

			if ("ñ".equals(segundaLetraApellido) || "#".equals(segundaLetraApellido) || "@".equals(segundaLetraApellido) || "?".equals(segundaLetraApellido) || "¿".equals(segundaLetraApellido) || "/"
					.equals(segundaLetraApellido) || "\\".equals(segundaLetraApellido) || "~".equals(segundaLetraApellido)) {
				segundaLetraApellido = "Ñ";
			}

			if ("ñ".equals(terceraLetraApellido) || "#".equals(terceraLetraApellido) || "@".equals(terceraLetraApellido) || "?".equals(terceraLetraApellido) || "¿".equals(terceraLetraApellido) || "/"
					.equals(terceraLetraApellido) || "\\".equals(terceraLetraApellido) || "~".equals(terceraLetraApellido)) {
				terceraLetraApellido = "Ñ";
			}

			// Quitamos los acentos de las letras
			if ("á".equals(primeraLetraApellido) || "Á".equals(primeraLetraApellido) || "ª".equals(primeraLetraApellido)) {
				primeraLetraApellido = "A";
			}

			// Quitamos los acentos de las letras
			if ("é".equals(primeraLetraApellido) || "É".equals(primeraLetraApellido)) {
				primeraLetraApellido = "E";
			}

			// Quitamos los acentos de las letras
			if ("í".equals(primeraLetraApellido) || "Í".equals(primeraLetraApellido)) {
				primeraLetraApellido = "I";
			}

			// Quitamos los acentos de las letras
			if ("ó".equals(primeraLetraApellido) || "Ó".equals(primeraLetraApellido) || "º".equals(primeraLetraApellido)) {
				primeraLetraApellido = "O";
			}

			// Quitamos los acentos de las letras
			if ("ú".equals(primeraLetraApellido) || "Ú".equals(primeraLetraApellido)) {
				primeraLetraApellido = "U";
			}

			// Quitamos los acentos de las letras
			if ("á".equals(segundaLetraApellido) || "Á".equals(segundaLetraApellido) || "ª".equals(segundaLetraApellido)) {
				segundaLetraApellido = "A";
			}

			// Quitamos los acentos de las letras
			if ("é".equals(segundaLetraApellido) || "É".equals(segundaLetraApellido)) {
				segundaLetraApellido = "E";
			}

			// Quitamos los acentos de las letras
			if ("í".equals(segundaLetraApellido) || "Í".equals(segundaLetraApellido)) {
				segundaLetraApellido = "I";
			}

			// Quitamos los acentos de las letras
			if ("ó".equals(segundaLetraApellido) || "Ó".equals(segundaLetraApellido) || "º".equals(segundaLetraApellido))
			...
			// Quitamos los acentos de las letras
			if ("ú".equals(segundaLetraApellido) || "Ú".equals(segundaLetraApellido)) {
				segundaLetraApellido = "U";

			}

			// Quitamos los acentos de las letras
			if ("á".equals(terceraLetraApellido) || "Á".equals(terceraLetraApellido) || "ª".equals(terceraLetraApellido)) {
				terceraLetraApellido = "A";
			}

			// Quitamos los acentos de las letras
			if ("é".equals(terceraLetraApellido) || "É".equals(terceraLetraApellido)) {
				terceraLetraApellido = "E";
			}

			// Quitamos los acentos de las letras
			if ("í".equals(terceraLetraApellido) || "Í".equals(terceraLetraApellido)) {
				terceraLetraApellido = "I";
			}

			// Quitamos los acentos de las letras
			if ("ó".equals(terceraLetraApellido) || "Ó".equals(terceraLetraApellido) || "º".equals(terceraLetraApellido)) {
				terceraLetraApellido = "O";
			}

			// Quitamos los acentos de las letras
			if ("ú".equals(terceraLetraApellido) || "Ú".equals(terceraLetraApellido)) {
			...
			if ("'".equals(segundaLetraApellido) || "´".equals(segundaLetraApellido)) {
				segundaLetraApellido = " ";
				terceraLetraApellido = "";
			...
			if ("Ä".equals(terceraLetraApellido) || "Ë".equals(terceraLetraApellido) || "Ï".equals(terceraLetraApellido) || "Ö".equals(terceraLetraApellido) || "Ü".equals(terceraLetraApellido) || "Ç"
			...
			if (primeraLetraNIF.equalsIgnoreCase("X") || primeraLetraNIF.equalsIgnoreCase("K") || primeraLetraNIF.equalsIgnoreCase("L") || primeraLetraNIF.equalsIgnoreCase("M") || primeraLetraNIF
					.equalsIgnoreCase("Y")) {
				cuartaLetra = obtenerLetra(primeraLetraNIF);
			}

			long total = primeraLetra + (segundaLetra * _100) + (terceraLetra * _10000) + (cuartaLetra * _1000000);
			...
			if (Character.isDigit(primeraLetraNIF.charAt(0))) {
				if (!nifNumerico) {
					total = total + Long.valueOf(NIF.substring(0, _8)).longValue();
				} else {
					total = total + Long.valueOf(NIF.substring(0, _7)).longValue();
				}
			} else {
				if (nifNumerico) {
					total = total + Long.valueOf(NIF.substring(1, _9)).longValue();
				} else {
					total = total + Long.valueOf(NIF.substring(1, _8)).longValue();
				}
			}
			String anagramaFiscal = primeraLetraApellido.toUpperCase() + segundaLetraApellido.toUpperCase() + terceraLetraApellido.toUpperCase() + calcularLetra(total);
			if (quitarEspacios) {
	...
	/**
	 * Main de prueba para verificar la correcta resolución del fallo en obtención del anagrama cuando el nif es un nie que empieza por 'y'
	 * @param args
	 */
	...
	public static boolean validar(String psAnagrama, String psApellido1, String psNIF) {
		...
		if (!NIFValidator.isValidCIF(psNIF) && psNIF.length() >= 8 && psApellido1 != null && !psApellido1.isEmpty() /* && psApellido1.length()>=3 */ && psAnagrama != null) {
