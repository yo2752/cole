...
public class PersonaDto implements Serializable, Cloneable {
	...
	private List<PersonaDireccionDto> personaDireccionDtos;
	...
	public List<PersonaDireccionDto> getPersonaDireccionDtos() {
		return personaDireccionDtos;
	}

	public void setPersonaDireccionDtos(List<PersonaDireccionDto> personaDireccionDtos) {
		this.personaDireccionDtos = personaDireccionDtos;
	}
