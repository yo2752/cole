...
public class FormularioAutorizarTramitesDto implements Serializable{
	...
	//TRANSMISION CTIT
	private boolean acreditacionAbono;
	private boolean informeVehiculo;
	private String acreditacionPago;
	private String acreditacionHerenciaDonacion;
	private boolean anexoI;
	private boolean justificanteIsd;
	private boolean documentoAcreditativoDonacion;
	private String acreditacionSubastaJudicial;
	private boolean documentoAcreditativoSubastaJudicial;
	
	//MATRICULACION EXENTO CTR
	private String exentoCtr;
	private boolean acreditarExencion;
	...
	private boolean checkAcreditacion;
	...
	public boolean isAcreditacionAbono() {
		return acreditacionAbono;
	}
	public void setAcreditacionAbono(boolean acreditacionAbono) {
		this.acreditacionAbono = acreditacionAbono;
	}
	public boolean isInformeVehiculo() {
		return informeVehiculo;
	}
	public void setInformeVehiculo(boolean informeVehiculo) {
	...
	public boolean isAcreditarExencion() {
		return acreditarExencion;
	}
	public void setAcreditarExencion(boolean acreditarExencion) {
		this.acreditarExencion = acreditarExencion;
	}
	...
	public boolean isCheckAcreditacion() {
		return checkAcreditacion;
	}
	public void setCheckAcreditacion(boolean checkAcreditacion) {
		this.checkAcreditacion = checkAcreditacion;
	}
	public boolean isAnexoI() {
		return anexoI;
	}
	public void setAnexoI(boolean anexoI) {
		this.anexoI = anexoI;
	}
	public boolean isJustificanteIsd() {
		return justificanteIsd;
	}
	public void setJustificanteIsd(boolean justificanteIsd) {
		this.justificanteIsd = justificanteIsd;
	}
	public boolean isDocumentoAcreditativoDonacion() {
		return documentoAcreditativoDonacion;
	}
	public void setDocumentoAcreditativoDonacion(boolean documentoAcreditativoDonacion) {
		this.documentoAcreditativoDonacion = documentoAcreditativoDonacion;
	}
	...
	public String getAcreditacionHerenciaDonacion() {
		return acreditacionHerenciaDonacion;
	}
	public void setAcreditacionHerenciaDonacion(String acreditacionHerenciaDonacion) {
		this.acreditacionHerenciaDonacion = acreditacionHerenciaDonacion;
	}
	public String getAcreditacionSubastaJudicial() {
		return acreditacionSubastaJudicial;
	}
	public void setAcreditacionSubastaJudicial(String acreditacionSubastaJudicial) {
		this.acreditacionSubastaJudicial = acreditacionSubastaJudicial;
	}
	public boolean isDocumentoAcreditativoSubastaJudicial() {
		return documentoAcreditativoSubastaJudicial;
	}
	public void setDocumentoAcreditativoSubastaJudicial(boolean documentoAcreditativoSubastaJudicial) {
		this.documentoAcreditativoSubastaJudicial = documentoAcreditativoSubastaJudicial;
	}
}
