package org.gestoresmadrid.datos.sensibles.ws;
...
public class SoapDatosSensiblesWSHandler extends GenericWSHandler{
/* INICIO ATRIBUTOS/CONSTANTES */
	
	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapDatosSensiblesWSHandler.class);
	
	private final String PREF_NOMBRE_FICHERO_REQ = "DS_";
	private final String PREF_NOMBRE_FICHERO_RESP = "DS_";
	
	private final String SUF_NOMBRE_FICHERO_REQ = "_REQ";
	private final String SUF_NOMBRE_FICHERO_RESP = "_RESP";
	
	private final String TIPO_DOCUMENTO = ConstantesGestorFicheros.TIPO_DOC_DATOS_SENSIBLES;
	...
	/* CONSTRUCTOR */
	public SoapDatosSensiblesWSHandler() {
	...
	public String getNombreFicheroResponse() {
		...
		return componerNombreFichero(PREF_NOMBRE_FICHERO_RESP, bastidor, fechaFichero, SUF_NOMBRE_FICHERO_RESP);
	}
