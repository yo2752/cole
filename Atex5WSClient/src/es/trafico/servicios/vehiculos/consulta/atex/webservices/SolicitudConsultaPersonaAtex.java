 ...
 *         &lt;element ref="{http://webservices.atex.consulta.vehiculos.servicios.trafico.es}CriteriosConsultaPersona"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SolicitudConsultaPersonaAtex")
public class SolicitudConsultaPersonaAtex {
    ...
    @XmlElement(name = "CriteriosConsultaPersona", required = true)
