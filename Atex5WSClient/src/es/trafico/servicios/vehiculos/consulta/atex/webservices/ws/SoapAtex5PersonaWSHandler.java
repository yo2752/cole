...
public class SoapAtex5PersonaWSHandler extends GenericWSHandlerCXF {

	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapAtex5PersonaWSHandler.class);

	public static final String PROPERTY_KEY_ID = "numExpediente";

	private final String PREF_NOMBRE_FICHERO = "ATEX5_PERSONA_";
	...
	public SoapAtex5PersonaWSHandler() {
