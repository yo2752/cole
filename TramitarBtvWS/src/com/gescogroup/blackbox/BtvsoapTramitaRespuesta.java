...
public class BtvsoapTramitaRespuesta  implements java.io.Serializable {
   
	private static final long serialVersionUID = -5496279645954554673L;
    ...
    private com.gescogroup.blackbox.BtvCodigoDescripcion[] avisos;

    private com.gescogroup.blackbox.BtvCodigoDescripcion[] impedimentos;

    private com.gescogroup.blackbox.BtvCodigoDescripcion[] errores;
    ...
    public BtvsoapTramitaRespuesta() {
    }
    ...
    public BtvsoapTramitaRespuesta(
           ...
           com.gescogroup.blackbox.BtvCodigoDescripcion[] avisos,
           com.gescogroup.blackbox.BtvCodigoDescripcion[] impedimentos,
           com.gescogroup.blackbox.BtvCodigoDescripcion[] errores,
    ...
    /**
     * Gets the resultado_codigo value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Sets the resultado_codigo value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Gets the resultado_descripcion value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Sets the resultado_descripcion value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Gets the num_expediente_gestor value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Sets the num_expediente_gestor value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Gets the num_expediente value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Sets the num_expediente value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Gets the avisos value for this BtvsoapTramitaRespuesta.
     * 
     * @return avisos
     */
    public com.gescogroup.blackbox.BtvCodigoDescripcion[] getAvisos() {
        return avisos;
    }


    /**
     * Sets the avisos value for this BtvsoapTramitaRespuesta.
     * 
     * @param avisos
     */
    public void setAvisos(com.gescogroup.blackbox.BtvCodigoDescripcion[] avisos) {
        this.avisos = avisos;
    }


    /**
     * Gets the impedimentos value for this BtvsoapTramitaRespuesta.
     * 
     * @return impedimentos
     */
    public com.gescogroup.blackbox.BtvCodigoDescripcion[] getImpedimentos() {
        return impedimentos;
    }


    /**
     * Sets the impedimentos value for this BtvsoapTramitaRespuesta.
     * 
     * @param impedimentos
     */
    public void setImpedimentos(com.gescogroup.blackbox.BtvCodigoDescripcion[] impedimentos) {
        this.impedimentos = impedimentos;
    }


    /**
     * Gets the errores value for this BtvsoapTramitaRespuesta.
     * 
     * @return errores
     */
    public com.gescogroup.blackbox.BtvCodigoDescripcion[] getErrores() {
        return errores;
    }


    /**
     * Sets the errores value for this BtvsoapTramitaRespuesta.
     * 
     * @param errores
     */
    public void setErrores(com.gescogroup.blackbox.BtvCodigoDescripcion[] errores) {
        this.errores = errores;
    }


    /**
     * Gets the informe value for this BtvsoapTramitaRespuesta.
     * 
     * @return informe
     */
    ...
    /**
     * Sets the informe value for this BtvsoapTramitaRespuesta.
     * 
     * @param informe
     */
    ...
    /**
     * Gets the registro_entrada value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Sets the registro_entrada value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Gets the registro_salida value for this BtvsoapTramitaRespuesta.
     * 
    ...
    /**
     * Sets the registro_salida value for this BtvsoapTramitaRespuesta.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BtvsoapTramitaRespuesta)) return false;
        BtvsoapTramitaRespuesta other = (BtvsoapTramitaRespuesta) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BtvsoapTramitaRespuesta.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://blackbox.gescogroup.com/", "btvsoapTramitaRespuesta"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://blackbox.gescogroup.com/", "btvCodigoDescripcion"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
