...
@Entity
@Table(name="EVOLUCION_CONSULTA_DEV")
public class EvolucionConsultaDevVO implements Serializable{

	private static final long serialVersionUID = 4546488727058568491L;
	
	@EmbeddedId
	private EvolucionConsultaDevPK id;
	...
	public EvolucionConsultaDevPK getId() {
		return id;
	}

	public void setId(EvolucionConsultaDevPK id) {
		this.id = id;
	}
