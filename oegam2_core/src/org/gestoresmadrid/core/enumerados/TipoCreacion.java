...
public enum TipoCreacion {
	...
	public static String convertirTexto(String valorEnum) {
		...
		if (SinClasificar.valorEnum.equals(valorEnum))
			return SinClasificar.nombreEnum;
		else if (OEGAM.valorEnum.equals(valorEnum))
		...
		else if (TXT.valorEnum.equals(valorEnum))
			return TXT.nombreEnum;
		else if (JSON.valorEnum.equals(valorEnum))
			return JSON.nombreEnum;
		else if (EXCEL.valorEnum.equals(valorEnum))
			return EXCEL.nombreEnum;
		else
			return null;
	}
}