...
@Repository
public class TasaInteveDaoImpl extends GenericDaoImplHibernate<TasaInteveVO> implements TasaInteveDao {

	private static final long serialVersionUID = -118294495598330990L;
	...
	public List<TasaInteveVO> obtenerTasasInteveContrato(Long idContrato, String tipoTasa, int maxResult) {
		Criteria criteria = getCurrentSession().createCriteria(TasaInteveVO.class);
