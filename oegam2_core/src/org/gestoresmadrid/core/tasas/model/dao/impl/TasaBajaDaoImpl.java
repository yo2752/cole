...
@Repository
public class TasaBajaDaoImpl extends GenericDaoImplHibernate<TasaBajaVO> implements TasaBajaDao {

	private static final long serialVersionUID = -6699605539171455422L;
	...
	@Override
	public List<TasaBajaVO> obtenerTasasBajaContrato(Long idContrato, String tipoTasa, int maxResult) {
		Criteria criteria = getCurrentSession().createCriteria(TasaBajaVO.class);
