...
@Repository
public class TasaDuplicadoDaoImpl extends GenericDaoImplHibernate<TasaDuplicadoVO> implements TasaDuplicadoDao {

	private static final long serialVersionUID = 1014972217431901047L;
	...
	@Override
	public List<TasaDuplicadoVO> obtenerTasasDuplicadoContrato(Long idContrato, String tipoTasa, int maxResult) {
		Criteria criteria = getCurrentSession().createCriteria(TasaDuplicadoVO.class);
