...
@Repository
public class TasaPermInternDaoImpl extends GenericDaoImplHibernate<TasaPermInternVO> implements TasaPermInternDao {

	private static final long serialVersionUID = 1503702271969348885L;
	...
	@Override
	public List<TasaPermInternVO> obtenerTasasPermIntContrato(Long idContrato, String tipoTasa, int maxResult) {
		Criteria criteria = getCurrentSession().createCriteria(TasaPermInternVO.class);
