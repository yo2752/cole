...
public class GestorCorreoIncidenciaCanje {
	...
	private static GestorCorreoIncidenciaCanje instance = null;
	
	protected GestorCorreoIncidenciaCanje() {
		super();
	...
	public static GestorCorreoIncidenciaCanje getInstance() {
		if(instance == null) {
	    	instance = new GestorCorreoIncidenciaCanje();
	    }
		return instance;
	}
	...
	private Session getSession(){
		if (session == null) {
			...
			String mailSmtpUser =  mapaPropiedades.get("mail_usuario_incidencias_canje");
	        ...
	        String password = mapaPropiedades.get("mail_password_incidencias_canje");
	...
	public ResultBean enviarMail(CorreoRequest correo){
		...
		try {
			...
			mimeMessage.setFrom(new InternetAddress((correo.getFrom() != null && !correo.getFrom().trim().isEmpty())? correo.getFrom() :  mapaPropiedades.get("from_incCanje")));
