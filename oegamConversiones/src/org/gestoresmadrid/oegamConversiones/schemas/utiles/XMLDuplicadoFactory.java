...
@Component
public class XMLDuplicadoFactory implements Serializable {

	private static final long serialVersionUID = -501140903779341289L;

	private static final String NAME_CONTEXT = "org.gestoresmadrid.oegamConversiones.jaxb.duplicado";
	...
	/**
	 * Obtiene el objeto {@link FORMATOOEGAM2DUPLICADO} que contiene los datos del XML que recibe en el String
	...
	public FORMATOOEGAM2DUPLICADO getFormatoOegam2Duplicado(String xmlString) {
		FORMATOOEGAM2DUPLICADO formatoDuplicado = null;
		try {
			formatoDuplicado = (FORMATOOEGAM2DUPLICADO) fromXML(xmlString);
		} catch (Exception e) {
			log.error("Error obteniendo FORMATOGADuplicado, error: ", e);
		}
	 ...
	 * @return Devuelve un objeto {@link FORMATOOEGAM2DUPLICADO} que contiene los datos del XML recibido
	 */
	public FORMATOOEGAM2DUPLICADO getFormatoDuplicado(File fichero) {
		FORMATOOEGAM2DUPLICADO formatoDuplicado = null;
		try {
			formatoDuplicado = (FORMATOOEGAM2DUPLICADO) fromXML(fichero);
		} catch (Exception e) {
	...
	private Object fromXML(String xmlString) throws JAXBException {
		...
		try {
			...
			log.error("Error UNMARSHAL formatoOegam2Duplicado, error: ", e);
		}
		try {
			bais.close();
	 ...
	 * @throws SAXException
	 */
	public void validarXMLFORMATOGADuplicado(File fichero, String rutaEsquema) throws XmlNoValidoExcepcion, IOException {
		try {
