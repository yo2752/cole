...
@Component
public class XMLBajaFactory implements Serializable {

	private static final long serialVersionUID = -501140903779341289L;

	private static final String NAME_CONTEXT = "org.gestoresmadrid.oegamConversiones.jaxb.baja";
	...
	/**
	 * Obtiene el objeto {@link FORMATOOEGAM2BAJA} que contiene los datos del XML que recibe en el String
	...
	public FORMATOOEGAM2BAJA getFormatoOegam2Baja(String xmlString) {
		...
		try {
			...
			log.error("Error obteniendo formatoOegam2Baja, error: ", e);
		}
	...
	private Object fromXML(String xmlString) throws JAXBException {
		...
		try {
			...
			log.error("Error UNMARSHAL formatoOegam2Baja, error: ", e);
		}
		try {
			bais.close();
