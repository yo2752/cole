package org.gestoresmadrid.oegamConversiones.dozer.converter;
...
public class DozerFechaConverter extends DozerConverter<Fecha, Date> {
	...
	public Fecha convertFrom(Date source, Fecha destination) {
		...
		return ContextoSpring.getInstance().getBean(UtilesFecha.class).getFechaTimeStampConDate(source);
	}
