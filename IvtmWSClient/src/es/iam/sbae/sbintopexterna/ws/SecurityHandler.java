...
public class SecurityHandler implements Handler {
	...
	private static ILoggerOegam log = LoggerOegam.getLogger(SecurityHandler.class);
	...
	private SOAPEnvelope createFirma(org.apache.axis.MessageContext msgContext) {
		try {
			...
			byte[] firma = utilesViaFirma.firmarIvtm(soapEnvelope.getAsString().getBytes("UTF-8"), alias);
	...
	private void createBinaryToken(SOAPEnvelope soapEnvelope) throws SOAPException {
       ...
       // usernameToken.addAttribute(new QName("xmlns:wsu"), "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd");
        ...
        username.addTextNode("COGAM");

        SOAPElement password =
                usernameToken.addChildElement("Password", gestorPropiedades.valorPropertie("securityToken.pass"));
        password.setAttribute("Type", "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText");
    	password.addTextNode("consultaDeudaIVTM");
