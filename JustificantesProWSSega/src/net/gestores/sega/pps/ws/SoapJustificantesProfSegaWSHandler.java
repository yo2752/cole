...
public class SoapJustificantesProfSegaWSHandler extends GenericWSHandler{
	
private static final ILoggerOegam log = LoggerOegam.getLogger(SoapJustificantesProfSegaWSHandler.class);
	...
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.JUSTIF_PROFESIONAL_RESQ_RESP;
