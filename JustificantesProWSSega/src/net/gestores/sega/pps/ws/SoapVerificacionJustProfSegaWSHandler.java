package net.gestores.sega.pps.ws;
...
public class SoapVerificacionJustProfSegaWSHandler extends GenericWSHandler{
	
private static final ILoggerOegam log = LoggerOegam.getLogger(SoapVerificacionJustProfSegaWSHandler.class);
	...
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.VERIFICACION_JUSTIF_PROF_RESQ_RESP;
