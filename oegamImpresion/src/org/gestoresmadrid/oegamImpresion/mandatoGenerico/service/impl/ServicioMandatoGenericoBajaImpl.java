...
@Service
public class ServicioMandatoGenericoBajaImpl implements ServicioMandatoGenericoBaja {

	private static final long serialVersionUID = -4709763326604091060L;

	private static final ILoggerOegam log = LoggerOegam.getLogger(ServicioMandatoGenericoBajaImpl.class);
	...
	public ResultadoImpresionBean imprimirMandatoGenerico(List<BigDecimal> listaExpediente) {
		...
		try {
			...
			log.error("Ha sucedido un error a la hora de imprimir los mandatos genericos de Baja, error: ", e);
			resultado.setError(Boolean.TRUE);
			resultado.setMensaje("Ha sucedido un error a la hora de imprimir los mandatos genericos de Baja.");
		}
		return resultado;
	}
	...
	private void rellenarInterviniente(TramiteTrafBajaVO tramite, Set<String> camposPlantilla, ArrayList<CampoPdfBean> camposFormateados) {
