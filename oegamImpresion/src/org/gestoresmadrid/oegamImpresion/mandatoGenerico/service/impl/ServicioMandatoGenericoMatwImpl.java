...
@Service
public class ServicioMandatoGenericoMatwImpl implements ServicioMandatoGenericoMatw {

	private static final long serialVersionUID = -7690933435269309157L;

	private static final ILoggerOegam log = LoggerOegam.getLogger(ServicioMandatoGenericoMatwImpl.class);
	...
	public ResultadoImpresionBean imprimirMandatoGenerico(List<BigDecimal> listaExpediente) {
		...
		try {
			...
			log.error("Ha sucedido un error a la hora de imprimir los mandatos genericos de Matriculacion, error: ", e);
			resultado.setError(Boolean.TRUE);
			resultado.setMensaje("Ha sucedido un error a la hora de imprimir los mandatos genericos de Matriculacion.");
		}
		return resultado;
	}
