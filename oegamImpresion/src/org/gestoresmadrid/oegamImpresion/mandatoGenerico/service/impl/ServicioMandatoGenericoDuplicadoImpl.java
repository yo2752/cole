...
@Service
public class ServicioMandatoGenericoDuplicadoImpl implements ServicioMandatoGenericoDuplicado {

	private static final long serialVersionUID = -6299904925180584747L;

	private static final ILoggerOegam log = LoggerOegam.getLogger(ServicioMandatoGenericoDuplicadoImpl.class);
	...
	public ResultadoImpresionBean imprimirMandatoGenerico(List<BigDecimal> listaExpediente) {
		...
		try {
			...
			log.error("Ha sucedido un error a la hora de imprimir los mandatos genericos de Duplicado, error: ", e);
			resultado.setError(Boolean.TRUE);
			resultado.setMensaje("Ha sucedido un error a la hora de imprimir los mandatos genericos de Duplicado.");
		}
		return resultado;
	}
	...
	private void rellenarInterviniente(TramiteTrafDuplicadoVO tramite, Set<String> camposPlantilla, ArrayList<CampoPdfBean> camposFormateados) {
