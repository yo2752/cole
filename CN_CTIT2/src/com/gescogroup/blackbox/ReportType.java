...
public class ReportType implements java.io.Serializable {
    ...
    public static final ReportType REPORT = new ReportType(_REPORT);
    public static final ReportType STAT = new ReportType(_STAT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://blackbox.gescogroup.com/", "reportType"));
    }
    /**
