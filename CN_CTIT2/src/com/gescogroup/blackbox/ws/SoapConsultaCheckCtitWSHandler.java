...
public class SoapConsultaCheckCtitWSHandler  extends GenericWSHandler{

	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapConsultaCheckCtitWSHandler.class);
	
	public static final String PROPERTY_KEY_ID = "numExpediente";
	
	private final String PREF_NOMBRE_FICHERO = "CONSULTA_CHECKCTIT_";
	private final String SUF_NOMBRE_FICHERO_REQ = "_REQ";
	private final String SUF_NOMBRE_FICHERO_RESP = "_RESP";
	
	private final String TIPO_DOCUMENTO = ConstantesGestorFicheros.CHECKCTIT;
	private final String SUB_TIPO_DOCUMENTO_RESP = ConstantesGestorFicheros.RESPUESTA;
	private final String SUB_TIPO_DOCUMENTO_REQ = ConstantesGestorFicheros.ENVIO_REQ;
	
	private String numExpediente;

	
	
	public SoapConsultaCheckCtitWSHandler() {
	...
	public void init(HandlerInfo arg0) {
		...
		if(arg0.getHandlerConfig() != null){
			if(arg0.getHandlerConfig().get(PROPERTY_KEY_ID) != null){
				numExpediente =(String) arg0.getHandlerConfig().get(PROPERTY_KEY_ID);
			}
		}
	...
	public String getNombreFicheroRequest() {
		...
		sb.append(numExpediente.toString()).append(SUF_NOMBRE_FICHERO_REQ);
		return sb.toString();
	}
	...
	public String getNombreFicheroResponse() {
		StringBuilder sb = new StringBuilder(PREF_NOMBRE_FICHERO);
		sb.append(numExpediente.toString()).append(SUF_NOMBRE_FICHERO_RESP);
		return sb.toString();
	}
