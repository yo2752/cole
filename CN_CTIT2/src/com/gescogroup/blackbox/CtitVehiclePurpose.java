...
public class CtitVehiclePurpose implements java.io.Serializable {
    ...
    public static final CtitVehiclePurpose B03 = new CtitVehiclePurpose(_B03);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://blackbox.gescogroup.com/", "ctitVehiclePurpose"));
    }
    /**
