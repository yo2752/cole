...
public class Region  extends com.gescogroup.blackbox.AbstractEntity  implements java.io.Serializable {
    private com.gescogroup.blackbox.MlString description;

    private com.gescogroup.blackbox.Province[] provinces;
    ...
    public Region(
           ...
           com.gescogroup.blackbox.Province[] provinces) {
        super(
            createdOn,
            deletedOn,
            id,
     ...
     * @return provinces
     */
    public com.gescogroup.blackbox.Province[] getProvinces() {
        return provinces;
    }
     ...
     * @param provinces
     */
    public void setProvinces(com.gescogroup.blackbox.Province[] provinces) {
        this.provinces = provinces;
    }

    public com.gescogroup.blackbox.Province getProvinces(int i) {
        return this.provinces[i];
    }

    public void setProvinces(int i, com.gescogroup.blackbox.Province _value) {
