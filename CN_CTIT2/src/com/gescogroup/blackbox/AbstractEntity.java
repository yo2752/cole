...
public abstract class AbstractEntity  implements java.io.Serializable {
    ...
    private com.gescogroup.blackbox.UserLabel[] userLabels;
     ...
     * @return userLabels
     */
    public com.gescogroup.blackbox.UserLabel[] getUserLabels() {
        return userLabels;
    }
     ...
     * @param userLabels
     */
    public void setUserLabels(com.gescogroup.blackbox.UserLabel[] userLabels) {
        this.userLabels = userLabels;
    }

    public com.gescogroup.blackbox.UserLabel getUserLabels(int i) {
        return this.userLabels[i];
    }

    public void setUserLabels(int i, com.gescogroup.blackbox.UserLabel _value) {
