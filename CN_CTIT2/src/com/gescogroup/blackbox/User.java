...
public class User  extends com.gescogroup.blackbox.AbstractEntity  implements java.io.Serializable {
    ...
    private com.gescogroup.blackbox.UserProfile[] userProfiles;

    private com.gescogroup.blackbox.UserRPTProfile[] userRptProfiles;
     ...
     * @return userProfiles
     */
    public com.gescogroup.blackbox.UserProfile[] getUserProfiles() {
        return userProfiles;
    }
     ...
     * @param userProfiles
     */
    public void setUserProfiles(com.gescogroup.blackbox.UserProfile[] userProfiles) {
        this.userProfiles = userProfiles;
    }

    public com.gescogroup.blackbox.UserProfile getUserProfiles(int i) {
        return this.userProfiles[i];
    }

    public void setUserProfiles(int i, com.gescogroup.blackbox.UserProfile _value) {
     ...
     */
    public com.gescogroup.blackbox.UserRPTProfile[] getUserRptProfiles() {
        return userRptProfiles;
    }
     ...
     */
    public void setUserRptProfiles(com.gescogroup.blackbox.UserRPTProfile[] userRptProfiles) {
        this.userRptProfiles = userRptProfiles;
    }

    public com.gescogroup.blackbox.UserRPTProfile getUserRptProfiles(int i) {
        return this.userRptProfiles[i];
    }

    public void setUserRptProfiles(int i, com.gescogroup.blackbox.UserRPTProfile _value) {
