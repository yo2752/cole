...
public interface GuardarDocumentosService {

	/**
	 * Guarda un documento, se debe de rellenar el tipo de fichero con el tipo Byte no el array de File. Como tipo de documento usar la constante.
	 * @param fichero
	 */
	...
	/**
	 * Busqueda de archivo por nombre. Si no vienen subtipo buscara por todos todo el directorio de carpetas. Si viene el expediente buscará por año, mes, para afinar mas la busqueda.
	...
	/**
	 * Empaqueta una lista de ficheros, en concreto fichas tecnicas, enviando los ficheros como File y guardándolos en carpeta en función del año/mes del numero de expediente
	 * @param fichero
	 * @return
	 * @throws IOException
	 * @throws OegamExcepcion
	...
	/**
	 * Crea un fichero en el directorio que se envia en tipo sub tipo con la historificación. Se envia un lista de String
	...
	public FileResultBean buscarFicheroPorNombreTipoAM(String mate, String subTipoJust, Fecha fechaConDate,
			String fichero, String extensionPdf) throws OegamExcepcion;
}
