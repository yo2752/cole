...
public class SoapMatwImpresionPersmisoDistintivoWSHandler extends GenericWSHandler{
	
	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapMatwImpresionPersmisoDistintivoWSHandler.class);
	
	public static final String PROPERTY_KEY_ID = "numExpediente";
	
	private final String PREF_NOMBRE_FICHERO = "MATW_PERM_DST_";
	...
	public SoapMatwImpresionPersmisoDistintivoWSHandler() {
		super();
