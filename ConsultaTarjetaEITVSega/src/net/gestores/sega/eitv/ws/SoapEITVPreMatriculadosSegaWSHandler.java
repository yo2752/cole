...
public class SoapEITVPreMatriculadosSegaWSHandler extends GenericWSHandler{
	
private static final ILoggerOegam log = LoggerOegam.getLogger(SoapEITVPreMatriculadosSegaWSHandler.class);
	...
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.EITV_PREMATRICULADO_RESQ_RESP;
