...
/**
 * PROCEDURE DATOS_CARDMATE (P_NUM_EXPEDIENTE IN OUT TRAMITE_TRAFICO.NUM_EXPEDIENTE%TYPE,
                       -- Datos del tramite de matriculación
                       P_HAS_FORM_576    OUT VARCHAR2,
                       P_HAS_FORM_05     OUT VARCHAR2,
                       P_HAS_FORM_06     OUT VARCHAR2,
                       P_FORM_05_KEY     OUT TRAMITE_TRAF_MATR.ID_REDUCCION_05%TYPE,
                       P_FORM_06_KEY     OUT TRAMITE_TRAF_MATR.ID_NO_SUJECCION_06%TYPE,
                       --  Datos del vehículo
                       P_VEHICLE_SERIAL OUT VEHICULO.BASTIDOR%TYPE,
                       P_ITV_CARD_TYPE   OUT VEHICULO.ID_TIPO_TARJETA_ITV%TYPE,
                       -- MATW : Nif del gestor que tramita el expediente:
                       P_AGENT_FISCAL_ID OUT USUARIO.NIF%TYPE,
                       P_EXTERNAL_SYSTEM_FISCAL_ID OUT COLEGIO.CIF%TYPE,
                       P_SERIAL_CARD_ITV  OUT VEHICULO.N_SERIE%TYPE,
                       P_CODE OUT NUMBER,
                       P_SQLERRM OUT VARCHAR2);
 */

@SuppressWarnings("serial")
public class MatwRequest  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MatwRequest)) return false;
        MatwRequest other = (MatwRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MatwRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://blackbox.gescogroup.com", "matwRequest"));
