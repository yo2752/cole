...
public class SolicitudMatw  implements java.io.Serializable {
    private matw.beans.InformacionRegistro infoReg;

    private matw.beans.SolicitudMatwVersion version;  // attribute

    public SolicitudMatw() {
    }

    public SolicitudMatw(
           matw.beans.InformacionRegistro infoReg,
           matw.beans.SolicitudMatwVersion version) {
     ...
     * @return infoReg
     */
    public matw.beans.InformacionRegistro getInfoReg() {
        return infoReg;
    }
     ...
     * @param infoReg
     */
    public void setInfoReg(matw.beans.InformacionRegistro infoReg) {
        this.infoReg = infoReg;
    }
     ...
     * @return version
     */
    public matw.beans.SolicitudMatwVersion getVersion() {
        return version;
    }
     ...
     * @param version
     */
    public void setVersion(matw.beans.SolicitudMatwVersion version) {
        this.version = version;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SolicitudMatw)) return false;
        SolicitudMatw other = (SolicitudMatw) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SolicitudMatw.class, true);
