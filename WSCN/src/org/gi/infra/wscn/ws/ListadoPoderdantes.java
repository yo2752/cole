...
public class ListadoPoderdantes  implements java.io.Serializable {
    ...
    private org.gi.infra.wscn.ws.Poderdante[] poderdantes;
    ...
    public ListadoPoderdantes(
           ...
           org.gi.infra.wscn.ws.Poderdante[] poderdantes,
     ...
     * @return poderdantes
     */
    public org.gi.infra.wscn.ws.Poderdante[] getPoderdantes() {
        return poderdantes;
    }
     ...
     * @param poderdantes
     */
    public void setPoderdantes(org.gi.infra.wscn.ws.Poderdante[] poderdantes) {
        this.poderdantes = poderdantes;
    }

    public org.gi.infra.wscn.ws.Poderdante getPoderdantes(int i) {
        return this.poderdantes[i];
    }

    public void setPoderdantes(int i, org.gi.infra.wscn.ws.Poderdante _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.wscn.infra.gi.org/", "listadoPoderdantes"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "poderdantes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.wscn.infra.gi.org/", "poderdante"));
        elemField.setMinOccurs(0);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "tienePoderdantes"));
