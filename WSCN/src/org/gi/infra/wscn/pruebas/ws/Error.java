...
public class Error  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2134223983420895657L;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.pruebas.wscn.infra.gi.org/", "error"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ws.pruebas.wscn.infra.gi.org/", "descripcion"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ws.pruebas.wscn.infra.gi.org/", "identificadorPeticion"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
