...
public class ClientHandler extends BasicHandler {
	...
	public void invoke(MessageContext msgContext) throws AxisFault {
		...
		try {
			((SOAPPart) msgContext.getRequestMessage().getSOAPPart())
					.setCurrentMessage(this.createBinarySecurityToken(msgContext), SOAPPart.FORM_SOAPENVELOPE);
		} catch (Exception e) {
	...
	/**
	 * Securiza, mediante el tag BinarySecurityToken y firma una petición SOAP no
	 * securizada.
	 *
	 * @param soapEnvelopeRequest Documento xml que representa la petición SOAP sin
	 *                            securizar.
