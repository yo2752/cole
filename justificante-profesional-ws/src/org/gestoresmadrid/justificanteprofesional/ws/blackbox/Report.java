...
public class Report  extends org.gestoresmadrid.justificanteprofesional.ws.blackbox.AbstractEntity  implements java.io.Serializable {
    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.MlString description;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptDetails details;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptGroup group;

    private java.lang.String name;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.ReportType reportType;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile[] rptProfiles;
    ...
    public Report(
           ...
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptDetails details,
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptGroup group,
           java.lang.String name,
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.ReportType reportType,
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile[] rptProfiles) {
        super(
            createdOn,
            deletedOn,
            id,
     ...
     * @return details
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptDetails getDetails() {
        return details;
    }
     ...
     * @param details
     */
    public void setDetails(org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptDetails details) {
        this.details = details;
    }
     ...
     * @return group
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptGroup getGroup() {
        return group;
    }
     ...
     * @param group
     */
    public void setGroup(org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptGroup group) {
        this.group = group;
    }
     ...
     * @return reportType
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.ReportType getReportType() {
        return reportType;
    }
     ...
     * @param reportType
     */
    public void setReportType(org.gestoresmadrid.justificanteprofesional.ws.blackbox.ReportType reportType) {
        this.reportType = reportType;
    }
     ...
     * @return rptProfiles
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile[] getRptProfiles() {
        return rptProfiles;
    }
     ...
     * @param rptProfiles
     */
    public void setRptProfiles(org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile[] rptProfiles) {
        this.rptProfiles = rptProfiles;
    }

    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile getRptProfiles(int i) {
        return this.rptProfiles[i];
    }

    public void setRptProfiles(int i, org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile _value) {
