...
public class Profile  extends org.gestoresmadrid.justificanteprofesional.ws.blackbox.AbstractEntity  implements java.io.Serializable {
    private java.lang.String description;

    private java.lang.String name;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.ServicePermission[] servicePermissions;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.UiPermission[] uiPermissions;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.UserProfile[] userProfiles;
    ...
    public Profile(
           ...
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.ServicePermission[] servicePermissions,
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.UiPermission[] uiPermissions,
     ...
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.ServicePermission[] getServicePermissions() {
        return servicePermissions;
    }
     ...
     */
    public void setServicePermissions(org.gestoresmadrid.justificanteprofesional.ws.blackbox.ServicePermission[] servicePermissions) {
        this.servicePermissions = servicePermissions;
    }

    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.ServicePermission getServicePermissions(int i) {
        return this.servicePermissions[i];
    }

    public void setServicePermissions(int i, org.gestoresmadrid.justificanteprofesional.ws.blackbox.ServicePermission _value) {
     ...
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.UiPermission[] getUiPermissions() {
        return uiPermissions;
    }
     ...
     * @param uiPermissions
     */
    public void setUiPermissions(org.gestoresmadrid.justificanteprofesional.ws.blackbox.UiPermission[] uiPermissions) {
        this.uiPermissions = uiPermissions;
    }

    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.UiPermission getUiPermissions(int i) {
        return this.uiPermissions[i];
    }

    public void setUiPermissions(int i, org.gestoresmadrid.justificanteprofesional.ws.blackbox.UiPermission _value) {
     ...
     * @return userProfiles
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.UserProfile[] getUserProfiles() {
        return userProfiles;
    }
     ...
     * @param userProfiles
     */
    public void setUserProfiles(org.gestoresmadrid.justificanteprofesional.ws.blackbox.UserProfile[] userProfiles) {
        this.userProfiles = userProfiles;
    }

    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.UserProfile getUserProfiles(int i) {
        return this.userProfiles[i];
    }

    public void setUserProfiles(int i, org.gestoresmadrid.justificanteprofesional.ws.blackbox.UserProfile _value) {
