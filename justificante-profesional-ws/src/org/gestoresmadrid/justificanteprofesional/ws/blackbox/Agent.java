...
public class Agent  extends org.gestoresmadrid.justificanteprofesional.ws.blackbox.User  implements java.io.Serializable {
    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.Agency[] agencies;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.AgentCertificate agentCertificate;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.BranchOffice branchOffice;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.Address fiscalAddress;
    ...
    public Agent(
           ...
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.Agency[] agencies,
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.AgentCertificate agentCertificate,
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.BranchOffice branchOffice,
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.Address fiscalAddress,
           int memberId) {
        super(
            createdOn,
            deletedOn,
     ...
     * @return agencies
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.Agency[] getAgencies() {
        return agencies;
    }
     ...
     * @param agencies
     */
    public void setAgencies(org.gestoresmadrid.justificanteprofesional.ws.blackbox.Agency[] agencies) {
        this.agencies = agencies;
    }

    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.Agency getAgencies(int i) {
        return this.agencies[i];
    }

    public void setAgencies(int i, org.gestoresmadrid.justificanteprofesional.ws.blackbox.Agency _value) {
     ...
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.AgentCertificate getAgentCertificate() {
        return agentCertificate;
    }
     ...
     */
    public void setAgentCertificate(org.gestoresmadrid.justificanteprofesional.ws.blackbox.AgentCertificate agentCertificate) {
        this.agentCertificate = agentCertificate;
    }
     ...
     * @return branchOffice
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.BranchOffice getBranchOffice() {
        return branchOffice;
    }
     ...
     * @param branchOffice
     */
    public void setBranchOffice(org.gestoresmadrid.justificanteprofesional.ws.blackbox.BranchOffice branchOffice) {
        this.branchOffice = branchOffice;
    }
     ...
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.Address getFiscalAddress() {
        return fiscalAddress;
    }
     ...
     * @param fiscalAddress
     */
    public void setFiscalAddress(org.gestoresmadrid.justificanteprofesional.ws.blackbox.Address fiscalAddress) {
        this.fiscalAddress = fiscalAddress;
    }
