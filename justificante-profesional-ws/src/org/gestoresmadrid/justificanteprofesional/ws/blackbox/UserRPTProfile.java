...
public class UserRPTProfile  extends org.gestoresmadrid.justificanteprofesional.ws.blackbox.AbstractEntity  implements java.io.Serializable {
    private java.lang.Boolean admin;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile rptProfile;

    private org.gestoresmadrid.justificanteprofesional.ws.blackbox.User user;
    ...
    public UserRPTProfile(
           ...
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile rptProfile,
           org.gestoresmadrid.justificanteprofesional.ws.blackbox.User user) {
        super(
            createdOn,
            deletedOn,
            id,
     ...
     * @return rptProfile
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile getRptProfile() {
        return rptProfile;
    }
     ...
     * @param rptProfile
     */
    public void setRptProfile(org.gestoresmadrid.justificanteprofesional.ws.blackbox.RptProfile rptProfile) {
        this.rptProfile = rptProfile;
    }
     ...
     * @return user
     */
    public org.gestoresmadrid.justificanteprofesional.ws.blackbox.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(org.gestoresmadrid.justificanteprofesional.ws.blackbox.User user) {
        this.user = user;
    }
