...
public class FileHandlerModificacionIvtm extends GenericWSHandlerCXF{

	private static final ILoggerOegam log = LoggerOegam.getLogger(FileHandlerModificacionIvtm.class);

	public static final String PROPERTY_KEY_ID = "numExpediente";

	private static final String PREF_NOMBRE_FICHERO = "IVTM_MODIFICACION_";
	private static final String SUF_NOMBRE_FICHERO_REQ = "_REQ";
	private static final String SUF_NOMBRE_FICHERO_RESP = "_RESP";

	private static final String TIPO_DOCUMENTO = ConstantesGestorFicheros.IVTM;
	private static final String SUB_TIPO_DOCUMENTO_REQ = ConstantesGestorFicheros.IVTM_MODIFICACION_ENVIO;
	private static final String SUB_TIPO_DOCUMENTO_RESP = ConstantesGestorFicheros.IVTM_MODIFICACION_RESPUESTA;
	private String fecha;

	@Autowired
	private UtilesFecha utilesFecha;

	public FileHandlerModificacionIvtm(){
