...
public class SecurityClientHandlerEEFFNuevo implements Handler {

	private static final ILoggerOegam log = LoggerOegam.getLogger(SecurityClientHandlerEEFFNuevo.class);
