...
public class AltaConductorHandler extends GenericWSHandlerCAYC{

	private static final ILoggerOegam log = LoggerOegam.getLogger(AltaConductorHandler.class);
	public static final String PROPERTY_KEY_ID = "numExpediente";
	private final String PREF_NOMBRE_FICHERO = "ENVIO_ALTA_CONDUCTOR_HABITUAL_";
	private final String SUF_NOMBRE_FICHERO_REQ = "_REQ";
	private final String SUF_NOMBRE_FICHERO_RESP = "_RESP";
	private final String SUB_TIPO_DOCUMENTO_REQ = ConstantesGestorFicheros.ENVIO_ALTA_CONDUCTOR_HABITUAL;
	private final String SUB_TIPO_DOCUMENTO_RESP = ConstantesGestorFicheros.RESPUESTA_ALTA_CONDUCTOR_HABITUAL;
