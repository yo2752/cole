...
public class ModiConductorHandler extends GenericWSHandlerCAYC {

	private static final ILoggerOegam log = LoggerOegam.getLogger(ModiConductorHandler.class);

	public static final String PROPERTY_KEY_ID = "numExpediente";

	private final String PREF_NOMBRE_FICHERO = "ENVIO_MOD_CONDUCTOR_HABITUAL_";
	...
	private final String SUB_TIPO_DOCUMENTO_REQ = ConstantesGestorFicheros.ENVIO_MOD_CONDUCTOR_HABITUAL;
	private final String SUB_TIPO_DOCUMENTO_RESP = ConstantesGestorFicheros.ENVIO_MOD_CONDUCTOR_HABITUAL;
