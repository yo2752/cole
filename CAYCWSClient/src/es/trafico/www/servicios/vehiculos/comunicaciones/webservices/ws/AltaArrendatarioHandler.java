...
public class AltaArrendatarioHandler extends GenericWSHandlerCAYC {

	private static final ILoggerOegam log					= LoggerOegam.getLogger(AltaArrendatarioHandler.class);

	private final String			SUB_TIPO_DOCUMENTO_RESP	= ConstantesGestorFicheros.ENVIO_ALTA_ARRENDATARIO;
	private final String			SUB_TIPO_DOCUMENTO_REQ	= ConstantesGestorFicheros.ENVIO_ALTA_ARRENDATARIO;

	public static final String		PROPERTY_KEY_ID			= "numExpediente";
	private static final String		PREF_NOMBRE_FICHERO		= "ALTA_ARRENDATARIO_";
	private static final String		SUF_NOMBRE_FICHERO_REQ	= "_REQ";
	private static final String		SUF_NOMBRE_FICHERO_RESP	= "_RESP";
	private static final String		TIPO_DOCUMENTO			= ConstantesGestorFicheros.CAYC;
