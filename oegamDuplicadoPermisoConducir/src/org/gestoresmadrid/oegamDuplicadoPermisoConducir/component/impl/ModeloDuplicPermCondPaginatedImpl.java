...
@Service(value = "modeloDuplicPermCondPaginated")
@Transactional(readOnly = true)
public class ModeloDuplicPermCondPaginatedImpl extends AbstractModelPagination {
	...
	protected GenericDao<?> getDao() {
		return duplicadoPermisoConducirDao;
	}
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<ConsultaDuplicadoPermConducirBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaDuplPermCond.convertirListaEnBeanPantallaConsulta((List<DuplicadoPermisoConducirVO>) list);
