...
public class UserLabel  extends com.gescogroup.blackbox.AbstractEntity  implements java.io.Serializable {
    ...
    private com.gescogroup.blackbox.User owner;

    private boolean shared;

    private com.gescogroup.blackbox.User[] users;
    ...
    public UserLabel(
           ...
           com.gescogroup.blackbox.User owner,
           boolean shared,
           com.gescogroup.blackbox.User[] users) {
        super(
            createdOn,
            deletedOn,
            id,
     ...
     * @return owner
     */
    public com.gescogroup.blackbox.User getOwner() {
        return owner;
    }
     ...
     * @param owner
     */
    public void setOwner(com.gescogroup.blackbox.User owner) {
        this.owner = owner;
    }
     ...
     * @return users
     */
    public com.gescogroup.blackbox.User[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(com.gescogroup.blackbox.User[] users) {
        this.users = users;
    }

    public com.gescogroup.blackbox.User getUsers(int i) {
        return this.users[i];
    }

    public void setUsers(int i, com.gescogroup.blackbox.User _value) {
        this.users[i] = _value;
    }
