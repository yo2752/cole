package net.gestores.sega.matw.ws;
...
public class SoapMatwSegaWSHandler extends GenericWSHandler{
	
	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapMatwSegaWSHandler.class);
	...
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.MATE_ENVIO_RESQ_RESP;
