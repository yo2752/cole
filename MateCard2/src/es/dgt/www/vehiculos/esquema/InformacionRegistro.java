...
public class InformacionRegistro  implements java.io.Serializable {
    ...
    private es.dgt.www.vehiculos.esquema.Documento[] documentos;
    ...
    public InformacionRegistro(
           ...
           es.dgt.www.vehiculos.esquema.Documento[] documentos) {
     ...
     * @return documentos
     */
    public es.dgt.www.vehiculos.esquema.Documento[] getDocumentos() {
        return documentos;
    }
     ...
     * @param documentos
     */
    public void setDocumentos(es.dgt.www.vehiculos.esquema.Documento[] documentos) {
        this.documentos = documentos;
    }
