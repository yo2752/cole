...
public class User  extends com.gescogroup.blackbox.AbstractEntity  implements java.io.Serializable {
    ...
    private com.gescogroup.blackbox.Profile[] profiles;
    ...
    /**
     * Gets the profiles value for this User.
     * 
     * @return profiles
     */
    public com.gescogroup.blackbox.Profile[] getProfiles() {
        return profiles;
    }


    /**
     * Sets the profiles value for this User.
     * 
     * @param profiles
     */
    public void setProfiles(com.gescogroup.blackbox.Profile[] profiles) {
        this.profiles = profiles;
    }

    public com.gescogroup.blackbox.Profile getProfiles(int i) {
        return this.profiles[i];
    }

    public void setProfiles(int i, com.gescogroup.blackbox.Profile _value) {
