...
import trafico.beans.jaxb.matw.TipoEstadoCivil;

public enum EstadoCivilMatw {
	...
	private EstadoCivilMatw(String valorEnum, String nombreEnum) {
	...
	// valueOf
	public static EstadoCivilMatw convertir(String valorEnum) {
