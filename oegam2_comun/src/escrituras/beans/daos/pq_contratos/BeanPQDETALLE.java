...
ejecutarProc(this,SCHEMA,ValoresCatalog.PQ_CONTRATOS,PROCEDURE,null,true);
	...
	private String P_TIPO_CONTRATO;
	...
	public String getP_TIPO_CONTRATO(){
		return P_TIPO_CONTRATO;}
 
	public void setP_TIPO_CONTRATO(String P_TIPO_CONTRATO){
	...
	public void setP_ALIAS(String pALIAS) {
		P_ALIAS = pALIAS;
	}
	...
	public Object getC_APLICACIONES(){
		return C_APLICACIONES;}
 
	public void setC_APLICACIONES(Object C_APLICACIONES){
		this.C_APLICACIONES=C_APLICACIONES;}
