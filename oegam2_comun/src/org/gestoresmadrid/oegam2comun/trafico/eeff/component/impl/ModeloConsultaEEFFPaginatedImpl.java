package org.gestoresmadrid.oegam2comun.trafico.eeff.component.impl;
...
@Service(value="modeloConsultaEEFFPaginated")
@Transactional(readOnly=true)
public class ModeloConsultaEEFFPaginatedImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<ConsultaEEFFBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if(list != null && !list.isEmpty()){
				lista = servicioConsultaEEFF.convertirListaEnBeanPantalla((List<ConsultaEEFFVO>) list); 
