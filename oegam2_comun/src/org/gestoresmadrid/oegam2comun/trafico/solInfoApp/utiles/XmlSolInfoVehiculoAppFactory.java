...
import org.gestoresmadrid.oegam2comun.trafico.solInfoVehiculoApp.view.xml.SolicitudInformacionVehiculos;
import org.xml.sax.SAXException;

public class XmlSolInfoVehiculoAppFactory {

	private static final String XML_ENCODING = "UTF-8";
	public static final String NAME_CONTEXT = "org.gestoresmadrid.oegam2comun.trafico.solInfoVehiculoApp.view.xml";
	private final static String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String SOLICITUDES_INFORMACION_VEHICULOS_XSD = "org/gestoresmadrid/oegam2/trafico/solInfoApp/schemas/Solicitud_Info_Vehiculo.xsd";
	...
	private static Logger log = Logger.getLogger(XmlSolInfoVehiculoAppFactory.class);
	...
	private URL getEsquemaURL() {
		if (esquemaURL == null){
			esquemaURL = XmlSolInfoVehiculoAppFactory.class.getResource(SOLICITUDES_INFORMACION_VEHICULOS_XSD);
		}
		return esquemaURL; 
	}
	...
	/**
	 * M�todo que genera el String con el formato XML que contiene los datos del objeto {@link SolicitudInformacionVehiculos} que 
	 * recibe como par�metro.
	 * 
	 * @param SolicitudInformacionVehiculos Objeto {@link SolicitudInformacionVehiculos} que contiene los datos que se quieren pasar a XML
	 * @return Devuelve el String que contiene el XML
	 */
	public String toXML(SolicitudInformacionVehiculos solicitudInformacionVehiculos) {
		String xmlString = null;
		try {
			xmlString = toXML((Object)solicitudInformacionVehiculos);
		} catch(Exception e) {
			log.error("Error al generar XML del objeto SolicitudInformacionVehiculos");
			log.error(e);
		}
		return xmlString;
	}
