...
@Service(value="modeloGestionPedidosPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloGestionPedidosPaginatedImpl extends AbstractModelPagination {

	@Resource
	private PedidoDao pedidoDao;

	@Autowired
	private ServicioConsultaPedidos servicioConsultaPedidos;
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<PedidosResultadosBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaPedidos.convertirListaEnBeanPantalla((List<PedidoVO>) list);
