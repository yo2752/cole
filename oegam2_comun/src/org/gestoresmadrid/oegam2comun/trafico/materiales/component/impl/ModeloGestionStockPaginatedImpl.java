...
@Service(value="modeloGestionStockPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloGestionStockPaginatedImpl extends AbstractModelPagination {

	@Resource private MaterialStockDao materialStockDao;
	@Autowired private ServicioConsultaStock servicioConsultaStock;
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<StockResultadosBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaStock.convertirListaEnBeanPantalla((List<MaterialStockVO>) list);
