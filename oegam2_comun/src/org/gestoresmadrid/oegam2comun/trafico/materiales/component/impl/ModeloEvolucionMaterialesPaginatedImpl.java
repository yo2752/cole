...
@Service(value="modeloEvolucionMaterialesPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloEvolucionMaterialesPaginatedImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<EvolucionMaterialesResultadosBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaEvolucionMateriales.convertirListaEnBeanPantalla((List<EvolucionMaterialVO>) list);
