...
@Service(value="modeloEvolucionPedidoPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloEvolucionPedidoPaginatedImpl extends AbstractModelPagination {

	@Resource EvolucionPedidoDao evolucionPedidoDao;

	@Autowired ServicioConsultaEvolucionPedido servicioConsultaEvolucionPedido;
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<EvolucionPedidoResultadosBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaEvolucionPedido.convertirListaEnBeanPantalla((List<EvolucionPedidoVO>) list);
