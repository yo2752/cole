...
@Service(value="modeloGestionIncidenciasPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloGestionIncidenciasPaginatedImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<IncidenciasResultadosBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaIncidencias.convertirListaEnBeanPantalla((List<IncidenciaVO>) list);
