...
@Service(value="modeloGestionMaterialesPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloGestionMaterialesPaginatedImpl extends AbstractModelPagination {

	@Resource
	private MaterialDao materialDao;

	@Autowired
	private ServicioConsultaMateriales servicioConsultaMateriales;
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<MaterialesResultadosBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaMateriales.convertirListaEnBeanPantalla((List<MaterialVO>) list);
