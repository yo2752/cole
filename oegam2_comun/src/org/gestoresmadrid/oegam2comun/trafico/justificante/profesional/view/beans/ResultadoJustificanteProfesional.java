...
public class ResultadoJustificanteProfesional implements Serializable{
	...
	public ResultadoJustificanteProfesional(boolean error) {
		super();
		this.error = error;
	}

	public ResultadoJustificanteProfesional(Exception excepcion) {
		super();
		this.excepcion = excepcion;
		this.error = false;
	}
	
	public ResultadoJustificanteProfesional(boolean error, String mensajeError) {
		super();
		this.error = error;
