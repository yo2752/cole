...
@Component
public class BuildXmlMatwPermisoDistintivoItv implements Serializable{

	private static final long serialVersionUID = -902923795498138368L;

	private static final ILoggerOegam log = LoggerOegam.getLogger(BuildXmlMatwPermisoDistintivoItv.class);
	...
	public ResultadoPermisoDistintivoItvBean validarXml(SolicitudImpresionDocumentos solicitudImpresionDocumentos) {
	...
	public ResultadoPermisoDistintivoItvBean firmarXml(SolicitudImpresionDocumentos solicitudImpresionDocumentos) throws UnsupportedEncodingException {
		ResultadoPermisoDistintivoItvBean resultado = new ResultadoPermisoDistintivoItvBean(Boolean.FALSE);
		XmlPermisoDistintivoItvFactory xmlFactory = new XmlPermisoDistintivoItvFactory();
	...
	private DatosEspecificos createDatosEspecificos(TramiteTrafMatrVO tramiteTrafMatr, ObjectFactory objectFactory) throws ParseException {
		...
		if(tramiteTrafMatr.getVehiculo().getFechaMatriculacion() != null){
