package org.gestoresmadrid.oegam2comun.modelo600_601.component.impl;
...
@Service(value="modeloModelosPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloModelosPaginatedImpl extends AbstractModelPagination{
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<Modelo600_601Bean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if(list != null && !list.isEmpty()){
				lista = servicioModelo600_601.convertirListaEnBeanPantalla((List<Modelo600_601VO>) list); 
