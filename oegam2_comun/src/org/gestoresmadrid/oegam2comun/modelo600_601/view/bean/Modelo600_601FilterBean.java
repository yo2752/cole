...
public class Modelo600_601FilterBean implements Serializable{
	
	private static final long serialVersionUID = -4052832838411704184L;
	...
	@FilterSimpleExpression(name="numExpediente")
	@FilterRelationship(name="remesa", joinType = Criteria.LEFT_JOIN)
	private BigDecimal numExpRemesa;
	...
	public void setCodigoNotario(String codNotario) {
		this.codigoNotario = codNotario;
	}

	public BigDecimal getNumExpRemesa() {
		return numExpRemesa;
	}

	public void setNumExpRemesa(BigDecimal numExpRemesa) {
		this.numExpRemesa = numExpRemesa;
	}
