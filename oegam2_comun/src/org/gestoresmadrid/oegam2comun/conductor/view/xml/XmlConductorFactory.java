...
public class XmlConductorFactory {

	private static final String XML_ENCODING = "UTF-8";
	public static final String NAME_CONTEXT = "org.gestoresmadrid.oegam2comun.conductor.view.xml";
	private final static String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String TRAFICO_SCHEMAS_INTERFAZ_Conductor_XSD = "/org/gestoresmadrid/oegam2/conductor/schemas/solicitud_registro_entrada_CondHabitual.xsd";
	...
	private ILoggerOegam log = LoggerOegam.getLogger(XmlConductorFactory.class);
	...
	private URL getEsquemaURL() {
		if (esquemaURL == null){
			esquemaURL = XmlConductorFactory.class.getResource(TRAFICO_SCHEMAS_INTERFAZ_Conductor_XSD);
		}
		return esquemaURL; 
	}
	 ...
	 */
	public void validarXMLConductor(File fichero) throws OegamExcepcion {
		Validator validator;
		String mensaje, snif;
		int pos;
		try {
