...
public class ConsultaConductorBean {
	...
	private String consentimientotxt;
	...
	public String getConsentimientotxt() {
		return consentimientotxt;
	}

	public void setConsentimientotxt(String consentimientotxt) {
		this.consentimientotxt = consentimientotxt;
	}
