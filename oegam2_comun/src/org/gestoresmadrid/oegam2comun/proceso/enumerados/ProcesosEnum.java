package org.gestoresmadrid.oegam2comun.proceso.enumerados;

public enum ProcesosEnum {

	// Mantis 18007. David Sierra: Se ha modificado el nombre del proceso A9 por SEA_ENVIO_DS.
	// Se han eliminado SIGA, ANUNTISM, ANUNTIST, INTEVE4ANUNTIS y ATEM4ANUNTIS
	...
	CHECK_DUPLICADO("CHECKDUPLICADO", "Check Duplicado") {
		public String toString() {
			return "CHECKDUPLICADO";
		}
	},
	FULL_DUPLICADO("FULLDUPLICADO", "Full Duplicado") {
		public String toString() {
			return "FULLDUPLICADO";
		}
	},
	...
	Excel_CambioServicio_Madrid("EXCELCAMBIOSERVICIOMADRID", "EXCEL CAMBIO SERVICIO MADRID") {
		public String toString() {
			return "EXCELCAMBIOSERVICIOMADRID";
		}
	},
	...
	Excel_CambioServicio_Alcorcon("EXCELCAMBIOSERVICIOALCORCON", "EXCEL CAMBIO SERVICIO ALCORCON") {
		public String toString() {
			return "EXCELCAMBIOSERVICIOALCORCON";
		}
	},
	...
	Excel_CambioServicio_Alcala("EXCELCAMBIOSERVICIOALCALA", "EXCEL CAMBIOSERVICIO ALCALA") {
		public String toString() {
			return "EXCELCAMBIOSERVICIOALCALA";
		}
	},
	...
	Excel_CambioServicio_Avila("EXCELCAMBIOSERVICIOAVILA", "EXCEL CAMBIO SERVICIO AVILA") {
		public String toString() {
			return "EXCELCAMBIOSERVICIOAVILA";
		}
	},
	...
	Excel_CambioServicio_Ciudad_Real("EXCELCAMBIOSERVICIOCIUDADREAL", "EXCEL CAMBIO SERVICIO CIUDAD REAL") {
		public String toString() {
			return "EXCELCAMBIOSERVICIOCIUDADREAL";
		}
	},
	...
	Excel_CambioServicio_Cuenca("EXCELCAMBIOSERVICIOCUENCA", "EXCEL CAMBIO SERVICIO CUENCA") {
		public String toString() {
			return "EXCELCAMBIOSERVICIOCUENCA";
		}
	},
	...
	Excel_CambioServicio_Guadalajara("EXCELCAMBIOSERVICIOGUADALAJARA", "EXCEL CAMBIO SERVICIO GUADALAJARA") {
		public String toString() {
			return "EXCELCAMBIOSERVICIOGUADALAJARA";
		}
	},
	...
	Excel_CambioServicio_Segovia("EXCELCAMBIOSERVICIOSEGOVIA", "EXCEL CAQMBIO SERVICIO SEGOVIA") {
		public String toString() {
			return "EXCELCAMBIOSERVICIOSEGOVIA";
		}
	},
	...
	// Mantis 14748 este proceso ya no esta en uso. Deberia quitarse, pero InfoWS tiene relacion con el
	...
	// Mantis 14748
	// VEHICULO_PREMATICULADO_FICHA_EITV("FICHA_EITV", "Consulta ficha técnia EITV de Vehiculos prematriculados"){
	// public String toString() {
	// return "FICHA_EITV";
	// }
	// },
	...
	IMPR_ERRORES("IMPR_ERRORES", "Proceso para imprimir los permisos y fichas que han tenido errores") {
		public String toString() {
			return "IMPR_ERRORES";
		}
	},
	...
	EXCEL_CAMBIO_SERVICIO("EXCELCAMBIOSERVICIO", "Excel Cambio de Servicio") {
		public String toString() {
			return "EXCELCAMBIOSERVICIO";
		}
	},
	...
	GESTION_PERM_INTER("GESTION_PERM_INTER", "Gestion Permiso Internacional") {
		public String toString() {
			return "GESTION_PERM_INTER";
		}
