...
public class ResultBeanConsultaIVTM {
private static final long serialVersionUID = 1L;
	...
	public ResultBeanConsultaIVTM(boolean error, List<String> listaMensajes) {
		super();
		this.error = error;
		this.listaMensajes = listaMensajes;
	}

	public ResultBeanConsultaIVTM(boolean error, String mensajeError) {
		super();
		this.error = error;
	...
	public ResultBeanConsultaIVTM(boolean error, Exception excepcion) {
		super();
		this.error = error;
