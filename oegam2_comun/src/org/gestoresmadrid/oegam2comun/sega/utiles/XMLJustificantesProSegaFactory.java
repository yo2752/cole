...
public class XMLJustificantesProSegaFactory {

	private static final String UTF_8 = "UTF-8";
	private static final String NAME_CONTEXT = "org.gestoresmadrid.oegam2comun.sega.justProf.view.xml";
	private final static String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String XML_ENCODING = UTF_8;
	private static final String RUTA_XSD = "/org/gestoresmadrid/oegam2/trafico/sega/schemas/Interfaz_Justf_Profesional_Sega.xsd";
	...
	private static ILoggerOegam log = LoggerOegam.getLogger(XMLJustificantesProSegaFactory.class);
	...
	private URL getEsquemaURL() {
		if (esquemaURL == null){
			esquemaURL = XMLJustificantesProSegaFactory.class.getResource(RUTA_XSD);
		}
		return esquemaURL; 
	}
