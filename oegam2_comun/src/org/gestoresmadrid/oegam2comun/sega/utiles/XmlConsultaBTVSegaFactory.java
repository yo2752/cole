...
public class XmlConsultaBTVSegaFactory {
	...
	public static final String NAME_CONTEXT = "org.gestoresmadrid.oegam2comun.sega.checkBtv.view.xml";
	private final static String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String TRAFICO_SCHEMAS_INTERFAZ_CONSULTABTV_XSD = "/org/gestoresmadrid/oegam2/trafico/sega/schemas/Interfaz_Check_Btv_Sega.xsd";
	 ...
	 */
	public String toXML(org.gestoresmadrid.oegam2comun.sega.checkBtv.view.xml.SolicitudTramite solicitudTramiteSega) {
	...
	/**
	 * Método que valida un XML contra el xsd del CheckBTV (checkBtv.xsd)
