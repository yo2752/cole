...
public interface ServicioWebServiceFullCtitSega extends Serializable{
	...
	public static final String NOTIFICACION = "PROCESO FULL CTIT FINALIZADO";
	
	ResultadoCtitBean tramitarFullCtit(ColaBean solicitud);
