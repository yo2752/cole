package org.gestoresmadrid.oegam2comun.contrato.model.component.impl;
...
@Service(value="modeloContratoPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloContratoPaginatedImpl  extends AbstractModelPagination{
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		if (numElementosTotales > 0) {
			...
			if(list != null && !list.isEmpty()){
				lista = servicioConsultaContrato.convertirListaEnBeanPantalla((List<ContratoVO>)list);
			}
		} else {
