...
public class ResultadoConsultaContratoBean implements Serializable{

	private static final long serialVersionUID = -3971697236600581309L;
	...
	public ResultadoConsultaContratoBean() {
		super();
		this.error = false;
	}
