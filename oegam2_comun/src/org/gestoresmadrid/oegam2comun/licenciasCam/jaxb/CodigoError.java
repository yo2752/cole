 ...
 *       &lt;sequence>
 *         &lt;element name="campo" type="{http://licencias/mensajes}minstring"/>
 *         &lt;element name="codigo_respuesta" type="{http://licencias/mensajes}minstring"/>
 *         &lt;element name="descripcion" type="{http://licencias/mensajes}minstring"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CodigoError", namespace = "http://licencias/peticionGenerica", propOrder = {
    "campo",
    "codigoRespuesta",
    "descripcion"
})
public class CodigoError {
    ...
    @XmlElement(name = "codigo_respuesta", required = true, nillable = true)
