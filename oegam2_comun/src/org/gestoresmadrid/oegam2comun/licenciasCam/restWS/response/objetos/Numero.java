...
public class Numero implements Serializable {
	...
	private static final long serialVersionUID = -688054629076622492L;
	...
	private String nomAppActual;

	private String numAppActual;

	private String calAppAactual;

	private Integer codVialActual;
	...
	public String getNomAppActual() {
		return nomAppActual;
	}

	public void setNomAppActual(String nomAppActual) {
		this.nomAppActual = nomAppActual;
	}

	public String getNumAppActual() {
		return numAppActual;
	}

	public void setNumAppActual(String numAppActual) {
		this.numAppActual = numAppActual;
	}

	public String getCalAppAactual() {
		return calAppAactual;
	}

	public void setCalAppAactual(String calAppAactual) {
		this.calAppAactual = calAppAactual;
	}

	public Integer getCodVialActual() {
		return codVialActual;
	}

	public void setCodVialActual(Integer codVialActual) {
		this.codVialActual = codVialActual;
	}
