package org.gestoresmadrid.oegam2comun.evolucionDocPrmDstvFicha.component.impl;
...
@Service(value = "modeloEvolucionDocPrmDstvFichaPaginated")
@Transactional(readOnly = true)
public class ModeloEvolucionDocPrmDstvFichaPaginatedImpl extends AbstractModelPagination {
	...
	protected GenericDao<?> getDao() {
		return evolucionDocPrmDstvFichaDao;
	}
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<EvolucionDocPrmDstvFichaBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioEvolucionDocPrmDstvFicha.convertirListaEnBeanPantallaConsulta((List<EvolucionDocPrmDstvFichaVO>) list);
