...
public class ResultConsultaEmpresaDIReBean implements Serializable {
	...
	public EmpresaDIReDto empresaDIReDto;
	private File ficheroXml;
	private String nombreXml;
	private SolicitudRegistroEntrada solicitudRegistroEntrada;
	private byte[] xml;

	public ResultConsultaEmpresaDIReBean(Boolean error) {
		this.error = error;
	}
