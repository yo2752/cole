package org.gestoresmadrid.oegam2comun.transporte.component.impl;
...
@Service(value="modeloNotificacionTransportePaginated")
@Transactional(readOnly=true)
public class ModeloNotificacionTransportePaginatedImpl extends AbstractModelPagination {
	...
	protected GenericDao<?> getDao() {
		return notificacionTransporteDao;
	}
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<NotificacionTransporteBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaNotificacionesTransporte.convertirListaEnBeanPantalla((List<NotificacionTransporteVO>) list);
