...
@Service(value = "modeloConsultaPoderesTransportePaginated")
@Transactional(readOnly = true)
public class ModeloConsultaPoderesTransportePaginatedListImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<PoderesTransporteBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaPoderesTransporte.convertirListaEnBeanPantalla((List<PoderTransporteVO>) list);
