package org.gestoresmadrid.oegam2comun.evolucionConsultaDev.component.impl;
...
@Service(value="modeloEvolucionConsultaDevPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloEvolucionConsultaDevPaginatedImpl extends AbstractModelPagination{
	...
	protected GenericDao<?> getDao() {
		return evolucionConsultaDevDao;
	}
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<EvolucionConsultaDevDto> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if(list != null && !list.isEmpty()){
				lista = servicioEvolucionConsultaDev.convertirListaVOToDto((List<EvolucionConsultaDevVO>) list); 
