package org.gestoresmadrid.oegam2comun.impresion.remesas.component.impl;
...
@Service(value="modeloImpresionRemesasModelPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloImpresionRemesasModelPaginatedImpl extends AbstractModelPagination{
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		if (numElementosTotales > 0) {
			...
			if(list != null && !list.isEmpty()){
				lista = conversor.transform(list, RemesaDto.class);
