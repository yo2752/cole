package org.gestoresmadrid.oegam2comun.evolucionPrmDstvFicha.component.impl;
...
@Service(value = "modeloEvolucionPrmDstvFichaPaginated")
@Transactional(readOnly = true)
public class ModeloEvolucionPrmDstvFichaPaginatedImpl extends AbstractModelPagination {
	...
	protected GenericDao<?> getDao() {
		return evolucionPrmDstvFichaDao;
	}
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<EvolucionPrmDstvFichaBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioEvolucionPrmDstvFicha.convertirListaEnBeanPantallaConsulta((List<EvolucionPrmDstvFichaVO>) list);
