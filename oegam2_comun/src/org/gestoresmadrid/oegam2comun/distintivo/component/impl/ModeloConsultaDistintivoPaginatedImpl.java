...
@Service(value = "modeloConsultaDistintivoPaginated")
@Transactional(readOnly = true)
public class ModeloConsultaDistintivoPaginatedImpl extends AbstractModelPagination {

	@Resource
	TramiteTraficoMatrDao tramiteTrafMatrDao;
	
	@Autowired
	ServicioGestionDistintivoDgt servicioConsultaDistintivoDgt;
	
	@Override
	protected GenericDao<?> getDao() {
		return tramiteTrafMatrDao;
	}
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<ConsultaDistintivoDgtBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaDistintivoDgt.convertirListaEnBeanPantallaConsulta((List<TramiteTrafMatrVO>) list);
