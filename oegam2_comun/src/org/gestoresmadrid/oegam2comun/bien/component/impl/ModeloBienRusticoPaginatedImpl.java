...
@Service(value = "modeloBienRusticoPaginatedImpl")
@Transactional(readOnly = true)
public class ModeloBienRusticoPaginatedImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<BienRusticoBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioBienRustico.convertirListaEnBeanPantalla((List<BienRusticoVO>) list); 
