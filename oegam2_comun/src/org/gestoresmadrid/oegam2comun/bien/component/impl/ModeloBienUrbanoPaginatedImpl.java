...
@Service(value = "modeloBienUrbanoPaginatedImpl")
@Transactional(readOnly = true)
public class ModeloBienUrbanoPaginatedImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<BienUrbanoBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioBienUrbano.convertirListaEnBeanPantalla((List<BienUrbanoVO>) list);
