...
import org.gestoresmadrid.oegam2comun.mandato.view.dto.EvolucionMandatoDto;
...
@Service(value = "modeloEvolucionMandatoPaginated")
@Transactional(readOnly = true)
public class ModeloEvolucionMandatoPaginatedImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<EvolucionMandatoDto> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = conversor.transform(list, EvolucionMandatoDto.class);
