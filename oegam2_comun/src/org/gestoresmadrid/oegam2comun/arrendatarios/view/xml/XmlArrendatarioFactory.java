...
public class XmlArrendatarioFactory {

	private static final String XML_ENCODING = "UTF-8";
	public static final String NAME_CONTEXT = "org.gestoresmadrid.oegam2comun.arrendatarios.view.xml";
	private final static String W3C_XML_SCHEMA = "http://www.w3.org/2001/XMLSchema";
	private static final String TRAFICO_SCHEMAS_INTERFAZ_Arrendatario_XSD = "/org/gestoresmadrid/oegam2/arrendatario/schemas/solicitud_registro_entrada_Arrendatario.xsd";
	...
	private ILoggerOegam log = LoggerOegam.getLogger(XmlArrendatarioFactory.class);
	...
	private URL getEsquemaURL() {
		if (esquemaURL == null){
			esquemaURL = XmlArrendatarioFactory.class.getResource(TRAFICO_SCHEMAS_INTERFAZ_Arrendatario_XSD);
		}
		return esquemaURL; 
	}
	...
	/**
	 * Método que valida un XML contra el xsd del Arrendatario (Interfaz_Arrendatario.xsd)
	 ...
	 */
	public void validarXMLArrendatario(File fichero) throws OegamExcepcion {
		Validator validator;
		String mensaje, snif;
		int pos;
		try {
	 ...
	 * @throws OegamExcepcion
	 */
	public void validarXMLArrendatario(String xml) throws OegamExcepcion {
		Validator validator;
		String mensaje, snif;
		int pos;
		try {
