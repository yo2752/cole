...
@Service(value = "modeloArrendatarioPaginationImpl")
@Transactional(readOnly = true)
public class ModeloArrendatarioPaginationImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<ConsultaArrendatarioBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				...
				lista = servicioConsultaArrendatario.convertirListaEnBeanPantalla((List<ArrendatarioVO>) list);
