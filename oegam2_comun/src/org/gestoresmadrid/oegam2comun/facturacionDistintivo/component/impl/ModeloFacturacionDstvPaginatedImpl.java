package org.gestoresmadrid.oegam2comun.facturacionDistintivo.component.impl;
...
@Service(value="modeloFacturacionDstvPaginated")
@Transactional(readOnly=true)
public class ModeloFacturacionDstvPaginatedImpl extends AbstractModelPagination{

	@Resource
	private FacturacionDistintivoDao facturacionDstvDao;
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<FacturacionDstvBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioFacturacionDistintivo.convertirListaEnBeanPantallaConsulta((List<FacturacionDistintivoVO>) list);
