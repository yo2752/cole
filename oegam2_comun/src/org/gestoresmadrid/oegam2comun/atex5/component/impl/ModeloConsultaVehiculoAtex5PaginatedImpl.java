...
@Service(value = "modeloConsultaVehiculoAtex5PaginatedImpl")
@Transactional(readOnly = true)
public class ModeloConsultaVehiculoAtex5PaginatedImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<ConsultaVehiculoAtex5Bean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaVehiculoAtex5.convertirListaEnBeanPantalla((List<ConsultaVehiculoAtex5VO>) list);
	...
	protected GenericDao<?> getDao() {
		return consultaVehiculoAtex5Dao;
	}
}
