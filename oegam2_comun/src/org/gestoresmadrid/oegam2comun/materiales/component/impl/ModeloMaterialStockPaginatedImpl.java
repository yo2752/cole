...
@Service(value = "modeloMaterialStockPaginated")
@Transactional(readOnly = true)
public class ModeloMaterialStockPaginatedImpl extends AbstractModelPagination {

	@Resource
	StockMaterialDao stockMaterialDao;

	@Autowired
	ServicioStockMateriales servicioStockMaterial;

	@Override
	protected GenericDao<?> getDao() {
		return stockMaterialDao;
	}
	@Override
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort,
		...
		List<StockMaterialBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if(list != null && !list.isEmpty()){
				lista = servicioStockMaterial.convertirListaEnBeanPantalla((List<StockMaterialVO>) list); 
