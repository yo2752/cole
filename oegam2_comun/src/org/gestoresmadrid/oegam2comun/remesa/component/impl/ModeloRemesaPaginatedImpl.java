package org.gestoresmadrid.oegam2comun.remesa.component.impl;
...
@Service(value="modeloRemesaPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloRemesaPaginatedImpl extends AbstractModelPagination{
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		if (numElementosTotales > 0) {
			...
			if(list != null && !list.isEmpty()){
				lista = servicioRemesas.convertirListaEnBeanPantalla((List<RemesaVO>) list); 
