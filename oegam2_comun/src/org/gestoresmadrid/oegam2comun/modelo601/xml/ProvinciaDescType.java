...
/**
 * <p>Java class for provinciaDescType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="provinciaDescType">
 ...
 * 
 */
@XmlType(name = "provinciaDescType")
@XmlEnum
public enum ProvinciaDescType {
    ...
    public static ProvinciaDescType fromValue(String v) {
        for (ProvinciaDescType c: ProvinciaDescType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
