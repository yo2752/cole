package org.gestoresmadrid.oegam2comun.consultaKo.component.impl;
...
@Service(value = "modeloConsultaKoPaginated")
@Transactional(readOnly = true)
public class ModeloConsultaKoPaginatedImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<ConsultaKoBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioConsultaKo.convertirListaEnBeanPantallaConsulta((List<ConsultaKoVO>) list);
