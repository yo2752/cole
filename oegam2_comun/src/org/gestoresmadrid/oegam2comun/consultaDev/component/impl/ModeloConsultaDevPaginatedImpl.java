package org.gestoresmadrid.oegam2comun.consultaDev.component.impl;
...
@Service(value="modeloConsultaDevPaginatedImpl")
@Transactional(readOnly=true)
public class ModeloConsultaDevPaginatedImpl extends AbstractModelPagination{

	@Resource
	private ConsultaDevDao consultaDevDao;
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<ConsultaDevBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if(list != null && !list.isEmpty()){
				lista = servicioConsultaDev.convertirListaEnBeanPantalla((List<ConsultaDevVO>) list); 
