package trafico.matriculacion.eitv;
 ...
 * presentar en la DGT
 */
public class DGTSolicitudEitv {

	private static final String UTF_8 = "UTF-8";
	private static final String TEXTO_MATEEITV_LOG = "LOG_MATEEITV:";
	private static final String TIMEOUT_PROP_EITV = "webservice.eitv.timeOut";
	private static final String WEBSERVICE_MATE_EITV = "webservice.eitv.url";
	private static final int TIMEOUT_MATEGE = 120000;
	 ...
	 */	
	public EitvQueryWSResponse presentarDGTEitv(String peticionXML, BeanDatosFiscales datosFiscales, String id,
			String nive, String bastidor) throws Exception, OegamExcepcion {
		...
		try {
			 ...
			 * dgtResponse (String): Resultado íntegro del trámite MATEGE que la DGT devuelve.
	...
	private EitvQueryWSRequest completaRequest(String peticionXML, BeanDatosFiscales datosFiscales, String id,
			String nive, String bastidor) throws UnsupportedEncodingException {
		...
		/* externalSystemFiscalId CIF de la plataforma que realiza la conexión a la Caja Negra.
		 * Es el que se usa para la firma en los PDF. Se obtendrá de TraficoTramiteBean.getNumExpediente() */
	...
	/**
	 * El stub de conexión con el webservice de eITV
	 * @throws OegamExcepcion
	...
	public EITVQueryWSBindingStub getStubEitv() throws MalformedURLException, ServiceException {
		...
		stubEitv.setTimeout(timeOut != null && !"".equals(timeOut) ? Integer.parseInt(timeOut) : TIMEOUT_MATEGE);
