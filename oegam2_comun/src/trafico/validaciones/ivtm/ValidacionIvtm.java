...
public class ValidacionIvtm {
	...
	/**
	 * Validaciones para el Alta - Modificacion de Autoliquidación del IVTM de Madrid
	 * 
	 */
	...
	public static List<String> validarAlta(TramiteTraficoDto tramite, IvtmMatriculacionDto ivtmMatriculacionDto){
		...
		// TODO está pendiente comprobar que fechas se utilizan
	...
	private static void anadirErroresMarcaVehiculo(MarcaDgt marca, List<String> errores) {
		...
		/* No se está comprobando que el marca sea una de las registradas, aunque el html ya lo está haciendo */
	}
	...
	private static void anadirErroresBastidor(String bastidor, List<String> errores) {
		...
		/* No se está comprobando que el bastidor esté bien formado */
	}
	...
	private static void anadirErroresNIF(String nif, List<String> errores, String tipo) {
		/* Se podría tambien comprobar que el NIF, tarjeta de residente o CIF está correctamente formado */
	...
	/** Fin de Validaciones para el Alta - Modificacion de Autoliquidación del IVTM de Madrid */
