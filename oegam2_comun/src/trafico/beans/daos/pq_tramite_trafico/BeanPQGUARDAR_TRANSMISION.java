...
public class BeanPQGUARDAR_TRANSMISION extends BeanPQGeneral{
 
 
public static final String PROCEDURE="GUARDAR_TRANSMISION";
...
ejecutarProc(this,SCHEMA,ValoresCatalog.PQ_TRAMITE_TRAFICO,PROCEDURE,null,true);
	...
	public void setP_ELECTRONICA(String P_ELECTRONICA){
		this.P_ELECTRONICA=P_ELECTRONICA;}
...
// 	P_CONSENTIMIENTO_CAMBIO 3038
	...
	public void setP_CONSENTIMIENTO_CAMBIO(String pCONSENTIMIENTOCAMBIO){
		this.P_CONSENTIMIENTO_CAMBIO=pCONSENTIMIENTOCAMBIO;}
