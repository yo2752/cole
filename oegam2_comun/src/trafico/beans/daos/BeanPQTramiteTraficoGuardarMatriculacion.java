...
public class BeanPQTramiteTraficoGuardarMatriculacion extends BeanPQGeneral{
...
//	-- Valores propios del trámite general
	...
	//Nuevos campos Matw
	//JMC - Desaparecen en la nueva versión de MATW
	...
	private String P_CHECK_JUSTIF_FICHERO_IVTM;

	// Campo de información sobre lógica de negocio.
	...
	public void setP_ENTREGA_FACT_MATRICULACION(
			String p_ENTREGA_FACT_MATRICULACION) {
	...
	public String getP_CHECK_JUSTIF_FICHERO_IVTM() {
		return P_CHECK_JUSTIF_FICHERO_IVTM;
	}
	public void setP_CHECK_JUSTIF_FICHERO_IVTM(String p_CHECK_JUSTIF_FICHERO_IVTM) {
		P_CHECK_JUSTIF_FICHERO_IVTM = p_CHECK_JUSTIF_FICHERO_IVTM;
	}
