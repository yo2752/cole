...
/**
 * <p>Java class for tipoServicioDelVehiculo.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="tipoServicioDelVehiculo">
 ...
 * 
 */
@XmlType(name = "tipoServicioDelVehiculo", namespace = "http://www.gacn.es/CTIT/tipos")
@XmlEnum
public enum TipoServicioDelVehiculo {
    ...
    TipoServicioDelVehiculo(String v) {
        value = v;
    }
    ...
    public static TipoServicioDelVehiculo fromValue(String v) {
        for (TipoServicioDelVehiculo c: TipoServicioDelVehiculo.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
