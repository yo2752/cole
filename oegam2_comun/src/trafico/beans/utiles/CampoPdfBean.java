...
public class CampoPdfBean {
	...
	public CampoPdfBean(String nombre, String valor, boolean negrita, boolean cursiva, 
			float tamFuente, int pagina, float posX, float posY) {
		this.imagen = false;
		this.nombre = nombre;
	...
	//SINCODIG Nueva propiedad. Inicio
