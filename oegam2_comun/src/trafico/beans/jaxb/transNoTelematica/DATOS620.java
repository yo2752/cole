...
//	protected String aniofabricacion;
	...
	// 30-01-2023. DVV. Nuevos campos
	@XmlElement(name = "TRANSMITENTE", required = true)
	protected String transmitente;
	@XmlElement(name = "TIPO_MOTOR", required = true)
	protected String tipoMotor;
	@XmlElement(name = "SUBASTA", required = true)
	protected String subasta;
	@XmlElement(name = "TIPO_MOTOR_EMBARCACION", required = true)
	protected String tipoMotorEmbarcacion;
	@XmlElement(name = "PRESCRITA", required = true)
	protected String prescrita;
	@XmlElement(name = "PRECIO_COMPRAVENTA", required = true)
	protected String precioCompraventa;
	@XmlElement(name = "CODIGO_REDUCCION", required = true)
	protected String codigoReduccion;
	@XmlElement(name = "PORCENTAJE_REDUCCION", required = true)
	protected String porcentajeReduccion;
	@XmlElement(name = "IMPORTE_REDUCCION", required = true)
	protected String importeReduccion;
	 ...
	 * 
	 * @return possible object is {@link DIRECCIONDISTINTAADQUIRIENTE }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link DIRECCIONDISTINTAADQUIRIENTE }
	 * 
	 */
	 ...
	 * 
	 * @return value allowed object is {@link String }
	 * 
	 */
