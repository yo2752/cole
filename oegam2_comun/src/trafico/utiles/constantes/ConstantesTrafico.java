...
public class ConstantesTrafico {
	...
	public static final int POS_IN_NUBE2 = 112; // Índice del array en el que comienza la nube 2 (Si se añade o se elmina algún campo en el array es necesario
	...
	/**
	 * Siglas de la Jefatura de Tráfico.
	 * 
	...
	/**
	 * Fecha límite de validez de matrícula turística
	 * 
	...
	/**
	 * Nombre de la gestoría o del profesional
	 * 
	...
	/**
	 * Campo para insertar las siglas del tipo de vía del titular 2
	 */
	public static final String ID_TIPO_VIA_TITULAR_2 = ID_PREFIX
			+ "TIPO_VIA_TITULAR_2";

	/**
	 * Campo para insertar las siglas del tipo de vía del titular 3
	 */
	...
	// Bajas Exportación o tránsito comunitario
	...
	public static final Integer DIAS_VALIDEZ_POR_DEFECTO = 30; // Incidencia
																// 4359 atc
	public static final DocumentosJustificante DOCUMENTOS_POR_DEFECTO = DocumentosJustificante.CambioTitular;
	public static final MotivoJustificante MOTIVO_TRANSMISION_POR_DEFECTO = MotivoJustificante.Otros;
	public static final MotivoJustificante MOTIVO_DUPLICADO_POR_DEFECTO = MotivoJustificante.Otros;
...
//	public static final String SUBTIPO_GF_ATEM_XML = "ATEM_XMLS";
	...
	// CONSTANTES PARA LAS SOLICITUDES DE INFORMACIÓN
