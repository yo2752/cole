...
public enum PaisFabricacion {
	...
	public static PaisFabricacion getPaisFabricacion(String valorEnum) {
		...
		if (PaisFabricacion.IMPORTACION_UE.valorEnum.equals(valorEnum)
				|| Fabricacion.IMPORTACION_UE.getValorEnum().equals(valorEnum) || valorEnum.equalsIgnoreCase("3"))
			return PaisFabricacion.IMPORTACION_UE;
		else if (PaisFabricacion.IMPORTACION_NO_UE.valorEnum.equals(valorEnum)
				|| Fabricacion.IMPORTACION_NO_UE.getValorEnum().equals(valorEnum) || valorEnum.equalsIgnoreCase("1"))
			return PaisFabricacion.IMPORTACION_NO_UE;
		else if (PaisFabricacion.NACIONAL.valorEnum.equals(valorEnum)
				|| Fabricacion.NACIONAL.getValorEnum().equals(valorEnum) || valorEnum.equalsIgnoreCase("0"))
	...
	/**
	 * Devuelve la equivalencia del país de fabricación con lugar de adquisición
	 * 
