 ...
 * 
 * La propiedad valorEnum contiene la correspondencia en la tabla FUNCION, y en
 * USUARIO_FUNCION_SIN_ACCESO para determinar si un usuario tiene o no permisos
 * para importar ese tipo de ficheros en OEGAM
 * 
 * La propiedad nombreEnum contiene la referencia en las properties al mensaje
 * de error asociado a la falta de permiso de un usuario para importar el
