...
public class XmlCheckCTITFactory {

	private static final String UTF_8 = "UTF-8";
	private static final String TRAFICO_SCHEMAS_INTERFAZ_CTITCON_XSD = "/trafico/schemas/InterfazCTITCON.xsd";
	public static final String NAME_CONTEXT = "trafico.beans.schemas.generated.checkctit";
	...
	private ILoggerOegam log = LoggerOegam.getLogger(XmlCheckCTITFactory.class);
	...
	private URL getEsquemaURL() {
		if (esquemaURL==null)
			esquemaURL = XmlCheckCTITFactory.class.getResource(TRAFICO_SCHEMAS_INTERFAZ_CTITCON_XSD);
		return esquemaURL; 
	}
	...
	/**
	 * Método que valida un XML contra el xsd del CheckCTIT (InterfazCTITCON.xsd)
