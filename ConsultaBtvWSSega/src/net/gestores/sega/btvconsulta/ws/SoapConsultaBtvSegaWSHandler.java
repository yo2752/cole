package net.gestores.sega.btvconsulta.ws;
...
public class SoapConsultaBtvSegaWSHandler extends GenericWSHandler {

	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapConsultaBtvSegaWSHandler.class);

	public static final String PROPERTY_KEY_ID = "numExpediente";

	private final String PREF_NOMBRE_FICHERO = "CONSULTA_BTV_";
	private final String SUF_NOMBRE_FICHERO_REQ = "_REQ";
	private final String SUF_NOMBRE_FICHERO_RESP = "_RESP";

	private final String TIPO_DOCUMENTO = ConstantesGestorFicheros.CONSULTA_BTV;
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.CONSULTABTV_RESQ_RESP;
