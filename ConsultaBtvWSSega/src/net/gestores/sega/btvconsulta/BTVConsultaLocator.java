...
public class BTVConsultaLocator extends org.apache.axis.client.Service implements net.gestores.sega.btvconsulta.BTVConsulta {
    ...
    private java.lang.String BTVConsulta_address = "https://217.130.244.72:8484/sega/BTVConsulta";
    ...
    public net.gestores.sega.btvconsulta.BTVWS getBTVConsulta(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.gestores.sega.btvconsulta.BTVWSBindingStub _stub = new net.gestores.sega.btvconsulta.BTVWSBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.gestores.sega.btvconsulta.BTVWS.class.isAssignableFrom(serviceEndpointInterface)) {
                net.gestores.sega.btvconsulta.BTVWSBindingStub _stub = new net.gestores.sega.btvconsulta.BTVWSBindingStub(new java.net.URL(BTVConsulta_address), this);
                _stub.setPortName(getBTVConsultaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://sega.gestores.net/btvconsulta", "BTVConsulta");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://sega.gestores.net/btvconsulta", "BTVConsulta"));
        }
