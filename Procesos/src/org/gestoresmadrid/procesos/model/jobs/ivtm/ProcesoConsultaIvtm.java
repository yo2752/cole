...
public class ProcesoConsultaIvtm extends AbstractProcesoBase {

	
	@Autowired
	ServicioIvtmWS servicioWS;
	
	private static final ILoggerOegam log = LoggerOegam.getLogger("ProcesoConsultaIVTM");
	...
	protected void doExecute() throws JobExecutionException {
		...
		try {
			...
			if (solicitud == null) {
				...
				resultado = servicioWS.procesarSolicitudConsulta(solicitud.getIdTramite(),solicitud.getXmlEnviar(), solicitud.getIdUsuario(), solicitud.getIdContrato());
	...
	protected String getProceso() {
		...
		return ProcesosEnum.IVTM_CONSULTA.getNombreEnum();
	}
