...
public class ProcesoImpresionPermisosCtit extends AbstractProceso{
	
	private static final ILoggerOegam log = LoggerOegam.getLogger(ProcesoImpresionPermisosCtit.class);
	...
	protected void doExecute() throws JobExecutionException {
		...
		try {
			...
			log.error("Ocurrio un error no controlado en el proceso IMPR_PERMISO_CTIT, error: ", e);
	...
	protected String getProceso() {
		return  ProcesosEnum.IMP_PRM_CTIT.getNombreEnum();
	}
