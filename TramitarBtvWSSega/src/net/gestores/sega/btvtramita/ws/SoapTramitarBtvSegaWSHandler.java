package net.gestores.sega.btvtramita.ws;
...
public class SoapTramitarBtvSegaWSHandler extends GenericWSHandler{
	
private static final ILoggerOegam log = LoggerOegam.getLogger(SoapTramitarBtvSegaWSHandler.class);
	...
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.TRAMITARBTV_RESQ_RESP;
