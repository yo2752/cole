...
public class SoapFullCtitSegaWSHandler  extends GenericWSHandler{

	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapFullCtitSegaWSHandler.class);
	
	public static final String PROPERTY_KEY_ID = "numExpediente";
	
	private final String PREF_NOMBRE_FICHERO = "FULL_CTIT_";
	...
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.FULL_CTIT_RESQ_RESP;
