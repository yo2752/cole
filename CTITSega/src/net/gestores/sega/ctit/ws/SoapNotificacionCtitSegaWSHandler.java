package net.gestores.sega.ctit.ws;
...
public class SoapNotificacionCtitSegaWSHandler  extends GenericWSHandler{

	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapNotificacionCtitSegaWSHandler.class);
	
	public static final String PROPERTY_KEY_ID = "numExpediente";
	
	private final String PREF_NOMBRE_FICHERO = "NOTIFICACION_CTIT_";
	private final String SUF_NOMBRE_FICHERO_REQ = "_REQ";
	private final String SUF_NOMBRE_FICHERO_RESP = "_RESP";
	
	private final String TIPO_DOCUMENTO = ConstantesGestorFicheros.CTIT;
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.NOTIF_CTIT_RESQ_RESP;
