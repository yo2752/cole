...
public class SoapTradeCtitSegaWSHandler  extends GenericWSHandler{

	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapTradeCtitSegaWSHandler.class);
	
	public static final String PROPERTY_KEY_ID = "numExpediente";
	
	private final String PREF_NOMBRE_FICHERO = "TRADE_CTIT_";
	...
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.TRADE_CTIT_RESQ_RESP;
