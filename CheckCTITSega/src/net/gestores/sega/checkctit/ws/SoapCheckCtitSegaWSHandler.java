package net.gestores.sega.checkctit.ws;
...
public class SoapCheckCtitSegaWSHandler  extends GenericWSHandler{

	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapCheckCtitSegaWSHandler.class);
