package org.gestoresmadrid.oegamPlacasMatricula.component.impl;
...
@Service(value = "modeloSolicitudPlacasPaginated")
@Transactional(readOnly = true)
public class ModeloPlacasMatriculaPaginatedImpl extends AbstractModelPagination {

	@Resource
	SolicitudPlacasDAO solicitudPlacasDao;
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<SolicitudPlacaDto> listaSolicitudes = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				listaSolicitudes = servicioPlacasMatricula.convertirListaEnBeanPantallaConsulta((List<SolicitudPlacaVO>) list);
				if (listaSolicitudes == null || listaSolicitudes.isEmpty()) {
					listaSolicitudes = Collections.emptyList();
				}
			}
		} else {
		...
		return new PaginatedListImpl(resPag, page, dir, sort, numElementosTotales, listaSolicitudes);
	}
