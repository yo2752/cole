...
public class SoapConsultaTarjetaEitvPreMatriculadosWSHandler extends GenericWSHandler{
/* INICIO ATRIBUTOS/CONSTANTES */
	
	private static final ILoggerOegam log = LoggerOegam.getLogger(SoapConsultaTarjetaEitvPreMatriculadosWSHandler.class);
	
	private final String PREF_NOMBRE_FICHERO_REQ = "CONSULTA_TARJETA_EITV_PREMATRICULADOS_";
	...
	private final String SUB_TIPO_DOCUMENTO = ConstantesGestorFicheros.EITV_PREMATRICULADO;
	...
	/* CONSTRUCTOR */
	public SoapConsultaTarjetaEitvPreMatriculadosWSHandler() {
