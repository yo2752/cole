...
public class Agent  extends org.gestoresmadrid.gescogroup.blackbox.User  implements java.io.Serializable {
    private org.gestoresmadrid.gescogroup.blackbox.Agency[] agencies;

    private org.gestoresmadrid.gescogroup.blackbox.AgentCertificate agentCertificate;

    private org.gestoresmadrid.gescogroup.blackbox.BranchOffice branchOffice;

    private org.gestoresmadrid.gescogroup.blackbox.Address fiscalAddress;
    ...
    public Agent(
           ...
           org.gestoresmadrid.gescogroup.blackbox.Agency[] agencies,
           org.gestoresmadrid.gescogroup.blackbox.AgentCertificate agentCertificate,
           org.gestoresmadrid.gescogroup.blackbox.BranchOffice branchOffice,
           org.gestoresmadrid.gescogroup.blackbox.Address fiscalAddress,
           int memberId) {
        super(
            createdOn,
            deletedOn,
     ...
     * @return agencies
     */
    public org.gestoresmadrid.gescogroup.blackbox.Agency[] getAgencies() {
        return agencies;
    }
     ...
     * @param agencies
     */
    public void setAgencies(org.gestoresmadrid.gescogroup.blackbox.Agency[] agencies) {
        this.agencies = agencies;
    }

    public org.gestoresmadrid.gescogroup.blackbox.Agency getAgencies(int i) {
        return this.agencies[i];
    }

    public void setAgencies(int i, org.gestoresmadrid.gescogroup.blackbox.Agency _value) {
     ...
     */
    public org.gestoresmadrid.gescogroup.blackbox.AgentCertificate getAgentCertificate() {
        return agentCertificate;
    }
     ...
     */
    public void setAgentCertificate(org.gestoresmadrid.gescogroup.blackbox.AgentCertificate agentCertificate) {
        this.agentCertificate = agentCertificate;
    }
     ...
     * @return branchOffice
     */
    public org.gestoresmadrid.gescogroup.blackbox.BranchOffice getBranchOffice() {
        return branchOffice;
    }
     ...
     * @param branchOffice
     */
    public void setBranchOffice(org.gestoresmadrid.gescogroup.blackbox.BranchOffice branchOffice) {
        this.branchOffice = branchOffice;
    }
     ...
     */
    public org.gestoresmadrid.gescogroup.blackbox.Address getFiscalAddress() {
        return fiscalAddress;
    }
     ...
     * @param fiscalAddress
     */
    public void setFiscalAddress(org.gestoresmadrid.gescogroup.blackbox.Address fiscalAddress) {
        this.fiscalAddress = fiscalAddress;
    }
