package org.gestoresmadrid.oegamImportacion.constantes;

import utilidades.logger.ILoggerOegam;
import utilidades.logger.LoggerOegam;

public class ConstantesPDF {
	...
	// Rutas de las plantillas(Esto hay que pasarlo a un properties y acceder a la
	// ruta así)
	...
	public static final String RUTA_MARCA_AGUA_PEQUENIA = "marcaAguaPeque.jpg";
	...
	// Ruta del fichero pdf resultante del webservice de Mate, permiso temporal de
	// circulacion
...
//	public static final String RUTA_PERMISO_TEMPORAL_CIRCULACION = b
	...
	// Constantes que se utilizan para el calculo de las posiciones en la impresion
	// de etiquetas
	...
	// Nombre de la property para indicar si se completa con 0 a la izquierda los
	// campos autonomía eléctrica y consumo.
	...
	public static String getSchema() {
		...
		// Si no se ha especificado el key store de las claves públicas se coje el de
		// por defecto
