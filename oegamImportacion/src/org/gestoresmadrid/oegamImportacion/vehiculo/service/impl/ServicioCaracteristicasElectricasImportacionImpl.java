...
@Service
public class ServicioCaracteristicasElectricasImportacionImpl implements ServicioCaracteristicasElectricasImportacion {

	private static final long serialVersionUID = 7382274235495334043L;

	private static final ILoggerOegam log = LoggerOegam.getLogger(ServicioCaracteristicasElectricasImportacionImpl.class);

	@Autowired
	CaracteristicasElectricasDao caracteristicasElectricasDao;
