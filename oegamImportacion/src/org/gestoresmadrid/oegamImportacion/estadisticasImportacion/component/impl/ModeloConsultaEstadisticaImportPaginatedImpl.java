package org.gestoresmadrid.oegamImportacion.estadisticasImportacion.component.impl;
...
@Service(value = "modeloConsultaEstadisticaImportPaginated")
@Transactional(readOnly = true)
public class ModeloConsultaEstadisticaImportPaginatedImpl extends AbstractModelPagination {
	...
	protected GenericDao<?> getDao() {
		return estadisticaImportacionFicherosDao;
	}
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<ConsultaEstadisticasImportBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioEstadisticaImportacion.convertirListaEnBeanPantallaConsultaEst((List<EstadisticaImportacionFicherosVO>) list);
