...
@Service(value = "modeloEstadisticaImportacionPaginated")
@Transactional(readOnly = true)
public class ModeloEstadisticaImportacionPaginatedImpl extends AbstractModelPagination {
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort,
		...
		List<EstadisticaImportacionBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioEstadisticaImportacion
						.convertirListaEnBeanPantallaConsulta((List<EstadisticaImportacionFicherosVO>) list);
