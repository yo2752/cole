package org.gestoresmadrid.oegamDocBase.component.impl;
...
@Service(value = "modeloGestionDocBasePaginated")
@Transactional(readOnly = true)
public class ModeloGestionDocBasePaginatedImpl extends AbstractModelPagination implements Serializable{
	
	private static final long serialVersionUID = -7065293739338872976L;
	...
	public PaginatedList buscarPag(Object beanCriterios, int resPag, int page, String dir, String sort, String[] listInitializedOnePath, String[] listInitializedAnyPath) {
		...
		List<GestionDocBaseBean> lista = null;
		...
		if (numElementosTotales > 0) {
			...
			if (list != null && !list.isEmpty()) {
				lista = servicioGestionDocBase.convertirListaEnBeanPantallaConsulta((List<DocumentoBaseVO>) list);
