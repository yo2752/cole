...
public class RptProfile  extends com.gescogroup.blackbox.AbstractEntity  implements java.io.Serializable {
    private com.gescogroup.blackbox.MlString description;

    private java.lang.String name;

    private com.gescogroup.blackbox.Report[] reports;
    ...
    public RptProfile(
           ...
           com.gescogroup.blackbox.Report[] reports) {
        super(
            createdOn,
            deletedOn,
            id,
     ...
     * @return reports
     */
    public com.gescogroup.blackbox.Report[] getReports() {
        return reports;
    }
     ...
     * @param reports
     */
    public void setReports(com.gescogroup.blackbox.Report[] reports) {
        this.reports = reports;
    }

    public com.gescogroup.blackbox.Report getReports(int i) {
        return this.reports[i];
    }

    public void setReports(int i, com.gescogroup.blackbox.Report _value) {
