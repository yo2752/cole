...
public class EitvQueryWSResponse  implements java.io.Serializable {
    ...
    private com.gescogroup.blackbox.EitvQueryError[] errorCodes;
    ...
    public EitvQueryWSResponse(
           ...
           com.gescogroup.blackbox.EitvQueryError[] errorCodes,
     ...
     * @return errorCodes
     */
    public com.gescogroup.blackbox.EitvQueryError[] getErrorCodes() {
        return errorCodes;
    }
     ...
     * @param errorCodes
     */
    public void setErrorCodes(com.gescogroup.blackbox.EitvQueryError[] errorCodes) {
        this.errorCodes = errorCodes;
    }

    public com.gescogroup.blackbox.EitvQueryError getErrorCodes(int i) {
        return this.errorCodes[i];
    }

    public void setErrorCodes(int i, com.gescogroup.blackbox.EitvQueryError _value) {
