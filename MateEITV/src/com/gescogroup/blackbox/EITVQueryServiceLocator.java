...
public class EITVQueryServiceLocator extends org.apache.axis.client.Service implements com.gescogroup.blackbox.EITVQueryService {
    ...
    private java.lang.String EITVQueryService_address = "https://test.gacn.es/bbws/EITVQueryService";
    ...
    public com.gescogroup.blackbox.EITVQueryWS getEITVQueryService() throws javax.xml.rpc.ServiceException {
    ...
    public com.gescogroup.blackbox.EITVQueryWS getEITVQueryService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gescogroup.blackbox.EITVQueryWSBindingStub _stub = new com.gescogroup.blackbox.EITVQueryWSBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gescogroup.blackbox.EITVQueryWS.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gescogroup.blackbox.EITVQueryWSBindingStub _stub = new com.gescogroup.blackbox.EITVQueryWSBindingStub(new java.net.URL(EITVQueryService_address), this);
                _stub.setPortName(getEITVQueryServiceWSDDServiceName());
                return _stub;
            }
        }
